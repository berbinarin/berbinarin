...
@section('content')
    <section class="flex w-full h-full overflow-hidden"> <!-- full height + no scroll halaman -->
        <div class="flex w-full flex-col">
            ...
            <!-- Header -->
            <div class="py-4 md:pb-5 md:pt-5 flex-shrink-0">
            ...
            <!-- Form Section -->
            <div class="rounded-[18px] bg-white px-4 drop-shadow-lg md:px-8 md:py-5 xl:px-10 flex-1 overflow-y-auto">
                <form action="{{ route('dashboard.psychologists-staff.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            <label class="font-normal text-md">Status Pernikahan</label>
                        ...
                        <div>
                            <label class="font-normal text-md">Hobi atau Kegiatan Sosial yang diikuti</label>
                    ...
                    <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            <label class="font-normal text-md">Tanggal Pengajuan Konseling <span
                                    class="font-semibold text-md">(minimal 5 hari setelah pengisian form)</span></label>
