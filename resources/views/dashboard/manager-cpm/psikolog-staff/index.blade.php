                            ...
                            @forelse ($PsikologData as $key => $item)
                                <tr class="hover:bg-gray-50 transition text-md lg:text-base">
                                    ...
                                    <td class="flex justify-center gap-2">
                                        <a href="{{ route('dashboard.psychologists-staff.show', $item->id) }}" class="p-2 bg-blue-500 hover:bg-blue-600 rounded"><i
                                                class="bx bx-show text-white"></i></a>
                                        <a href="{{ route('dashboard.psychologists-staff.edit', $item->id) }}" class="p-2 bg-yellow-500 hover:bg-yellow-600 rounded"><i
                                                class="bx bx-edit text-white"></i></a>
                                        <form id="deleteForm-{{ $item->id }}" action="{{ route('dashboard.psychologists-staff.destroy', $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
