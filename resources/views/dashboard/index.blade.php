...
@section('content')
    <section class="flex w-full">
        <div class="flex flex-col w-full">
                    ...
                    <div class="">
                        ...
                        @role('manager-cpm')
                            <p tabindex="0" class="focus:outline-none text-4xl font-bold leading-normal text-gray-800">
                                Dashboard Konseling Staff</p>
                            <p class="w-full text-disabled">Dashboard ini menampilkan ringkasan data staf psikolog dan voucher
                                aktif, untuk membantu mengelola data psikolog staff. dan kode voucher dengan lebih mudah.</p>
                        @endrole
                ...
                <div class="flex flex-col xl:w-[80vw] gap-6">
                        ...
                        <div class="flex w-1/3 items-center p-8 bg-white shadow rounded-lg">
                            ...
                            <div>
                                <span class="block text-2xl font-bold"
                                    id="job-descriptions-count">{{ $HiringPosisitonsJobDescriptionment }}</span>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div class="flex h-[330px] flex-col rounded-xl bg-white px-6 py-4 shadow">
                            <div class="mb-4">
                                <h1 class="text-[28px] text-[#75BADB]"><b>Analisis posisi, deskripsi pekerjaan, persyaratan</b>
                                </h1>
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                    <p class="text-[14px]">Berikut ini merupakan visualisasi diagram Posisi, deskripsi
                                        pekerjaan, persyaratan</p>
                                </div>
                            </div>
            ...
            @role('class-pm')
                <div
                    class="flex flex-row items-center mx-10 py-12 px-20 justify-between gap-12 bg-white shadow-xl rounded-3xl">
                    <div class="bg-[#6482AD] w-1/2 rounded-3xl p-6 h-96">
                        <div class="flex flex-row justify-between">
                            <p class="text-white text-xl font-semibold">Class Berbinar +</p><img
                                src="{{ asset('assets/images/dashboard/svg-icon/person.png') }}" alt="">
                        </div>
                    ...
                    <div class="bg-[#85B3E2] w-1/2 rounded-3xl p-6 h-96">
                        <div class="flex flex-row justify-between">
                            <p class="text-white text-xl font-semibold">Pendaftar</p><img
                                src="{{ asset('assets/images/dashboard/svg-icon/list.png') }}" alt="">
                        </div>
                        <div class="h-full flex flex-col justify-end">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div class="flex h-[340px] flex-col rounded-xl bg-white p-6 shadow">
                            <div class="mb-4">
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                    <p class="text-[14px]">Berikut ini merupakan visualisasi diagram Analisis Pembaca ArteRi
                                    </p>
