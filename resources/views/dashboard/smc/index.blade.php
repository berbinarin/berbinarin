                ...
                <div class="-ml-10">
                    <div class="flex flex-row gap-2">
                        <p tabindex="0"
                            ...
                            Sosial Media Creator Data
                        </p>
                    </div>
                    <p class="w-full text-disabled text-xs sm:text-xs md:text-sm lg:text-md xl:text-base">
                        Halaman yang menampilkan dan mengelola data pendaftar sosial media creator.
                    </p>
                    ...
                    <table id="example" class="min-w-full border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-200 text-gray-700">
                                <tr class="hover:bg-gray-50 transition text-md lg:text-base">
                                    ...
                                    <td class="text-start">Asep</td>
                                    <td class="text-center">
                                        <a href="" target="_blank" class="text-blue-500 hover:text-blue-700 underline">08122718675</a>
                                    </td>
                                    <td class="text-center">asep@gmail.com</td>
                                    <td class="text-center">07/08/2026</td>
