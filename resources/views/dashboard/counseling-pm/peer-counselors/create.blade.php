            ...
            <div class="py-4 md:pb-7 md:pt-12">
                <div class="mb-2 flex items-center gap-2">
                    ...
                    <p class="text-base font-bold leading-normal text-gray-800 sm:text-lg md:text-2xl lg:text-4xl">Tambah
                        Data Peer Counselor</p>
                </div>
                <p class="w-3/4 text-disabled">Halaman yang digunakan untuk menambahkan, mengelola, dan melengkapi seluruh
                    data pribadi, latar belakang, serta informasi penting lainnya dari peer counselor secara detail untuk
                    keperluan administrasi dan monitoring.</p>
            </div>
...
>>>>>>> 15609a1c2513c1485a24986d233493a9ebe4fdef
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <input required type="text" name="jadwal_tanggal" id="tglkonseling"
                                class="w-full rounded-lg border-gray-300 px-3 py-2 shadow-sm" placeholder="dd/mm/yy"
                                readonly />
                        </div>
                        <div>
                            <label class="font-semibold">Hari Konseling</label>
                            <input type="text" name="hari" id="hari_konseling"
                                class="w-full rounded-lg border-gray-300 bg-gray-100 px-3 py-2 shadow-sm" readonly />
                        </div>
                        <div>
                            <label class="font-semibold">Waktu Konseling</label>
                            <select name="jadwal_pukul" id="waktu-konseling" required
                                class="w-full rounded-lg border-gray-300 px-3 py-2 shadow-sm">
                                <option value="" hidden selected>Pilih waktu dahulu</option>
                                @for ($i = 1; $i <= 24; $i++)
                        ...
                        <div>
                            ...
                            <select required name="metode" id="metode-select"
                                class="w-full rounded-lg border-gray-300 px-3 py-2 shadow-sm">
                        ...
                        <div>
                            ...
                            <input required name="harga" id="harga-input"
                                class="w-full rounded-lg border-gray-300 bg-gray-100 px-3 py-2 shadow-sm"
                                placeholder="Rp 0,00" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select required name="pendidikan"
                                class="w-full rounded-lg border-gray-300 px-3 py-2 shadow-sm">
                        ...
                        <div>
                            ...
                            <input required type="text" name="asal_sekolah"
                                class="w-full rounded-lg border-gray-300 px-3 py-2 shadow-sm"
                    ...
                    <div>
                        ...
                        <textarea required name="cerita" class="w-full rounded-lg border-gray-300 px-3 py-2 shadow-sm" rows="4"
                            placeholder="Tulislah hal yang ingin Anda konsultasikan"></textarea>
                    </div>
...
>>>>>>> 15609a1c2513c1485a24986d233493a9ebe4fdef
        ...
        function updateAvailableTimes(selectedDate) {
            ...
            // Jangan reset opsi waktu (biar tetap Siang / Malam kayak di HTML awal)
            ...
            if (selectedDate) {
                ...
                // ⛔️ Jangan filter jadwalPeerData, biarkan user pilih sendiri
                waktuSelect.disabled = false;
            } else {
                // Clear hari field
                document.getElementById('hari_konseling').value = '';
                waktuSelect.disabled = false; // biar tetap aktif meski tanggal kosong
            }
