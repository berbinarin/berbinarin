    ...
    <section class="flex w-full">
        <div class="flex w-full flex-col">
            <div class="py-4 md:pb-7 md:pt-12">
                ...
                <p class="w-3/4 text-disabled">Halaman yang digunakan untuk menambahkan, mengelola, dan melengkapi seluruh data pribadi, latar belakang, serta informasi penting lainnya dari peer counselor secara detail untuk keperluan administrasi dan monitoring.</p>
            </div>
                ...
                <form action="{{ route("dashboard.peer-counselors.store") }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input required name="harga" id="harga-input" class="w-full rounded-lg border-gray-300 bg-gray-100 px-3 py-2 shadow-sm" placeholder="Rp 0,00" />
                        </div>
                    </div>
