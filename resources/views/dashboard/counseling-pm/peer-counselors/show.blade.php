            ...
            <div class="w-full">
                <div class="py-4 md:pb-7 md:pt-12">
                    <div class="mb-2 flex items-center gap-2">
                        ...
                        <p class="text-base font-bold leading-normal text-gray-800 sm:text-lg md:text-2xl lg:text-4xl">Peer Counselor Data</p>
                    </div>
                    ...
                    <div class="mt-8 flex space-x-4 sm:mt-3">
                        <a href="{{ route("dashboard.peer-counselors.edit", $PeerConsellorDataDetails->id) }}" type="button" class="inline-flex items-center justify-center rounded bg-primary px-6 py-3 text-white hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2">
                            <p class="text-dark font-medium leading-none">Edit Data</p>
                        </a>
                        <button type="button" id="deleteButton" data-id="{{ $PeerConsellorDataDetails->id }}" class="inline-flex items-center justify-center rounded bg-primary px-6 py-3 text-white hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2">
                            <p class="font-medium leading-none text-white">Delete Data</p>
                        </button>
                    </div>
                </div>
                <div class="w-full max-w-[900px] justify-items-center rounded-2xl bg-white px-4 py-4 shadow-lg md:px-6 md:py-4">
                    <!-- Part 1 -->
                        ...
                        <div class="flex flex-col gap-2.5 p-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-3.5 text-base text-black">
                                    ...
                                    <span class="italic">{{ \Carbon\Carbon::parse($PeerConsellorDataDetails->created_at)->format("d/m/Y") }}</span>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-start gap-5">
                                ...
                                <span class="w-2">:</span>
                                <span class="text-lg text-black">{{ \Carbon\Carbon::parse($PeerConsellorDataDetails->jadwal_tanggal)->format("d/m/Y") }}</span>
                            </div>
                            ...
                            <div class="flex items-center justify-start gap-5">
                                ...
                                <span class="w-2">:</span>
                                <span class="text-lg text-black">{{ $PeerConsellorDataDetails->jadwal_pukul }}</span>
                            </div>
                            ...
                            <div class="flex items-center justify-start gap-5">
                                ...
                                <span class="w-2">:</span>
                                <span class="text-lg text-black">Rp {{ number_format($PeerConsellorDataDetails->harga, 0, ",", ".") }}</span>
                            </div>
                        </div>
                    </div>
                    <!-- Part 2 -->
                    <div class="mb-5 w-[803px] overflow-hidden rounded-[20px] border-[0.5px] border-black shadow-md">
                        ...
                        <div class="flex flex-col gap-2.5 p-6">
                            ...
                            <div class="flex items-center justify-start gap-5">
                                ...
                                <span class="w-2">:</span>
                                <a href="https://wa.me/62{{ ltrim($PeerConsellorDataDetails->no_wa, "0") }}" target="_blank" class="text-lg text-blue-500 underline hover:text-blue-700">{{ $PeerConsellorDataDetails->no_wa }}</a>
                            </div>
                            <div class="flex items-center justify-start gap-5">
                                <span class="w-56 text-lg text-black">Email</span>
                                <span class="w-2">:</span>
                                <a href="mailto:{{ $PeerConsellorDataDetails->email }}" class="text-lg text-blue-500 underline hover:text-blue-700">{{ $PeerConsellorDataDetails->email }}</a>
                            </div>
                            <div class="flex items-center justify-start gap-5">
                    ...
                    <div class="mb-5 w-[803px] overflow-hidden rounded-[20px] border-[0.5px] border-black shadow-md">
                        ...
                        <div class="flex flex-col gap-2.5 p-6">
                            <div class="flex items-center justify-start gap-5">
                                ...
                                <span class="w-2">:</span>
                                <span class="text-lg text-black">{{ $PeerConsellorDataDetails->kategori_voucher ?? "-" }}</span>
                            </div>
                            ...
                            <div class="flex items-center justify-start gap-5">
                                ...
                                <span class="w-2">:</span>
                                <span class="text-lg text-black">{{ $PeerConsellorDataDetails->code_voucher ?? "-" }}</span>
                            </div>
                            ...
                            <div class="flex items-center justify-start gap-5">
                                ...
                                <span class="w-2">:</span>
                                <span class="text-lg text-black">{{ $PeerConsellorDataDetails->presentase_diskon ? $PeerConsellorDataDetails->presentase_diskon . "%" : "-" }}</span>
                            </div>
                            ...
                            <div class="flex items-start justify-start gap-5">
                                ...
                                <div class="relative w-[219px]">
                                    <a href="{{ asset("assets/images/dashboard/Mengejek.jpg") }}" target="_blank">
                                        <img src="{{ asset("assets/images/dashboard/Mengejek.jpg") }}" alt="Bukti Kartu Pelajar" class="w-full rounded-md border border-gray-300 object-cover" />
                                        <div class="absolute bottom-0 left-0 w-full rounded-b-md bg-black/50 py-1 pl-2 text-start font-plusJakartaSans text-lg text-white">Mengejek.jpg</div>
                                    </a>
                                </div>
                            </div>
                        </div>
