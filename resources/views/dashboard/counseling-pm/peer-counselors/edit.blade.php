    ...
    <section class="flex w-full">
        <div class="flex w-full flex-col">
            <div class="py-4 md:pb-7 md:pt-12">
                ...
                <p class="w-3/4 text-disabled">Halaman yang digunakan untuk mengedit, mengelola, dan melengkapi seluruh data pribadi, latar belakang, serta informasi penting lainnya dari peer counselor secara detail untuk keperluan administrasi dan monitoring.</p>
            </div>
                ...
                <form action="{{ route("dashboard.peer-counselors.update", $PeerConsellorDataDetails->id) }}" method="POST" id="editForm">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input required type="text" id="tanggal_lahir" name="tanggal_lahir" value="{{ \Carbon\Carbon::parse($PeerConsellorDataDetails->tanggal_Lahir)->format("d/m/Y") }}" class="w-full rounded-lg border-gray-300 px-3 py-2 shadow-sm" placeholder="dd/mm/yy" readonly />
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <input required type="text" name="jadwal_tanggal" id="tglkonseling" value="{{ \Carbon\Carbon::parse($PeerConsellorDataDetails->jadwal_tanggal)->format("d/m/Y") }}" class="w-full rounded-lg border-gray-300 px-3 py-2 shadow-sm" placeholder="dd/mm/yy" readonly />
                        </div>
                        <div>
                            <label class="font-semibold">Hari Konseling</label>
                            <input type="text" name="hari" id="hari_konseling" value="{{ \Carbon\Carbon::parse($PeerConsellorDataDetails->jadwal_tanggal)->translatedFormat("l") }}" class="w-full rounded-lg border-gray-300 bg-gray-100 px-3 py-2 shadow-sm" readonly />
                        </div>
                        ...
                        <div>
                            ...
                            <input required name="harga" id="harga-input" value="Rp {{ number_format($PeerConsellorDataDetails->harga, 0, ",", ".") }}" class="w-full rounded-lg border-gray-300 bg-gray-100 px-3 py-2 shadow-sm" placeholder="Rp 0,00" readonly />
                        </div>
                    </div>
