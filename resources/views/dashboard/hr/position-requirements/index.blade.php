        ...
        <div class="flex flex-col">
            <div class="w-full">
                <div class="py-4 md:pb-7 md:pt-12">
                    <div class="">
                        <p tabindex="0" class="mb-2 text-base font-bold leading-normal text-gray-800 focus:outline-none sm:text-lg md:text-2xl lg:text-4xl">Position Requirements Management Data</p>
                ...
                <div class="rounded-md bg-white px-4 py-4 md:px-8 md:py-7 xl:px-10">
                    <div class="mt-4 overflow-x-auto">
                        <table id="example" class="display" style="overflow-x: scroll">
                            ...
                            <tbody>
                                @forelse ($HiringPosisitonsRequirement as $key => $item)
                                    <tr class="data-consume">
                                        ...
                                        <td class="flex gap-2">
                                            <a href="{{ route("dashboard.position-requirements.edit", $item->id) }}" class="mt-4 inline-flex items-start justify-start rounded bg-yellow-500 p-3 hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 sm:mt-0">
                                    ...
                                    {{-- modal untuk delete position requirement --}}
                                        ...
                                        <div class="relative mx-auto my-6 w-auto max-w-3xl">
                                            ...
                                            <div class="relative flex w-full flex-col rounded-lg border-0 bg-white shadow-lg outline-none focus:outline-none">
                                                ...
                                                <div class="border-blueGray-200 flex items-start justify-between rounded-t border-b border-solid p-5">
                                                    <h3 class="text-3xl font-semibold">Delete Position Description Data</h3>
                                                ...
                                                <div class="relative flex-auto p-6">
                                                    <form action="{{ route("dashboard.position-requirements.destroy", $item->id) }}" method="post">
                                                        ...
                                                        <input type="hidden" name="id" />
                                                        <p class="mb-6">
                                                            Apakah anda yakin ingin menghapus syarat untuk
                                                            <b>{{ $item->HiringPositions->name }}</b>
                                                            dengan deskripsi
                                                            <i>{{ $item->requirement }}</i>
                                                            ?
                                                        </p>
                                                        <!--footer-->
    ...
    <div class="fixed inset-0 z-50 hidden items-center justify-center overflow-y-auto overflow-x-hidden outline-none focus:outline-none" id="modal-id">
        <div class="relative mx-auto my-6 w-auto max-w-3xl">
            ...
            <div class="relative flex w-full flex-col rounded-lg border-0 bg-white shadow-lg outline-none focus:outline-none">
                <!--header-->
                <div class="border-blueGray-200 flex items-start justify-between rounded-t border-b border-solid p-5">
                    <h3 class="text-3xl font-semibold">Input Data Position Requirement</h3>
                ...
                <div class="relative flex-auto p-6">
                    <form action="{{ route("dashboard.position-requirements.store") }}" class="flex flex-col gap-1" method="post">
                        ...
                        <div class="mb-1 w-full pt-0">
                            ...
                            <textarea id="requirement" name="requirement" placeholder="Requirement" required class="placeholder-blueGray-300 text-blueGray-600 relative w-full rounded border-0 bg-white px-3 py-3 text-base shadow outline-none focus:outline-none focus:ring"></textarea>
                        </div>
