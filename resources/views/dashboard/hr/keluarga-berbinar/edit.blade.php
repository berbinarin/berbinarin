            ...
            <div class="py-4 md:pb-7 md:pt-12">
                <div class="">
                    <div class="mb-2 flex items-center gap-2">
                        ...
                        <p tabindex="0" class="text-base font-bold leading-normal text-gray-800 focus:outline-none sm:text-lg md:text-2xl lg:text-4xl">Ubah Data Staf</p>
                    </div>
                    <p class="w-full text-disabled">Admin dapat mengubah data staf dengan menyertakan input yang sesuai untuk setiap form. Data tersebut meliputi informasi data diri dan riwayat jabatan.</p>
                </div>
            </div>
                                ...
                                <div class="col-span-2">
                                    ...
                                    @if ($staff->photo)
                                        <div id="photoPreviewContainer" class="mt-3">
                                            <img src="{{ asset("storage/" . $staff->photo) }}" alt="Current Photo" class="h-40 w-40 rounded-lg border border-gray-300 object-cover shadow" />
                                        </div>
                                    @else
