            ...
            <div class="py-4 md:pb-7 md:pt-12">
                <div class="">
                    <div class="mb-2 flex items-center gap-2">
                        ...
                        <p tabindex="0" class="text-base font-bold leading-normal text-gray-800 focus:outline-none sm:text-lg md:text-2xl lg:text-4xl">Add Staff Data</p>
                    </div>
                    <p class="w-3/4 text-disabled">
                        Admin dapat menambahkan data staff dengan menyertakan input yang sesuai untuk setiap form.
                        <br />
            ...
            <div class="rounded-md bg-white px-4 py-4 shadow-lg shadow-gray-400 md:px-8 md:py-7 xl:px-10">
                <form action="{{ route("dashboard.keluarga-berbinar.store") }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 mt-4 overflow-x-auto">
                        ...
                        <div class="flex w-full gap-10 pt-5">
                        ...
                        <div class="flex w-full flex-col gap-2">
                            ...
                            <div class="flex items-center">
                                <input type="radio" name="motm" value="yes" class="mr-2" required />
                                Ya
                                <input type="radio" name="motm" value="no" class="ml-4 mr-2" required />
                                Tidak
                            </div>
                        </div>
