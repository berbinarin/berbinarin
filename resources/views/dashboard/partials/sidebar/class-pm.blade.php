...
<li class="dark-hover:text-blue-300 my-5 rounded-lg p-2">
    <a href="{{ route("dashboard.berbinar-class.index") }}" class="{{ isRouteNameStartWith("dashboard.berbinar-class") }} flex flex-row items-center text-gray-700 duration-700 hover:text-primary">
        <i class="bx bx-tab {{ isRouteNameStartWith("dashboard.berbinar-class") }} mr-2 text-lg text-gray-700"></i>
