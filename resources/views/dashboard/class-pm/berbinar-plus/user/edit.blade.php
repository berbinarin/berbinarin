                ...
                <div class="flex flex-col">
                    <div class="grid grid-cols-1 mb-10 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select id="gender" name="gender" class="peer w-full rounded-lg border-gray-300 px-4 py-4 shadow-sm bg-white" required>
                                ...
                                <div class="p-2 grid grid-cols-2 gap-4" style="background-color: white;">
                                    ...
                                    <div>
                                        ...
                                        <input type="text"
                                            ...
                                            id="otherInput" name="other_education" placeholder="Isi pendidikan lain..." {{ !in_array($user->last_education, ['SD','SMP','SMA','Ahli Madya','Sarjana']) && $user->last_education ? '' : 'disabled' }} value="{{ !in_array($user->last_education, ['SD','SMP','SMA','Ahli Madya','Sarjana']) ? $user->last_education : '' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <select id="kelas" name="kelas" class="peer w-full rounded-lg border-gray-300 px-4 py-4 shadow-sm bg-white" required>
                        ...
                        <div>
                            ...
                            <select id="paket" name="paket" class="peer w-full rounded-lg border-gray-300 px-4 py-4 shadow-sm bg-white" required>
                        ...
                        <div>
                            ...
                            <div class="relative w-full flex items-center">
                                <input type="file" id="bukti_transfer" name="bukti_transfer" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" accept="image/*,application/pdf" />
                                <div class="mt-1 block w-full h-10 pl-2 bg-gray-100 border border-gray-100 rounded-md shadow-sm pointer-events-none flex items-center">
                                    ...
                                    <span id="fileName" class="ml-3 text-base text-gray-600 truncate">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                id="sumber" name="knowing_source" required>
                                <option value="" disabled class="text-gray-500">Dari mana nihh</option>
                                @php $knowing = $user->knowing_source; @endphp
                            ...
                            <input type="text"
                                class="form-input mt-1 block w-full h-10 pl-2 bg-gray-100 border border-gray-100 rounded-md shadow-sm {{ !in_array($knowing, ['Instagram','Telegram','TikTok','LinkedIn','Teman']) && $knowing ? '' : 'hidden' }}"
                                id="otherReasonText" name="otherReasonText" placeholder="Please specify" value="{{ !in_array($knowing, ['Instagram','Telegram','TikTok','LinkedIn','Teman']) ? $knowing : '' }}">
                        </div>
                    </div>
                    ...
                    <div id="confirmModal" class="fixed inset-0 z-50 flex hidden items-center justify-center bg-black bg-opacity-50">
                        <div class="w-full max-w-md rounded-lg bg-white p-6 text-center">
                            ...
                            <p class="mb-6 text-lg">Apakah Anda yakin ingin membatalkan pengisian data?</p>
                            <div class="flex w-full justify-center gap-4">
                                <a href="{{ route("dashboard.berbinar-plus.index") }}" class="rounded-lg bg-[#3986A3] w-1/2 px-6 py-2 text-white text-center">Ya, Batalkan</a>
                                <button type="button" id="cancelSubmit" class="rounded-lg border border-[#3986A3] w-1/2 px-6 py-2 text-[#3986A3]">Tidak</button>
                            </div>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function validateForm() {
        const requiredFields = [
            'first_name', 'last_name', 'gender', 'age', 'wa_number', 'email', 'last_education', 'kelas', 'paket', 'knowing_source'
        ];
