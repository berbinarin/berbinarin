                        ...
                        <div class="relative rounded-xl border border-[#606060]/20 px-5 py-3 lg:border-none lg:px-0 lg:py-0 lg:shadow-none">
                            ...
                            <div class="mx-auto mb-4 w-full max-w-2xl">
                                <div class="relative aspect-video w-full overflow-hidden rounded-lg">
                                    <img src="{{ asset("storage/" . $article->cover_image) }}" loading="lazy" alt="artikel-banner-small" class="absolute inset-0 h-full w-full object-cover" />
                                </div>
                                ...
                                <div class="mb-2 flex w-full items-center justify-between gap-2 lg:justify-start">
                                    <div class="flex items-center justify-center gap-2">
                                        <div class="size-6 overflow-hidden rounded-full">
                                            <img src="{{ asset("storage/" . $article->author->profil_image) ? asset("assets/images/landing/arteri/" . $article->author->profil_image) : asset("assets/images/landing/arteri/dummy.png") }}" alt="profile dummy" class="object-cover" />
                                        </div>
