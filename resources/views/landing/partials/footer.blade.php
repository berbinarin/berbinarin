...
<section class="footer">
    <img src="{{ asset("assets/images/landing/vector-wave.png") }}" alt="Wave Vector" class="mb-0 w-full bg-[#F7F9FA] lg:-mb-[80px]" />
        ...
        <div class="mx-5 flex flex-row items-start justify-between max-sm:flex-col lg:mx-14">
            ...
            <div class="mb-4 w-full space-y-4 text-left lg:mb-0 lg:w-2/4">
                <div class="flex items-center space-x-1">
                    <img src="{{ asset("assets/images/landing/logo-berbinar.png") }}" alt="Logo Berbinar" class="h-8 w-auto" />
            ...
            <div class="mx-4 w-full text-left max-sm:mx-0 max-sm:mt-4 lg:w-1/4">
                ...
                <div class="-mx-2 flex flex-wrap">
                    <a href="https://x.com/PsikologiDiri?mx=2" class="mb-4 px-2" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset("assets/images/landing/asset-beranda/sosmed-icon/x.png") }}" alt="X" class="mx-auto h-5 w-auto" />
                    </a>
                    <a href="https://www.instagram.com/berbinar.in/" class="mb-4 px-2" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset("assets/images/landing/asset-beranda/sosmed-icon/instagram.png") }}" alt="Instagram" class="mx-auto h-6 w-auto" />
                    </a>
                    <a href="https://www.youtube.com/@berbinar" class="mb-4 px-2" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset("assets/images/landing/asset-beranda/sosmed-icon/youtube.png") }}" alt="Youtube" class="mx-auto h-6 w-auto" />
                    </a>
                    <a href="https://www.linkedin.com/company/berbinar/?lipi=urn%3Ali%3Apage%3Ad_flagship3_search_srp_all%3BH62OB4vFS7yp93D8kOV0oQ%3D%3D" class="mb-4 px-2" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset("assets/images/landing/asset-beranda/sosmed-icon/linkedin.png") }}" alt="Linkedin" class="mx-auto h-6 w-auto" />
                    </a>
                    <a href="https://wa.me/6282141869800" class="mb-4 px-2" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset("assets/images/landing/asset-beranda/sosmed-icon/whatsapp.png") }}" alt="Whatsapp" class="mx-auto h-6 w-auto" />
                    </a>
                    <a href="https://www.tiktok.com/@berbinar.in?_t=8zrlrhuqnha&_r=1" class="mb-4 px-2" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset("assets/images/landing/asset-beranda/sosmed-icon/tiktok.png") }}" alt="TikTok" class="mx-auto h-6 w-auto" />
                    </a>
                    <a href="https://www.facebook.com/berbinar.in" class="mb-4 px-2" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset("assets/images/landing/asset-beranda/sosmed-icon/facebook.png") }}" alt="Facebook" class="mx-auto h-6 w-auto" />
                    </a>
                    <a href="https://open.spotify.com/user/31c274wo5o5x4tujcjrimf4kujhu?si=360d3bfa5b2742f4" class="mb-4 px-2" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset("assets/images/landing/asset-beranda/sosmed-icon/spotify.png") }}" alt="Spotify" class="mx-auto h-6 w-auto" />
                    </a>
                    <a href="mailto:marketing.berbinar.in@gmail.com" class="mb-4 px-2" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset("assets/images/landing/asset-beranda/sosmed-icon/gmail.png") }}" alt="Gmail" class="mx-auto h-6 w-auto" />
                    </a>
                    <a href="https://t.me/OfficialChannelBerbinar" class="mb-4 px-2" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset("assets/images/landing/asset-beranda/sosmed-icon/telegram.png") }}" alt="Telegram" class="mx-auto h-6 w-auto" />
                    </a>
                </div>
            </div>
        </div>
