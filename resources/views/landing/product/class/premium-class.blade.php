...
@section("content")
            ...
            <div class="z-10 mx-20 flex flex-row items-center justify-between gap-x-10 max-sm:mx-4 max-sm:mt-32">
                <div class="max-lg:min-w-auto flex max-w-xl flex-1 flex-col space-y-6 max-sm:space-y-2">
                    ...
                    <div class="lg:order-3">
                        <!-- Judul untuk desktop -->
                        <h2 class="mb-4 hidden bg-gradient-to-r from-[#1C4352] to-[#3986A3] bg-clip-text py-1 font-[inter] text-6xl font-semibold text-transparent lg:block lg:text-5xl lg:tracking-wide">Premium Class</h2>

                        <!-- Judul untuk mobile -->
                        <h2 class="mb-2 block bg-gradient-to-r from-[#1C4352] to-[#3986A3] bg-clip-text py-1 font-[inter] font-semibold tracking-wide text-transparent lg:hidden" style="font-size: 32px; line-height: 40px">Premium Class</h2>
                    </div>
                ...
                <div class="py-4">
                    ...
                    <div class="px-2 pt-8 md:px-10">
                        ...
                        <div class="flex flex-col gap-1 pt-6 text-justify text-sm text-[#70787D] md:mr-40 md:text-lg">
                            ...
                            <p class="md:hidden">Belajar lebih fokus, fleksibel, dan sesuai kebutuhanmu bersama mentor berpengalaman</p>
    ...
    <section class="hidden w-full pt-16 md:block" style="padding-left: 70px; padding-right: 70px">
        ...
        <div class="relative left-1/2 w-[90%] -translate-x-1/2 overflow-hidden rounded-3xl" style="height: 350px; background-color: #205467">
            ...
            <div class="relative z-10 mt-10 flex h-full items-start justify-center">
                <h1 class="text-center font-[inter] font-semibold tracking-wide text-white" style="font-size: 32px; line-height: 40px; margin-bottom: 40px">Jenis Layanan Premium Class</h1>
            </div>
        </div>

        <!-- BAGIAN CARD NONGOL -->
        <div class="relative left-1/2 z-20 flex w-full max-w-[1090px] -translate-x-1/2 flex-wrap items-start justify-center gap-6" style="margin-top: -230px">
            <!-- Card 1 -->
            <div class="inline-flex flex-col items-center justify-start rounded-xl bg-white px-7 pb-8 pt-6 shadow-[0px_4px_12px_0px_rgba(0,0,0,0.15)] drop-shadow-lg" style="height: 414px; width: 256px">
                <div class="flex flex-col items-center justify-start gap-7">
                    <div class="text-center font-['Plus_Jakarta_Sans'] text-xl font-semibold leading-normal text-black">Kelas Daring</div>
                    <div class="w-48 bg-gray-200" style="height: 1px"></div>
                </div>
                <div class="mt-6 flex h-full flex-col items-center justify-start">
                    <p class="text-justify font-['Plus_Jakarta_Sans'] text-sm font-normal leading-normal text-[#70787D]">Model produk ini berupa akses materi pembelajaran dari narasumber sekaligus mentor kompeten sesuai topik kelas. Materi disampaikan secara daring melalui Zoom dan dapat dilanjutkan dengan sesi personal mentoring secara privat melalui chat WhatsApp, sesuai syarat dan ketentuan yang berlaku.</p>
                </div>
            </div>
            ...
            <div class="inline-flex flex-col items-center justify-start rounded-xl bg-white px-7 pb-8 pt-6 shadow-[0px_4px_12px_0px_rgba(0,0,0,0.15)] drop-shadow-lg" style="height: 414px; width: 256px">
                <div class="flex flex-col items-center justify-start gap-4">
                    <div class="w-56 text-center font-['Plus_Jakarta_Sans'] text-xl font-semibold leading-normal text-black">
                        Konseling Materi
                        <br />
                        Secara Langsung
                    </div>
                ...
                <div class="mt-6 flex h-full flex-col items-center justify-start">
                    <p class="text-justify font-['Plus_Jakarta_Sans'] text-sm font-normal leading-normal text-[#70787D]">Peserta dapat berdiskusi langsung dengan mentor berkompeten selama sesi pembelajaran daring, untuk memperdalam pemahaman materi. Diskusi berlangsung sesuai jadwal dan mengikuti syarat serta ketentuan yang berlaku.</p>
                </div>
            </div>
            ...
            <div class="inline-flex flex-col items-center justify-start rounded-xl bg-white px-7 pb-8 pt-6 shadow-[0px_4px_12px_0px_rgba(0,0,0,0.15)] drop-shadow-lg" style="height: 414px; width: 256px">
                <div class="flex flex-col items-center justify-start gap-4">
                    <div class="w-44 text-center font-['Plus_Jakarta_Sans'] text-xl font-semibold leading-normal text-black">Pemberian Tugas (Study Case)</div>
                    <div class="w-48 bg-gray-200" style="height: 1px"></div>
                </div>
                <div class="mt-6 flex h-full flex-col items-center justify-start">
                    <p class="text-justify font-['Plus_Jakarta_Sans'] text-sm font-normal leading-normal text-[#70787D]">Setiap peserta akan menerima studi kasus setelah menyelesaikan sesi mentoring. Studi kasus ini dirancang untuk menguji pemahaman dan kemampuan peserta dalam menerapkan materi ke situasi nyata. Tujuannya adalah memastikan peserta mampu mengaplikasikannya secara praktis.</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="swiper premiumClassSwiper relative z-10 overflow-visible">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="flex flex-col items-center gap-8">
                                <div class="relative z-20 flex h-16 w-16 items-center justify-center drop-shadow-lg">
                                    <div class="absolute inset-0 h-16 w-16 justify-self-center rounded-full" style="background: linear-gradient(to bottom, #74aabf 0%, #3986a3 23%, #163641 100%)"></div>
                                ...
                                <div class="flex h-[335px] w-56 flex-col items-center self-stretch rounded-xl bg-white px-7 pb-8 pt-6 drop-shadow-lg">
                                    ...
                                    <div class="mt-5 w-44 justify-start text-justify font-['Plus_Jakarta_Sans'] text-base font-medium leading-normal text-[#70787D]">
                        ...
                        <div class="swiper-slide">
                            <div class="flex flex-col items-center gap-8">
                                <div class="relative z-20 flex h-16 w-16 items-center justify-center drop-shadow-lg">
                                    <div class="absolute inset-0 h-16 w-16 rounded-full" style="background: linear-gradient(to bottom, #74aabf 0%, #3986a3 23%, #163641 100%)"></div>
                                ...
                                <div class="flex h-[335px] w-56 flex-col items-center rounded-xl bg-white px-7 pb-8 pt-6 drop-shadow-lg">
                                    ...
                                    <div class="mt-5 w-44 text-justify font-['Plus_Jakarta_Sans'] text-base font-medium leading-normal text-[#70787D]">
                        ...
                        <div class="swiper-slide">
                            <div class="flex flex-col items-center gap-8">
                                ...
                                <div class="flex h-[335px] w-56 flex-col items-center rounded-xl bg-white px-7 pb-8 pt-6 drop-shadow-lg">
                                    ...
                                    <div class="mt-5 w-44 text-justify font-['Plus_Jakarta_Sans'] text-base font-medium leading-normal text-[#70787D]">Calon peserta wajib memilih jenis kelas yang telah disediakan.</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="flex flex-col items-center gap-8">
                                ...
                                <div class="flex h-[335px] w-56 flex-col items-center rounded-xl bg-white px-7 pb-8 pt-6 drop-shadow-lg">
                                    ...
                                    <div class="mt-5 w-44 text-justify font-['Plus_Jakarta_Sans'] text-base font-medium leading-normal text-[#70787D]" style="min-height: 100px">
                ...
                <div class="swiper mySwiper relative w-full" style="height: 400px">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide z-10">
                            <div class="flex h-[350px] flex-col items-start rounded-2xl bg-white px-6 py-6 shadow-md shadow-black">
                                ...
                                <p class="mt-3 flex-grow text-justify text-xs text-[#70787D]">
                                    Model produk ini berupa akses materi pembelajaran dari narasumber sekaligus mentor kompeten sesuai topik kelas. Materi disampaikan secara daring melalui
                                    <i>Zoom</i>
                        ...
                        <div class="swiper-slide z-10">
                            <div class="flex h-[350px] flex-col items-start rounded-2xl bg-white px-6 py-6 shadow-md shadow-black">
                                <h1 class="w-full text-center text-lg font-bold text-black">Konseling Materi Secara Langsung</h1>
                                <div class="mt-3 w-full bg-gray-200" style="height: 2px"></div>
                                <p class="mt-3 flex-grow text-justify text-xs text-[#70787D]">Peserta dapat berdiskusi langsung dengan mentor berkompeten selama sesi pembelajaran daring, untuk memperdalam pemahaman materi. Diskusi berlangsung sesuai jadwal dan mengikuti syarat serta ketentuan yang berlaku.</p>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide z-10">
                            <div class="flex h-[350px] flex-col items-start rounded-2xl bg-white px-6 py-6 shadow-md shadow-black">
                                ...
                                <p class="mt-3 text-justify text-xs text-[#70787D]">Setiap peserta akan menerima studi kasus setelah menyelesaikan sesi mentoring. Studi kasus ini dirancang untuk menguji pemahaman dan kemampuan peserta dalam menerapkan materi ke situasi nyata. Tujuannya adalah memastikan peserta mampu mengaplikasikannya secara praktis.</p>
                            </div>
                        </div>
                    </div>
    ...
    <section class="mb-12 hidden w-full md:block" style="padding-top: 64px; overflow: visible">
        ...
        <div class="relative left-1/2 w-[85%] -translate-x-1/2 overflow-hidden rounded-3xl" style="height: 350px; background-color: #205467">
            ...
            <!-- JUDUL -->
            <div class="relative z-10 mt-10 flex h-full items-start justify-center">
                <h1 class="text-center font-[inter] font-semibold tracking-wide text-white" style="font-size: 32px; line-height: 40px; margin-bottom: 40px">
                    Layanan
                    <i>Premium Class</i>
                </h1>
            </div>
        ...
        <div class="relative left-1/2 z-20 flex w-full max-w-[1090px] -translate-x-1/2 flex-wrap items-start justify-center gap-6" style="margin-top: -230px">
            ...
            <div class="relative mx-3 flex w-full flex-col rounded-2xl bg-white px-6 pb-6 text-black shadow-lg" style="opacity: 0.9; width: 297px; height: 350px">
                ...
                <div class="mt-12 flex items-center justify-center">
                    <button class="justify-self-center rounded-xl bg-gradient-to-r from-[#F7B23B] to-[#AD7D29] px-6 py-2 text-base font-medium text-white">Mulai Sekarang</button>
                </div>
            </div>
                ...
                <div class="flex w-full flex-col items-center gap-6">
                    ...
                    <div class="w-full rounded-2xl bg-white px-5 text-black shadow-lg">
                        ...
                        <div class="mb-5 mt-9 flex items-center justify-center">
                            <button class="rounded-xl bg-gradient-to-r from-[#F7B23B] to-[#AD7D29] px-6 py-2 text-base font-medium text-white">Mulai Sekarang</button>
                        </div>
                    </div>
        ...
        <div class="flex flex-col px-4 py-10 md:px-16">
            ...
            <div class="grid grid-cols-1 gap-4 pt-0 md:grid-cols-2 md:pt-6 lg:grid-cols-4">
                ...
                <div class="flex h-auto min-h-[120px] w-full items-center gap-4 rounded-xl bg-white p-5 shadow-md md:flex-col md:items-center md:px-9 md:py-9 md:text-justify">
                    ...
                    <p class="mt-1 hidden text-justify text-lg font-medium text-black md:mx-auto md:mt-4 md:block md:max-w-[230px] md:pb-7">Kesempatan bertanya dan berdiskusi secara langsung</p>
                </div>
                ...
                <div class="flex h-auto min-h-[120px] w-full items-center gap-4 rounded-xl bg-white p-5 shadow-md md:flex-col md:items-center md:px-9 md:py-9 md:text-justify">
                    ...
                    <p class="mt-1 hidden text-justify text-lg font-medium text-black md:mx-auto md:mt-4 md:block md:max-w-[230px] md:pb-7">Studi kasus nyata untuk asah kemampuan analisis</p>
                </div>
            </div>
            ...
            <div class="hidden w-full md:block">
                ...
                <div class="flex w-full flex-wrap justify-center gap-4">
                    <div class="flex flex-none items-center gap-3 rounded-full px-4 py-2 text-white" style="background-color: #5b8da0">
            ...
            <div class="pt-6 md:hidden">
                ...
                <div class="mb-1 mt-2 flex justify-center">
                    <div class="inline-flex items-center gap-1 rounded-full px-2 py-1 text-[10px] text-white" style="background-color: #5b8da0">
    ...
    <section class="z-10 mx-4 pb-[50px] pt-[50px] sm:mx-20 md:pb-[75px] md:pt-[75px]">
        <ul class="flex flex-col">
            ...
            <li x-data="accordion(0)" :class="`bg-white py-2 shadow-sm rounded-lg my-2 border ${isActive() ? 'border-2 border-blue-500' : 'border'}`">
                <div class="mx-2 flex flex-row sm:mx-5">
                    <div class="flex w-full flex-col p-3 max-sm:p-2">
                        ...
                        <div class="w-full bg-gray-200 transition-all duration-300 md:hidden" :class="isActive() ? 'opacity-100' : 'opacity-0'" style="height: 1px; margin-top: 10px"></div>
                        <div x-ref="tab" :style="handleToggle()" class="max-h-0 overflow-hidden transition-all duration-500">
                            <p class="mt-5 text-justify text-neutral-600 max-sm:mt-2 max-sm:text-[15px]">
                                Tentu, SobatBinar diperbolehkan menggunakan tugas yang dikerjakan selama kelas sebagai bagian dari portofolio. Ini bisa menjadi bukti nyata atas keterampilan yang telah dipelajari dan dikembangkan selama mengikuti program
                                <i>Premium Class.</i>
                            </p>
                        </div>
                    </div>
                    <div class="ml-6 hidden items-center sm:flex">
                        ...
                        <template x-if="$store.accordion.tab !== idx">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                                <path d="M22.4 8L12 19.2 1.6 8" stroke="#3986A3" stroke-width="3" stroke-linecap="square" />
                            </svg>
                        </template>
                    </div>
                </div>
            ...
            <!-- FAQ 2 -->
            <li x-data="accordion(1)" :class="`bg-white py-2 shadow-sm rounded-lg my-2 border ${isActive() ? 'border-2 border-blue-500' : 'border'}`">
                <div class="mx-2 flex flex-row sm:mx-5">
                    <div class="flex w-full flex-col p-3 max-sm:p-2">
                        <h2 @click="handleClick()" class="cursor-pointer text-lg text-neutral-800 max-sm:text-[16.5px]">
                        ...
                        <div class="w-full bg-gray-200 transition-all duration-300 md:hidden" :class="isActive() ? 'opacity-100' : 'opacity-0'" style="height: 1px; margin-top: 10px"></div>
                        <div x-ref="tab" :style="handleToggle()" class="max-h-0 overflow-hidden transition-all duration-500">
                            <p class="mt-3 text-justify text-neutral-600 max-sm:mt-2 max-sm:text-[15px]">Ya, penjadwalan ulang kelas dapat dilakukan berdasarkan kesepakatan dengan mentor. SobatBinar disarankan memberi konfirmasi sebelumnya agar proses penjadwalan berjalan lancar dan sesuai ketentuan yang berlaku.</p>
                        </div>
                    </div>
                    <div class="ml-6 hidden items-center sm:flex">
                        <template x-if="$store.accordion.tab === idx">
            ...
            <!-- FAQ 3 -->
            <li x-data="accordion(2)" :class="`bg-white py-2 shadow-sm rounded-lg my-2 border ${isActive() ? 'border-2 border-blue-500' : 'border'}`">
                <div class="mx-2 flex flex-row sm:mx-5">
                    <div class="flex w-full flex-col p-3 max-sm:p-2">
                        <h2 @click="handleClick()" class="cursor-pointer text-lg text-neutral-800 max-sm:text-[16.5px]">
                        ...
                        <div class="w-full bg-gray-200 transition-all duration-300 md:hidden" :class="isActive() ? 'opacity-100' : 'opacity-0'" style="height: 1px; margin-top: 10px"></div>
                        <div x-ref="tab" :style="handleToggle()" class="max-h-0 overflow-hidden transition-all duration-500">
                            <p class="mt-3 text-justify text-neutral-600 max-sm:mt-2 max-sm:text-[15px]">Setelah pembelajaran berakhir serta telah menyelesaikan tugas dengan baik maka SobatBinar dapat memperoleh sertifikat.</p>
                        </div>
                    </div>
                    <div class="ml-6 hidden items-center sm:flex">
                        <template x-if="$store.accordion.tab === idx">
            ...
            <!-- FAQ 4 -->
            <li x-data="accordion(3)" :class="`bg-white py-2 shadow-sm rounded-lg my-2 border ${isActive() ? 'border-2 border-blue-500' : 'border'}`">
                <div class="mx-2 flex flex-row sm:mx-5">
                    <div class="flex w-full flex-col p-3 max-sm:p-2">
                        <h2 @click="handleClick()" class="cursor-pointer text-lg text-neutral-800 max-sm:text-[16.5px]">
                        ...
                        <div x-ref="tab" :style="handleToggle()" class="max-h-0 overflow-hidden transition-all duration-500">
                            <p class="mt-3 text-justify text-neutral-600 max-sm:mt-2 max-sm:text-[15px]">
                                Ya, studi kasus memiliki batas waktu penyelesaian yang telah ditentukan. Informasi mengenai
                                <i>deadline</i>
            ...
            <!-- FAQ 5 -->
            <li x-data="accordion(4)" :class="`bg-white py-2 shadow-sm rounded-lg my-2 border ${isActive() ? 'border-2 border-blue-500' : 'border'}`">
                <div class="mx-2 flex flex-row sm:mx-5">
                    <div class="flex w-full flex-col p-3 max-sm:p-2">
                        <h2 @click="handleClick()" class="cursor-pointer text-lg text-neutral-800 max-sm:text-[16.5px]">
                        ...
                        <div class="w-full bg-gray-200 transition-all duration-300 md:hidden" :class="isActive() ? 'opacity-100' : 'opacity-0'" style="height: 1px; margin-top: 10px"></div>
                        <div x-ref="tab" :style="handleToggle()" class="max-h-0 overflow-hidden transition-all duration-500">
                            <p class="mt-3 text-justify text-neutral-600 max-sm:mt-2 max-sm:text-[15px]">Mentor tidak tersedia setiap waktu. Namun, SobatBinar tetap dapat mengajukan pertanyaan kapan saja, dan mentor akan merespons sesuai dengan jadwal atau jam operasional yang telah ditentukan.</p>
                        </div>
                    </div>
                    <div class="ml-6 hidden items-center sm:flex">
                        <template x-if="$store.accordion.tab === idx">
