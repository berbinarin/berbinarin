...
@section("content")
                ...
                <div class="max-lg:min-w-auto flex max-w-xl flex-1 flex-col space-y-6 max-sm:space-y-2">
                    ...
                    <div class="lg:order-4">
                        <p class="text-justify text-lg text-[#70787D] max-lg:text-[17px] max-sm:text-[15px] max-sm:leading-normal">
                            ...
                            adalah produk yang membahas fenomena psikologis dari berbagai sudut pandang. Acara ini dilaksanakan secara
                            <span class="italic">live</span>
                            TikTok setiap hari Minggu pukul 20.00 WIB. Tidak hanya membahas tentang psikologi, tetapi juga membahas topik-topik lain yang dikaitkan dengan psikologi. Tentunya, mengusung konsep tanya jawab antara
                            <span class="italic">audience</span>
                            dengan psikolog. Dimana setiap
                            <span class="italic">audience</span>
                            bebas menanyakan apapun kepada psikolog secara gratis dan tidak dipungut biaya apapun. BERARTY dapat ditonton di Instagram Berbinar, dan juga tersedia di Youtube Berbinar.
                        </p>
                    </div>
                </div>
    ...
    <section class="relative w-full px-0">
        <div class="relative z-10">
            {{-- Desktop View --}}
            <h1 class="z-10 mb-4 mt-20 hidden text-center text-3xl font-semibold md:block">Konten BERARTY</h1>
            <div class="z-10 mx-4 mb-10 hidden md:mx-10 lg:mx-20 lg:block">
                <div class="z-10 mx-auto w-full max-w-full rounded-3xl bg-white px-10 pb-12 pt-10 shadow-lg md:gap-6 lg:gap-10">
                    <h1 class="mb-4 text-3xl font-semibold">
                        BERARTY
                        <span class="text-primary">Episode 54</span>
                    </h1>
                    <div class="mb-2 flex flex-col gap-6 md:flex-row">
        ...
        {{-- Mobile View --}}
        <h1 class="z-10 mb-4 mt-10 text-center text-3xl font-semibold md:hidden">Konten BERARTY</h1>
        <div class="block px-4 lg:hidden">
            <div class="mx-auto max-w-3xl rounded-3xl bg-white px-6 pb-8 pt-6 shadow-lg">
    ...
    <section>
        {{-- Desktop View --}}
        <div class="mx-4 mb-20 hidden md:mx-10 md:block lg:mx-20">
            <div class="flex flex-row gap-6">
                ...
                <div class="w-1/3 rounded-3xl px-2 py-6 shadow-lg">
                    ...
                    <a href="https://www.youtube.com/watch?v=Bb-N9gBqlcE" class="mt-3 block w-1/3 justify-self-center rounded-lg bg-gradient-to-r from-amber-400 to-yellow-700 py-2 text-center text-sm font-semibold text-white">Tonton BERARTY</a>
                </div>
                ...
                <div class="w-1/3 rounded-3xl px-2 py-6 shadow-lg">
                    ...
                    <a href="https://www.youtube.com/watch?v=OTNCLpnfmyM" class="mt-3 block w-1/3 justify-self-center rounded-lg bg-gradient-to-r from-amber-400 to-yellow-700 py-2 text-center text-sm font-semibold text-white">Tonton BERARTY</a>
                </div>
                ...
                <div class="w-1/3 rounded-3xl px-2 py-6 shadow-lg">
                    ...
                    <a href="https://www.youtube.com/watch?v=LcSNskaPi2A" class="mt-3 block w-1/3 justify-self-center rounded-lg bg-gradient-to-r from-amber-400 to-yellow-700 py-2 text-center text-sm font-semibold text-white">Tonton BERARTY</a>
                </div>
            </div>
        </div>

        {{-- Mobile View --}}
        <div class="mb-16 block px-4 md:hidden">
    ...
    <section>
        {{-- Desktop View --}}
        <div class="mx-4 mb-16 hidden md:mx-10 md:block lg:mx-20">
            <h1 class="mb-20 bg-gradient-to-r from-[#3986A3] to-[#1C4352] bg-clip-text text-center font-[inter] text-3xl font-semibold text-transparent lg:tracking-wide">Topik Konten BERARTY</h1>
    ...
    <div class="relative hidden h-0 lg:block">
        <div class="absolute -right-32 top-0 z-0 md:-right-40" style="width: 300px; height: 300px; border-top-left-radius: 420px; border-bottom-left-radius: 420px; border-top-right-radius: 420px; background: #a2d7f0; filter: blur(60px); opacity: 0.9; top: 100px"></div>
    </div>

    {{-- MANFAAT MENDENGAR BERARTY --}}
    <section class="mt-16 px-4">
        <h1 class="mb-20 bg-gradient-to-r from-[rgb(57,134,163)] to-[#1C4352] bg-clip-text text-center font-[inter] text-3xl font-semibold text-transparent lg:tracking-wide">Manfaat Mendengar BERARTY</h1>

        {{-- Desktop View --}}
        <div class="mx-4 mb-16 hidden md:mx-10 md:block lg:mx-20">
            {{-- Manfaat First Row --}}
            <div class="mb-20 mt-8 flex flex-row justify-center gap-52">
                ...
                <div class="relative w-72 rounded-2xl border-[2px] border-[#d7e6ed] bg-white px-2 pb-3 pt-14 shadow-md">
                    ...
                    <div class="flex flex-col gap-1 text-center">
                        ...
                        <span class="text-lg">
                            ...
                            <span class="italic">self-healing</span>
                        </span>
                    </div>
                </div>
                ...
                <div class="relative w-72 rounded-2xl border-[2px] border-[#d7e6ed] bg-white px-2 pb-3 pt-14 shadow-md">
                    ...
                    <div class="flex flex-col gap-1 text-center">
                        ...
                        <span class="text-lg">
                            ...
                            <span class="italic">mindful</span>
                            dan seimbang
                        </span>
                    </div>
                </div>
    ...
    <section class="mb-16 mt-20 px-0">
            ...
            <div class="flex w-full items-end gap-4 rounded-3xl bg-white px-2 shadow-lg md:gap-6 md:px-4 lg:gap-10 lg:px-6">
                ...
                <div class="mb-6 mt-1 flex w-full flex-col justify-start gap-4 md:mb-10 md:gap-6">
                    ...
                    <div class="mb-1 mt-1 flex items-center gap-2 text-[#1C4352]">
                        ...
                        <span class="text-md font-medium text-yellow-600">Jadwal BERARTY</span>
                    </div>
                        ...
                        <div class="mt-4 grid grid-cols-1 gap-3 md:mt-10 md:grid-cols-3 md:gap-4">
                            <div class="relative flex h-[180px] w-full flex-col justify-center overflow-hidden rounded-3xl bg-white p-4 text-center shadow-[0_4px_24px_0_#3986A373]">
                                ...
                                <div class="z-10 flex flex-col justify-center text-center">
                                    ...
                                    <span class="mb-4 mt-1 text-xl text-[#555555]">
                                        Tiktok
                                        <span class="italic">Live</span>
                                        BERARTY setiap minggu pukul
                                    </span>
                            ...
                            <div class="relative flex h-[180px] w-full flex-col justify-center overflow-hidden rounded-3xl bg-white p-4 text-center shadow-[0_4px_24px_0_#3986A373]">
                                ...
                                <div class="z-10 flex flex-col justify-center text-center">
                                    ...
                                    <span class="mb-4 mt-1 text-center text-xl text-[#555555]">
                                        <span class="italic">Replay</span>
                                        BERARTY akan diperbarui setiap hari :
                                    </span>
    ...
    {{-- KONSULTASI SEKARANG --}}
    <section class="z-10 mx-4 mb-16 sm:mx-20 lg:my-14">
        {{-- Desktop View --}}
        <div class="hidden md:block">
            <div class="relative flex flex-col items-center rounded-2xl bg-gradient-to-b from-cyan-700 to-slate-950 p-12 shadow-xl">
                ...
                <a href="#" class="mb-2 mt-2 block rounded-2xl bg-white px-8 py-3 text-center text-xl font-semibold text-black">Lihat Produk Berbinar</a>
            </div>
        </div>
        ...
        <div class="md:hidden">
            <div class="relative flex flex-col items-center rounded-2xl bg-gradient-to-b from-cyan-700 to-slate-800 p-4 shadow-xl">
                ...
                <a href="#" class="mb-2 mt-2 block rounded-lg bg-white px-4 py-2 text-center font-semibold text-black">Pilih Jadwal</a>
            </div>
        </div>
    </section>
@endsection
