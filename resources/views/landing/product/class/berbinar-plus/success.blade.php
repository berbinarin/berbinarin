    ...
    <div class="flex flex-no-wrap pt-8">
        <div class="w-full mt-14 md:mt-28 justify-center items-center">
            <div class="bg-white rounded-3xl p-5 md:px-12 xl:px-16 w-full shadow-xl" style="max-width: 80%; margin: auto;">
                ...
                <img class="justify-self-center" src="{{ asset('assets/images/landing/produk/emo/cheer.webp') }}" alt="">
                <h1 class="text-xl font-semibold text-center mb-8 mt-1 bg-gradient-to-r from-[#F7B23B] to-[#916823] bg-clip-text text-transparent">Akun anda berhasil terdaftar pada kelas BERBINAR+.<br>Nantikan informasi selanjutnya yang akan diumumkan melalui WhatsApp/Email</h1>
