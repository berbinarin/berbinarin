      ...
      <div class="relative">
            ...
            <div class="relative">
                ...
                >
                    <div class="max-lg:min-w-auto flex max-w-xl flex-1 flex-col space-y-6 max-sm:space-y-2">
                        ...
                        >
                            <img
                                src="{{ asset("assets/images/landing/produk/bisikan/banner-1.png") }}"
                                alt="Class"
                        ...
                        <div class="lg:order-3">
                            <h2 class="text-gradient py-2 text-5xl font-bold max-sm:text-3xl text-[#3986A3]">BISIKAN</h2>
                        </div>
                        ...
                        <div class="lg:order-4">
                            ...
                            >
                                ...
                                <i>sharing session</i>
                                eksklusif kami di Instagram, di mana kita akan bersama-sama merambah ke dalam lapisan
                                terdalam pikiran dan emosi. Temukan rahasia-rahasia kehidupan yang penuh warna bersama
                                kami.
                            </p>
                        </div>
                    </div>
        ...
        <section class="relative w-full px-0">
            ...
            <div class="relative z-10 mx-4 sm:mx-20">
                <div
                    class="flex w-full flex-col-reverse items-center gap-6 rounded-3xl bg-white px-6 pb-8 pt-6 shadow-lg md:flex-row md:items-start"
                >
                    <!-- Kiri: Teks -->
                    <div class="flex flex-1 flex-col justify-start">
                        ...
                        <p class="mt-3 text-justify text-base font-medium text-[#70787D] lg:text-lg">
                            "Mengubah <i>Stress</i> Kerja Menjadi Sukses dengan <i>Self-Compassion</i>"
                        </p>
                        <p class="text-justify text-base leading-relaxed text-[#70787D] lg:text-lg">
                            Stres di dunia kerja sering dianggap musuh, padahal bisa menjadi peluang untuk tumbuh jika
                            dikelola dengan
                            <i>self-compassion</i>
                            . Dalam episode ini, kita bahas bagaimana <i>self compassion</i> justru meningkatkan produktivitas,
                            ketahanan mental, dan kepuasan kerja. Kamu akan belajar mengenali stres, merespons dengan
                            lebih bijak, dan membangun rutinitas kerja yang sehat tanpa menyiksa diri.
                        </p>
                        <div class="mt-5">
                            <a
                                href="https://youtu.be/2YGAcGSlxTo?si=zgly-gJVqsxMWHXX"
                                class="inline-block rounded-lg bg-gradient-to-r from-[#F7B23B] to-[#AD7D29] px-6 py-2 font-semibold text-white shadow"
                                target="_blank"
                    ...
                    <div class="flex w-full flex-1 items-center justify-center md:justify-end">
                        <img
                            src="{{ asset("assets/images/landing/produk/bisikan/bisikan-episode22.png") }}"
                            alt="BISIKAN Episode 22"
                            class="mt-6 h-auto w-full max-w-xs rounded-xl border object-contain md:mr-8 lg:max-w-md"
                        />
                    </div>
                </div>
            </div>
                        ...
                        <div class="rounded-2xl p-4 shadow-lg">
                            ...
                            <div class="mt-4 flex flex-col gap-2">
                                ...
                                <a
                                    href="{{ $episode["link"] }}"
                                    target="_blank"
                                    class="mx-auto mt-3 rounded-lg bg-gradient-to-r from-[#F7B23B] to-[#AD7D29] px-6 py-2 text-center text-sm font-semibold text-white"
                                >
                                    Tonton BISIKAN
                                </a>
                            </div>
                                ...
                                <div class="flex h-full flex-col rounded-2xl p-4 shadow-lg">
                                    ...
                                    <div class="mt-4 flex flex-1 flex-col gap-3 px-2 text-center">
                                        ...
                                        <a
                                            href="{{ $episode["link"] }}"
                                            target="_blank"
                                            class="mx-auto mb-2 mt-4 w-full max-w-[200px] rounded-lg bg-gradient-to-r from-[#F7B23B] to-[#AD7D29] px-8 py-3 text-center text-sm font-semibold text-white"
                                        >
                                            Tonton BISIKAN
                                        </a>
                                    </div>
        ...
        <section class="relative z-10 px-6 pt-10 md:px-0">
            <h1
                class="bg-gradient-to-r from-[#3986A3] to-[#1C4352] bg-clip-text text-center font-[inter] text-3xl font-semibold text-transparent lg:tracking-wide"
            >
                Topik Konten BISIKAN
            </h1>
        ...
        <div class="relative hidden h-0 md:block">
            <div
                class="absolute -left-32 top-0 z-0 md:-left-40"
                style="
                    width: 300px;
                    height: 300px;
        ...
        <div class="relative hidden h-0 md:block">
            <div
                class="absolute -right-32 top-0 z-0 md:-right-40"
                style="
                    width: 300px;
                    height: 300px;
                    border-top-left-radius: 420px;
                ...
                <div class="grid grid-cols-2 gap-x-4 gap-y-8 lg:grid-cols-5 lg:gap-x-8 lg:gap-y-12">
                    ...
                    <div class="relative rounded-lg border-2 border-[#d7e6ed] px-2 pb-3 pt-8 md:px-6 md:py-8 lg:col-start-3">
                        ...
                        <div class="flex h-full flex-col justify-center gap-1 text-center">
                            ...
                            <span class="text-sm">Memberi ruang refleksi dan <i>self-healing</i></span>
                        </div>
                    </div>
                    ...
                    <div class="relative rounded-lg border-2 border-[#d7e6ed] px-2 pb-3 pt-8 md:px-6 md:py-8 lg:col-start-4">
                        ...
                        <div class="flex h-full flex-col justify-center gap-1 text-center">
                            ...
                            <span class="text-sm">Mendukung gaya hidup yang lebih <i>mindful</i> dan seimbang</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="mt-20 px-0">
            ...
            <div class="mx-4 hidden md:mx-10 md:block lg:mx-20">
                <div
                    class="flex w-full items-end gap-4 rounded-3xl bg-white px-2 shadow-lg md:gap-6 md:px-4 lg:gap-10 lg:px-6"
                >
                    {{-- Bagian KIRI: Gambar --}}
                    <div class="mt-6 flex h-full w-[40%] items-end md:mt-10 md:w-[45%] lg:w-[50%]">
                        <img
                            src="{{ asset("assets/images/landing/produk/bisikan/Clip-path.png") }}"
                            alt="Gambar BISIKAN"
                            class="h-auto max-h-[180px] w-full object-contain md:max-h-[250px] lg:max-h-[350px]"
                        />
                    </div>
                    ...
                    <div class="mb-6 mt-1 flex w-full flex-col justify-start gap-4 md:mb-10 md:gap-6">
                        ...
                        <div class="mt-4 grid grid-cols-1 gap-3 md:mt-10 md:grid-cols-3 md:gap-4">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                class="flex h-12 w-full max-w-[320px] items-center justify-center gap-2 rounded-full border-4 border-[#8FE0AC] bg-gradient-to-r from-[#8FE0AC] to-[#3986A3] px-4 py-2 font-semibold text-white shadow ring-2 ring-inset ring-white"
                            >
                                <img
                                    src="{{ asset($sosmed[0]["icon"] ?? "") }}"
                                    alt="{{ $sosmed[0]["platform"] ?? "Spotify" }}"
                                    class="h-5 w-5"
                                />
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                class="flex h-12 w-full max-w-[320px] items-center justify-center gap-2 rounded-full border-4 border-[#D77BB2] bg-gradient-to-r from-[#D77BB2] to-[#3986A3] px-4 py-2 font-semibold text-white shadow ring-2 ring-inset ring-white"
                            >
                                <img
                                    src="{{ asset($sosmed[1]["icon"] ?? "") }}"
                                    alt="{{ $sosmed[1]["platform"] ?? "Instagram" }}"
                                    class="h-5 w-5"
                                />
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                class="flex h-12 w-full max-w-[320px] items-center justify-center gap-2 rounded-full border-4 border-[#DC6E6E] bg-gradient-to-r from-[#DC6E6E] to-[#3986A3] px-4 py-2 font-semibold text-white shadow ring-2 ring-inset ring-white"
                            >
                                <img
                                    src="{{ asset($sosmed[2]["icon"] ?? "") }}"
                                    alt="{{ $sosmed[2]["platform"] ?? "Youtube" }}"
                                    class="h-5 w-5"
                                />
                        ...
                        <div class="mb-1 mt-1 flex items-center gap-2 text-[#1C4352]">
                            <img
                                src="{{ asset("assets/images/landing/produk/bisikan/calendar.svg") }}"
                                alt="Kalender"
                                class="h-8 w-8"
                            />
                        ...
                        <div class="flex flex-col gap-4 md:flex-row md:gap-6">
                            ...
                            <div class="flex flex-1 flex-col items-center justify-center">
                                <div
                                    class="relative flex h-[180px] w-full flex-col items-center justify-center overflow-hidden rounded-3xl bg-white p-3 text-center shadow-[0_4px_24px_0_#3986A373]"
                                >
                                    {{-- eclipse bg --}}
                                    <img
                                        src="{{ asset("assets/images/landing/produk/bisikan/eclipse/Ellipse_1.png") }}"
                                        alt=""
                                        class="absolute bottom-0 right-0 z-0"
                                    />
                                    <img
                                        src="{{ asset("assets/images/landing/produk/bisikan/eclipse/Ellipse_2.png") }}"
                                        alt=""
                                        class="absolute bottom-0 right-0 z-0"
                                    />
                                    <img
                                        src="{{ asset("assets/images/landing/produk/bisikan/eclipse/Ellipse_3.png") }}"
                                        alt=""
                                        class="absolute left-0 top-0 z-0"
                                    />
                                    <img
                                        src="{{ asset("assets/images/landing/produk/bisikan/eclipse/Ellipse_4.png") }}"
                                        alt=""
                                        class="absolute bottom-0 left-0 z-0"
                                    />
                                    <img
                                        src="{{ asset("assets/images/landing/produk/bisikan/eclipse/Ellipse_5.png") }}"
                                        alt=""
                                        class="absolute left-0 top-0 z-0"
                                    />

                                    <div
                                        class="z-10 flex w-full flex-col justify-center"
                                        style="height: calc(100% - 1rem)"
                                    >
                                        <span
                                            class="mb-1 block text-center text-xs font-semibold leading-tight text-cyan-950 sm:text-sm md:text-base lg:text-lg xl:text-xl"
                                        >
                                            BISIKAN Spotify Update
                                        </span>
                                        <span
                                            class="my-1 block text-center text-[10px] leading-tight text-[#555555] sm:text-xs md:text-sm"
                                        >
                                            Diadakan Setiap:
                                        </span>
                                        <span
                                            class="block text-center text-xs font-bold leading-tight text-cyan-950 sm:text-sm md:text-base lg:text-lg"
                                        >
                                            Awal Bulan
                                        </span>
                                    </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span
                                            class="my-1 block text-center text-[10px] leading-tight text-[#555555] sm:text-xs md:text-sm"
                                        >
                                            Video terbaru BISIKAN Youtube akan diupdate setiap:
                                        </span>
                                        <span
                                            class="block text-center text-xs font-bold leading-tight text-cyan-950 sm:text-sm md:text-base lg:text-lg"
                                        >
                                            Minggu ke-2 Tiap Bulan
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            class="mb-1 block text-center text-xs font-semibold leading-tight text-cyan-950 sm:text-sm md:text-base lg:text-lg xl:text-xl"
                                        >
                                            Instagram Live BISIKAN
                                        </span>
                                        <span
                                            class="my-1 block text-center text-[10px] leading-tight text-[#555555] sm:text-xs md:text-sm"
                                        >
                                            Live Instagram BISIKAN hadir setiap:
                                        </span>
                                        <span
                                            class="block text-center text-xs font-bold leading-tight text-cyan-950 sm:text-sm md:text-base lg:text-lg"
                                        >
                ...
                <div class="flex w-full flex-col gap-6 rounded-3xl bg-white px-4 py-6 shadow-lg">
                    ...
                    <div class="flex w-full items-center justify-between gap-2">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            class="h-[clamp(2.5rem, 6vw, 3.25rem)] flex basis-1/3 items-center justify-center gap-1 rounded-full border-4 border-[#8FE0AC] bg-gradient-to-r from-[#8FE0AC] to-[#3986A3] px-3 py-2 font-semibold text-white shadow ring-2 ring-inset ring-white"
                        >
                            <img
                                src="{{ asset($sosmed[0]["icon"] ?? "") }}"
                                alt="{{ $sosmed[0]["platform"] ?? "Spotify" }}"
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            class="h-[clamp(2.5rem, 6vw, 3.25rem)] flex basis-1/3 items-center justify-center gap-1 rounded-full border-4 border-[#D77BB2] bg-gradient-to-r from-[#D77BB2] to-[#3986A3] px-3 py-2 font-semibold text-white shadow ring-2 ring-inset ring-white"
                        >
                            <img
                                src="{{ asset($sosmed[1]["icon"] ?? "") }}"
                                alt="{{ $sosmed[1]["platform"] ?? "Instagram" }}"
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            class="h-[clamp(2.5rem, 6vw, 3.25rem)] flex basis-1/3 items-center justify-center gap-1 rounded-full border-4 border-[#DC6E6E] bg-gradient-to-r from-[#DC6E6E] to-[#3986A3] px-3 py-2 font-semibold text-white shadow ring-2 ring-inset ring-white"
                        >
                            <img
                                src="{{ asset($sosmed[2]["icon"] ?? "") }}"
                                alt="{{ $sosmed[2]["platform"] ?? "Youtube" }}"
                    ...
                    <div class="flex flex-col gap-4">
                        {{-- Card 1: Spotify --}}
                        <div
                            class="relative flex flex-col items-center overflow-hidden rounded-xl bg-white p-4 shadow-[0_4px_24px_0_#3986A373]"
                        >
                            {{-- eclipse bg --}}
                            <img
                                src="{{ asset("assets/images/landing/produk/bisikan/eclipse/Ellipse_6.png") }}"
                                alt=""
                                class="absolute bottom-0 z-0"
                            />
                            <img
                                src="{{ asset("assets/images/landing/produk/bisikan/eclipse/Ellipse_7.png") }}"
                                alt=""
                                class="absolute bottom-0 z-0"
                            />
                            <img
                        ...
                        >
                            ...
                            <div class="z-10 flex flex-col justify-center text-center">
                                ...
                                <span class="mt-1 text-center text-lg text-[#555555]">
                                    Video terbaru BISIKAN di Youtube akan diupdate setiap:
                                </span>
