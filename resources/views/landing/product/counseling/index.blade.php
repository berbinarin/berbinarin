...
@section('content')
                ...
                <div class="max-lg:min-w-auto flex max-w-xl flex-1 flex-col space-y-6 max-sm:space-y-2">
                    ...
                    <div class="lg:order-4">
                        <p
                            ...
                            Merasa terjebak dalam rutinitas yang membosankan? Membutuhkan panduan untuk mengatasi masalah
                            hidup? Konseling Berbinar solusinya! Bersama para psikolog dan
                            <i>peer counselor</i>
                            yang berpengalaman, Berbinar siap membantu klien untuk menemukan solusi tepat mengenai masalah
                            yang dihadapi, dengan mencapai pertumbuhan untuk menuju hidup yang lebih baik.
                        </p>
                    </div>

                    <div id="openModal" class="flex justify-start lg:order-5">
                        <button
                            class="text-md openModalBtn rounded-xl bg-gradient-to-r from-[#3986A3] to-[#225062] px-4 py-2 text-white max-sm:rounded-md max-sm:px-6 max-sm:text-[15px]">Lakukan
                            Konseling</button>
                    </div>
                    <div id="modal"
                        class="fixed inset-0 -top-6 z-30 flex hidden items-center justify-center bg-gray-900 bg-opacity-50 backdrop-blur-md max-sm:-top-2">
                        <div
                            ...
                            <div class="mb-6">
                                <div class="flex items-start gap-2">
                                    <img src="{{ asset('assets/images/landing/asset-konseling/vector/location.png') }}"
                                        alt="Lokasi" class="mt-0.5 h-5 w-5" />
                            ...
                            <div class="mb-6">
                                <div class="flex items-start gap-2">
                                    <img src="{{ asset('assets/images/landing/asset-konseling/vector/payment.png') }}"
                                        alt="Pembayaran" class="mt-0.5 h-5 w-5" />
                                    <span class="font-semibold">Pembayaran</span>
                                </div>
                                <ol class="mt-1 list-decimal space-y-1 pl-7">
                                    <li class="max-sm:text-sm">Melakukan pembayaran ke Bank Mandiri dengan no rekening
                                        1400020763711 a.n. Berbinar Insightful Indonesia dengan aturan transfer 1×24 jam.
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="mt-1 list-decimal space-y-1 pl-7">
                                    <li class="max-sm:text-sm">Tidak membalas pesan admin dalam 1×24 jam, pendaftaran oleh
                                        klien secara otomatis dibatalkan.</li>
                                    <li class="max-sm:text-sm">Tidak membalas pesan admin dalam 1×24 jam, jadwal yang sudah
                                        ditentukan oleh klien berhak untuk diubah oleh Tim Berbinar dan kesepakatan dari
                                        klien.</li>
                                    <li class="max-sm:text-sm">Tidak membalas pesan admin dalam 2×24 jam setelah melakukan
                                        pembayaran, pembayaran dianggap hangus.</li>
                                </ol>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="mt-1 list-decimal space-y-1 pl-7">
                                    <li class="max-sm:text-sm">Pengajuan proses pembatalan layanan konseling dapat dilakukan
                                        dalam kurun waktu 1×24 jam setelah proses administrasi dan dana yang telah
                                        dibayarkan akan dikembalikan 100%.</li>
                                </ol>
                            </div>
                            ...
                            <div class="mt-4 flex justify-center lg:gap-x-3">
                                <a href="{{ route('product.counseling.registration') }}">
                                    <button id=""
                                        class="rounded-md bg-gradient-to-r from-[#3986A3] to-[#225062] px-20 py-1.5 font-medium text-white max-sm:text-[15px]">Saya
                                        Mengerti</button>
                                </a>
                            </div>
                        </div>
            ...
            <div class="flex flex-col items-center gap-y-10 md:mx-20 md:flex-row md:justify-center md:gap-x-20 md:gap-y-0">
                ...
                <div class="flex w-full max-w-[318px] flex-col items-center">
                    ...
                    <div class="mb-4 flex flex-row items-center justify-center">
                        ...
                        <img src="{{ asset('assets/images/landing/asset-konseling/vector/sun.png') }}" alt="Vector"
                            class="ml-2 h-4 w-auto md:h-5" />
                    </div>

                    <!-- Card -->
                    <div
                        class="relative flex h-full max-w-[318px] flex-col overflow-hidden rounded-xl bg-white px-4 py-5 shadow-lg md:max-h-[394px] md:px-6 md:py-6">
                        <!-- Ribbon -->
                        <div class="absolute right-0 top-0">
                            <div
                                class="flex h-6 w-[110px] translate-x-[28px] translate-y-[12px] rotate-45 items-center justify-center bg-gradient-to-r from-[#F7B23B] via-[#D29732] to-[#AD7D29] font-plusJakartaSans text-[11px] font-bold text-white shadow-md md:h-8 md:w-[140px] md:translate-x-[35px] md:translate-y-[18px] md:text-sm">
                                8%</div>
                        </div>
                        ...
                        <div class="flex flex-col items-start font-plusJakartaSans font-semibold">
                            ...
                            <div class="flex flex-col items-start">
                                <span
                                    class="-mb-1 text-sm text-[#676767] line-through md:-mb-1 md:text-lg">Rp150.000</span>
                                <div class="flex items-baseline gap-2">
                                    <span
                                        class="bg-gradient-to-r from-[#F7B23B] via-[#D29732] to-[#AD7D29] bg-clip-text text-2xl text-transparent md:text-[32px]">Rp135.000</span>
                                    <span
                                        class="-top-1 font-plusJakartaSans text-sm font-normal text-black md:-top-2 md:text-lg">/jam</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Divider -->
                        <div
                            class="mx-auto my-4 h-[1px] w-full max-w-[220px] bg-gradient-to-r from-transparent via-[#D7E6ED] to-transparent md:my-6 md:w-[270px]">
                        </div>
                        ...
                        <div class="flex flex-col items-start font-plusJakartaSans font-semibold">
                            ...
                            <div class="flex flex-col items-start">
                                <div class="flex items-baseline gap-1">
                                    <span
                                        class="bg-gradient-to-r from-[#F7B23B] via-[#D29732] to-[#AD7D29] bg-clip-text text-2xl text-transparent md:text-[32px]">Rp175.000</span>
                                    <span
                                        class="-top-1 font-plusJakartaSans text-sm font-normal text-black md:-top-2 md:text-lg">/jam</span>
                                </div>
                            </div>
                        ...
                        <button id="openModal" class="pt-5 md:pt-6">
                            <a href="#"
                                class="openModalBtn block w-full rounded-lg bg-gradient-to-r from-[#F7B23B] via-[#D29732] to-[#AD7D29] py-2 text-center font-plusJakartaSans text-sm font-semibold text-white md:px-[83.75px] md:text-[14px]">Mulai
                                Sekarang</a>
                        </button>
                    </div>
                </div>
                ...
                <div class="flex w-full max-w-[318px] flex-col items-center">
                    ...
                    <div class="mb-4 flex flex-row items-center justify-center">
                        ...
                        <img src="{{ asset('assets/images/landing/asset-konseling/vector/sunglasses.png') }}"
                            alt="Vector" class="ml-2 h-6 w-auto md:h-8" />
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-col items-start font-plusJakartaSans font-semibold">
                            ...
                            <div class="flex flex-col items-start">
                                <span
                                    class="-mb-1 text-sm text-[#676767] line-through md:-mb-1 md:text-lg">Rp200.000</span>
                                <div class="flex items-baseline gap-1">
                                    <span
                                        class="bg-gradient-to-r from-[#F7B23B] via-[#D29732] to-[#AD7D29] bg-clip-text text-2xl text-transparent md:text-[32px]">Rp180.000</span>
                                    <span
                                        class="-top-1 font-plusJakartaSans text-sm font-normal text-black md:-top-2 md:text-lg">/jam</span>
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col items-start font-plusJakartaSans font-semibold">
                            ...
                            <div class="flex flex-col items-start">
                                <div class="flex items-baseline gap-1">
                                    <span
                                        class="bg-gradient-to-r from-[#F7B23B] via-[#D29732] to-[#AD7D29] bg-clip-text text-2xl text-transparent md:text-[32px]">Rp225.000</span>
                                    <span
                                        class="-top-1 font-plusJakartaSans text-sm font-normal text-black md:-top-2 md:text-lg">/jam</span>
                                </div>
                            </div>
                    ...
                    <div class="relative mx-auto flex w-full max-w-[270px] justify-center">
                        <div
                            ...
                            <div id="openModal" class="mb-1 mt-5 flex justify-center">
                                <button
                                    class="openModalBtn rounded-lg bg-gradient-to-r from-[#F7B23B] to-[#AD7D29] px-4 py-1.5 text-sm text-white">Mulai
                                    Sekarang</button>
                            </div>
                        </div>
                    </div>
    ...
    <section class="mt-60 max-md:mt-0">
        <h1
            class="font mt-8 text-center text-4xl font-semibold text-black max-md:mx-10 max-sm:mx-2 max-sm:mt-2 max-sm:text-[29px]">
