                ...
                <div class="space-y-3 flex flex-col">
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <div class="relative">
                            ...
                            <span
                                class="absolute left-[64px] top-1/2 -translate-y-1/2 text-[#333] text-base pointer-events-none">WIB</span>
...
<<<<<<< HEAD
    ...
    <script>
        ...
        const HARGA = {
            online: {
                weekdays: [135000, 275000, 415000],
                weekend: [180000, 310000, 460000]
            },
            offline: {
                weekdays: [175000, 350000, 525000],
                weekend: [225000, 340000, 500000]
...
<<<<<<< HEAD
            ...
            let harga = 0;
            if (!isWeekend) {
                if (metode === 'online') harga = {
                    1: 150000,
                    2: 300000,
                    3: 450000
                } [sesi];
                else if (metode === 'offline') harga = {
                    1: 175000,
                    2: 350000,
                    3: 525000
                } [sesi];
