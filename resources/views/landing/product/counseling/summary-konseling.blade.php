...
<div class="sm:mt-36 mt-24 sm:mb-20 mb-8 sm:mx-24 mx-4 md:bg-white bg-none justify-center flex flex-col md:shadow-lg shadow-none rounded-2xl px-12 max-md:px-1 py-6">
    ...
    <div id="modal" class="fixed bg-gray-900 bg-opacity-50 backdrop-blur-md hidden inset-0 items-center justify-center z-30" style="display: none;">
    ...
    <div class="flex justify-center items-center pt-10">
        <a href="{{ route('product.counseling.index') }}" class="w-full flex justify-center">
