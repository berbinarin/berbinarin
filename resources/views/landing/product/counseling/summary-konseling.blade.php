...
@section("content")
    ...
    <div class="mx-4 mb-8 mt-24 flex flex-col justify-center rounded-2xl bg-none px-12 py-6 shadow-none max-md:px-1 sm:mx-24 sm:mb-20 sm:mt-36 md:bg-white md:shadow-lg">
        ...
        <div id="modal" class="fixed inset-0 z-30 hidden items-center justify-center bg-gray-900 bg-opacity-50 backdrop-blur-md" style="display: none">
        ...
        <div class="flex flex-col space-y-4">
            <h1 class="text-gradient text-center text-3xl font-semibold max-sm:mx-2 max-sm:text-[29px]">Terima Kasih</h1>
