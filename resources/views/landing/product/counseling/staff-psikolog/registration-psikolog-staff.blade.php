...
@section("content")
    ...
    <div class="mx-4 mb-8 mt-24 flex flex-col justify-center rounded-2xl bg-none px-12 py-6 shadow-none max-md:px-1 sm:mx-24 sm:mb-20 sm:mt-36 md:bg-white md:shadow-lg">
        ...
        <form id="singleForm" action="{{ route("product.counseling.psikolog.staff.store") }}" method="POST" class="flex flex-col" enctype="multipart/form-data">
            @csrf
            ...
            <div class="step-section active">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <div class="relative">
                            <input type="text" name="kegiatan_sosial" class="w-full cursor-pointer rounded-lg border-none bg-[#F1F3F6] px-3 py-3 shadow-md focus:ring-[#3986A3] md:shadow-none" placeholder="Cth: volunteer, organisasi, dll" />
                        </div>
                    </div>
                    {{-- Nomor WhatsApp --}}
                    <div class="flex flex-col space-y-1">
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <div class="relative">
                            <input name="email" required type="email" class="w-full cursor-pointer rounded-lg border-none bg-[#F1F3F6] px-3 py-3 shadow-md focus:ring-[#3986A3] md:shadow-none" placeholder="BudiSigmaMewing@gmail.com" />
                        </div>
                    </div>
                </div>
                {{-- Riwayat Pendidikan dan Pekerjaan --}}
                <h1 class="font text-gradient my-10 text-center text-3xl font-semibold max-sm:mx-2 max-sm:text-[29px]">Riwayat Pendidikan dan Pekerjaan</h1>
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    {{-- Pekerjaan Saat Ini --}}
                    <div class="flex flex-col space-y-1">
                        <p class="text-base text-[#333333]">Pendidikan Terakhir</p>
                        <div class="relative">
                            <input type="text" name="pendidikan" required class="w-full cursor-pointer rounded-lg border-none bg-[#F1F3F6] px-3 py-3 shadow-md focus:ring-[#3986A3] md:shadow-none" placeholder="Cth: Semester 5 Fakultas Psikologi Universi..." />
                        </div>
                    </div>
                    {{-- Kegiatan Sosial --}}
                    <div class="flex flex-col space-y-1">
                        ...
                        <div class="relative">
                            <input type="text" name="riwayat_pekerjaan" required class="w-full cursor-pointer rounded-lg border-none bg-[#F1F3F6] px-3 py-3 shadow-md focus:ring-[#3986A3] md:shadow-none" placeholder="Cth: Peer Counselor, Berbinar Insightful Indonesia 2022-2..." />
                        </div>
                    </div>
                </div>
                {{-- Jadwal dan Preferensi Konseling --}}
                <h1 class="font text-gradient my-10 text-center text-3xl font-semibold max-sm:mx-2 max-sm:text-[29px]">Jadwal dan Preferensi Konseling</h1>
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    {{-- Divisi --}}
                    <div class="flex flex-col space-y-1">
                        <p class="text-base text-[#333333]">Divisi</p>
                        <div class="relative">
                            <input type="text" name="divisi" required class="w-full cursor-pointer rounded-lg border-none bg-[#F1F3F6] px-3 py-3 shadow-md focus:ring-[#3986A3] md:shadow-none" placeholder="Web & Mobile Developer" />
                        </div>
                    </div>
                    {{-- Posisi --}}
                    <div class="flex flex-col space-y-1">
                        ...
                        <div class="relative">
                            <input type="text" name="posisi" required class="w-full cursor-pointer rounded-lg border-none bg-[#F1F3F6] px-3 py-3 shadow-md focus:ring-[#3986A3] md:shadow-none" placeholder="Front-End Developer" />
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <div class="relative">
                            <input type="time" name="jadwal_pukul" value="12:00" required class="w-full cursor-pointer rounded-lg border-none bg-[#F1F3F6] px-3 py-3 shadow-md focus:ring-[#3986A3] md:shadow-none" />
                        </div>
                    </div>
                ...
                <h1 class="font text-gradient my-10 text-center text-3xl font-semibold max-sm:mx-2 max-sm:text-[29px]">Kondisi dan Permasalahan</h1>
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <div class="relative">
                            <input type="text" name="topik_pengajuan" required class="w-full rounded-lg border-none bg-[#F1F3F6] px-3 py-3 shadow-md focus:ring-[#3986A3] md:shadow-none" placeholder="Cth: Review CV / Overthinking / Insecurities / Kecemasan / DLL" />
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <div class="relative">
                            <textarea name="cerita" rows="3" required class="w-full resize-none rounded-lg border-none bg-[#F1F3F6] px-3 py-3 shadow-md focus:ring-[#3986A3] md:shadow-none" placeholder="Mental saya belakangan ini kurang stabil"></textarea>
                        </div>
                    </div>
                </div>

                <div class="flex items-center justify-center pt-10">
                    <button type="submit" class="rounded-xl bg-gradient-to-r from-[#3986A3] to-[#15323D] px-[136px] py-[10px] text-xl font-medium text-white md:px-[177px] md:py-3 md:text-2xl">Kirim</button>
                </div>
            </div>
        </form>
    </div>
