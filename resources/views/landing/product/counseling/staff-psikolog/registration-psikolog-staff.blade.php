...
@section('content')
            ...
            <div id="step-1" class="step-section active">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <div class="relative">
                            <input type="time" name="waktu_pengajuan" value="12:00" required
                                class="w-full cursor-pointer rounded-lg border-none bg-[#F1F3F6] px-3 py-3 shadow-md focus:ring-[#3986A3] md:shadow-none" />
                        </div>
                    </div>
    ...
    {{-- Modal untuk syarat dan ketentuan --}}
        ...
        <div class="h-auto max-sm:max-h-[90%] max-h-screen w-[70%] overflow-y-auto rounded-2xl bg-white p-6 max-sm:px-2 shadow-md max-lg:h-[90%] max-sm:w-[86%]">
            ...
            <div class="mb-6">
                <div class="flex items-start gap-2">
                    <img src="{{ asset('assets/images/landing/asset-konseling/vector/sk-vector.png') }}" alt="Pembalasan Pesan" class="h-5 w-5 mt-0.5" />
                    <span class="font-semibold">Ketentuan</span>
                </div>
                <ol class="list-decimal mt-1 space-y-1 pl-7">
                    <ul class="max-sm:text-sm">Sesuai dengan ketentuan yang ada di kontrak kerja terkait pemberian benefit kepada staff yang bekerja di PT. Berbinar Insightful Indonesia, bagi para staff yang ingin mengambil benefit konseling 1 kali/bulan bersama psikolog (Pak Danny) dan Peer, kalian dapat mengikuti alur dibawah ini</ul>
                </ol>
            </div>
