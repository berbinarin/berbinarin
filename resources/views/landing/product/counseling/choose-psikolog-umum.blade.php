...
@section('content')
    ...
    <div class="hidden md:block text-center font-semibold text-black text-base sm:text-base mt-5">
        <span>
                ...
                <div class="flex flex-col justify-center space-y-3 p-3 text-center">
                    ...
                    <div class="flex justify-center">
                        @if ($konseling['nama'] === 'Peer Counselor')
                            <a href="{{ route('product.counseling.peer-counselor.registration') }}">
                                <button
                                    class="text-sm rounded-xl bg-gradient-to-r from-[#3986A3] to-[#225062] px-4 py-2 text-white max-sm:px-6 max-sm:text-[15px]">
