    ...
    <div class="mx-4 mb-8 mt-24 flex flex-col justify-center rounded-2xl bg-none px-12 py-6 shadow-none max-md:px-1 sm:mx-24 sm:mb-20 sm:mt-36 md:bg-white md:shadow-lg">
        ...
        <div class="flex flex-row justify-between" id="step-2-header" style="display: none">
            <div class="flex cursor-pointer items-center space-x-2" onclick="prevStep(1)">
                ...
                <p class="flex text-[15px] font-semibold text-[#3986A3]">
                    Kembali
                    <span class="ml-0.5 hidden sm:block">isi jadwal</span>
                </p>
            </div>
        ...
        <div class="flex flex-row justify-between" id="step-3-header" style="display: none">
            <div class="flex cursor-pointer items-center space-x-2" onclick="prevStep(2)">
                <img src="{{ asset("assets/images/landing/asset-konseling/vector/left-arrow.svg") }}" alt="Left Arrow" class="h-3 w-auto" />
                <p class="flex text-[15px] font-semibold text-[#3986A3]">
                    Kembali
            ...
            <div class="flex cursor-pointer items-center space-x-1" id="openModal3">
                <img src="{{ asset("assets/images/landing/asset-konseling/vector/sk-vector.png") }}" alt="Syarat & Ketentuan" class="h-3 w-auto" />
                <p class="text-[15px] font-semibold text-[#3986A3]">
                    <span class="hidden sm:block">Syarat & Ketentuan</span>
                    <span class="block sm:hidden">S&K</span>
        ...
        <form id="multiStepForm" action="{{ route("product.counseling.peer-counselor.staff.store") }}" method="POST" class="flex flex-col" enctype="multipart/form-data">
            @csrf
            ...
            <div id="step-1" class="step-section active">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div class="flex flex-col space-y-1">
                        <p class="text-sm text-[#333333] sm:text-[17px]">Tanggal Konseling</p>
                        <div class="relative">
                            <input type="text" required name="jadwal_tanggal" id="tglkonseling" class="w-full cursor-pointer rounded-lg border-none bg-[#F1F3F6] px-3 py-3 shadow-md focus:ring-[#3986A3] md:shadow-none" placeholder="dd/mm/yy" autocomplete="off" readonly />
                            <img src="{{ asset("assets/images/landing/asset-konseling/vector/date.png") }}" class="absolute right-5 top-1/2 h-4 w-auto -translate-y-1/2 object-contain max-sm:hidden" onclick="document.getElementById('tglkonseling').focus()" />
                        </div>
                    </div>
                    {{-- Waktu Konseling --}}
                    <div class="flex flex-col space-y-1">
                        <p class="text-sm text-[#333333] sm:text-[17px]">Waktu Konseling</p>
                        <div class="relative">
                            <input type="text" id="waktukonseling" name="jadwal_pukul" required class="w-full cursor-pointer rounded-lg border-none bg-[#F1F3F6] px-3 py-3 shadow-md focus:ring-[#3986A3] md:shadow-none" placeholder="--:--" autocomplete="off" readonly />
                            <span class="pointer-events-none absolute left-[64px] top-1/2 -translate-y-1/2 text-base text-[#333]">WIB</span>
                            <img src="{{ asset("assets/images/landing/asset-konseling/vector/clock.png") }}" class="absolute right-5 top-1/2 h-4 w-auto -translate-y-1/2 object-contain max-sm:hidden" onclick="document.getElementById('waktukonseling').focus()" />
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-center pt-10">
                    <button type="button" class="text-md w-full rounded-xl bg-gradient-to-r from-[#3986A3] to-[#225062] px-24 py-2 text-white max-sm:text-[15px] sm:w-auto" onclick="validateAndNextStep(3)">Selanjutnya</button>
                </div>
            </div>
            ...
            <div id="step-3" class="step-section">
                ...
                <div class="flex flex-col space-y-1">
                    <p class="text-sm text-[#333333] sm:text-[17px]">Topik Pengajuan</p>
                    <div class="relative">
                        <textarea name="topik_pengajuan" class="h-96 w-full cursor-pointer resize-none rounded-lg border-none bg-[#F1F3F6] px-3 pt-3 text-start shadow-md focus:ring-[#3986A3] md:shadow-none" placeholder="Review CV / Overthinking / Insecurities / Kecemasan / DLL"></textarea>
                    </div>
                </div>
                <div class="flex flex-col space-y-1">
                    <p class="text-sm text-[#333333] sm:text-[17px]">Tuliskan Apa yang Ingin Anda Ceritakan</p>
                    <div class="relative">
                        <textarea name="cerita" class="h-96 w-full cursor-pointer resize-none rounded-lg border-none bg-[#F1F3F6] px-3 pt-3 text-start shadow-md focus:ring-[#3986A3] md:shadow-none" placeholder="Tidak ada minimum/batas jumlah kata"></textarea>
                    </div>
                </div>
                <div class="flex items-center justify-center pt-10">
