            ...
            <div class="relative flex h-full flex-col justify-center space-y-3 text-left max-md:text-center">
                ...
                <a href="{{ route("product.psikotes.registration") }}">
                    <div class="relative z-10 flex justify-start max-md:justify-center">
                        <a href="{{ route("product.psikotes.registration") }}" class="text-md rounded-xl bg-gradient-to-r from-[#3986A3] to-[#225062] px-4 py-2 text-white max-sm:rounded-md max-sm:px-6 max-sm:text-[15px]">Daftar Psikotes Individu</a>
                    </div>
                </a>
            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="flex h-full max-h-[300px] w-full max-w-[250px] flex-col items-center justify-center rounded-2xl bg-white px-2 py-4 text-center shadow-md">
                                ...
                                <div class="my-3 flex justify-center">
                                    <a href="{{ route("product.psikotes.registration") }}" class="rounded-lg bg-gradient-to-r from-[#F7B23B] to-[#AD7D29] px-4 py-1.5 text-sm text-white">Mulai Sekarang</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            @foreach ($individus as $individu)
                <div class="flex h-full w-full flex-col items-center justify-center rounded-2xl bg-white p-4 text-center shadow-md">
                    ...
                    <div class="mt-3 flex w-full justify-center">
                        <a href="{{ route("product.psikotes.registration") }}" class="w-full rounded-xl bg-gradient-to-r from-[#F7B23B] to-[#AD7D29] py-1.5 text-[13px] text-white">Mulai Sekarang</a>
                    </div>
                </div>
            @endforeach
        </div>
    ...
    <section>
        <div class="bg-perusahaan relative z-10 mx-20 mt-10 h-auto rounded-3xl p-10 max-sm:mx-4 max-sm:p-5">
            ...
            <div class="relative flex h-full flex-col justify-center space-y-3 text-left max-md:text-center">
                ...
                <a href="{{ route("product.psikotes.registration") }}">
                    <div class="relative z-10 flex justify-start max-md:justify-center">
                        <a href="{{ route("product.psikotes.registration") }}" class="text-md rounded-xl bg-gradient-to-r from-[#3986A3] to-[#225062] px-4 py-2 text-white max-sm:rounded-md max-sm:px-6 max-sm:text-[15px]">Daftar Psikotes Perusahaan</a>
                    </div>
                </a>
            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="flex h-full max-h-[500px] w-full max-w-[350px] flex-col items-center justify-center rounded-2xl bg-white p-4 text-center shadow-md">
                                    ...
                                    <div class="my-4 flex justify-center">
                                        <a href="{{ route("product.psikotes.registration") }}" class="rounded-lg bg-gradient-to-r from-[#F7B23B] to-[#AD7D29] px-4 py-1.5 text-[16px] text-white">Mulai Sekarang</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
    ...
    <section>
        <div class="bg-pendidikan relative z-10 mx-20 mt-14 h-auto rounded-3xl p-10 max-sm:mx-4 max-sm:p-5">
            ...
            <div class="relative flex h-full flex-col justify-center space-y-3 text-left max-md:text-center">
                ...
                <a href="{{ route("product.psikotes.registration") }}">
                    <div class="relative z-10 flex justify-start max-md:justify-center">
                        <a href="{{ route("product.psikotes.registration") }}" class="text-md rounded-xl bg-gradient-to-r from-[#3986A3] to-[#225062] px-4 py-2 text-white max-sm:rounded-md max-sm:px-6 max-sm:text-[15px]">Daftar Psikotes Instansi Pendidikan</a>
                    </div>
                </a>
            </div>
    ...
    <section>
        <div class="bg-komunitas relative z-10 mx-20 mt-10 h-auto rounded-3xl p-10 max-sm:mx-4 max-sm:p-5">
            ...
            <div class="relative flex h-full flex-col justify-center space-y-3 text-left max-md:text-center">
                ...
                <a href="{{ route("product.psikotes.registration") }}">
                    <div class="relative z-10 flex justify-start max-md:justify-center">
                        <a href="{{ route("product.psikotes.registration") }}" class="text-md rounded-xl bg-gradient-to-r from-[#3986A3] to-[#225062] px-4 py-2 text-white max-sm:rounded-md max-sm:px-6 max-sm:text-[15px]">Daftar Psikotes Komunitas</a>
                    </div>
                </a>
            </div>
