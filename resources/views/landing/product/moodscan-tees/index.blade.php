...
@section("content")
            ...
            <div class="z-10 mx-20 flex flex-row items-center justify-between gap-x-10 max-sm:mx-4 max-sm:mt-32">
                <div class="max-lg:min-w-auto flex max-w-xl flex-1 flex-col space-y-6 max-sm:space-y-2">
                    ...
                    <div class="hidden w-full items-center justify-center max-lg:flex-none max-md:flex lg:order-2 lg:w-auto">
                        <img src="{{ asset("assets/images/landing/produk/moodscan-tees/banner-moodscan-tees.webp") }}" alt="Moodscan Tees" class="h-[340px] w-auto object-contain max-sm:h-[320px] scale-110" />
                    </div>
                ...
                <div class="flex w-full flex-initial items-center justify-center max-lg:flex-1 max-md:hidden lg:w-auto">
                    <img src="{{ asset("assets/images/landing/produk/moodscan-tees/banner-moodscan-tees.webp") }}" alt="Moodscan Tees" class="h-[340px] w-auto max-lg:h-[320px]" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="relative w-full px-4 mb-6 lg:mb-[22rem] overflow-x-clip">
        <img src="{{ asset("assets/images/landing/produk/moodscan-tees/Squiggly-line.webp") }}" alt="" class="absolute left-0 top-10 lg:top-6 z-10 w-full lg:w-[100%] object-fill scale-90 lg:scale-75">
        <div class="relative flex flex-col w-full lg:px-16 gap-4 lg:gap-80">
            <div class="flex flex-row mb-6 w-full justify-start z-20">
                <div class="w-[85%] lg:w-[75%] h-20 mb-6">
                    <img src="{{ asset("assets/images/landing/produk/moodscan-tees/Mood-Card.webp") }}" alt="Mood" class="lg:w-full">
                </div>
            </div>
            ...
            <div class="flex flex-row mb-6 w-full justify-end z-20">
                <div class="w-[85%] lg:w-[75%] h-20 mb-6">
                    <img src="{{ asset("assets/images/landing/produk/moodscan-tees/Scan-Card.webp") }}" alt="Scan" class="lg:w-full">
                </div>
            </div>
            ...
            <div class="flex flex-row mb-6 w-full justify-start z-20">
                <div class="w-[85%] lg:w-[75%] h-20 mb-6 ml-4 lg:ml-0">
                    <img src="{{ asset("assets/images/landing/produk/moodscan-tees/Tees-Card.webp") }}" alt="Tees" class="lg:w-full">
                </div>
            </div>
        ...
        <div class="w-[90%] rounded-xl lg:rounded-3xl shadow-lg lg:shadow-2xl p-3 px-6 lg:px-32 lg:py-10 z-10" style="background: linear-gradient(90deg,rgba(223, 245, 253, 1) 0%, rgba(66, 102, 115, 1) 100%);">
            <div class="flex flex-row justify-between w-full gap-10 lg:gap-10">
                <div class="flex flex-col w-1/2 lg:w-2/5">
                    <img src="{{ asset("assets/images/landing/produk/moodscan-tees/T-shirt-size-table.webp") }}" alt="Size, width, and height; S, 66, 48; M, 68, 50; L, 70, 52; XL, 73, 54; 2XL, 75, 56; 3XL, 77, 58; 4XL, 79, 60; 5XL, 81, 62" class="mb-4">

                </div>
                <div class="flex flex-col w-1/2 lg:w-2/5">
                    <img src="{{ asset("assets/images/landing/produk/moodscan-tees/T-shirt.webp") }}" alt="T-shirt" class="lg:mb-4 scale-125">
    ...
    <section class="w-full flex flex-row justify-center mb-7 lg:mb-20 overflow-x-clip">
        <div class="w-[90%] flex flex-row justify-between lg:justify-center gap-4 lg:gap-20">
            ...
            <a href="https://www.tokopedia.com/berbinarin/moodscan-tees-by-berbinar-in-x-esize-kaos-edukatif-unisex-m-ea46b" target="_blank" class="lg:w-1/4 hover:scale-110 hover:rotate-3 transition-all">
                ...
                <img src="{{ asset("assets/images/landing/produk/moodscan-tees/MoodScan-Tees-Front.webp") }}" alt="T-shirt front" class="lg:w-full ">
            ...
            {{-- <a href="https://www.tokopedia.com/berbinarin/moodscan-tees-by-berbinar-in-x-esize-kaos-edukatif-unisex-m-ea46b" target="_blank" class="bg-white rounded-xl shadow border p-2 lg:w-1/4 hover:scale-110 hover:rotate-3 transition-all">
                ...
                <img src="{{ asset("assets/images/landing/produk/moodscan-tees/MoodScan-Tees-Front.webp") }}" alt="T-shirt front" class="rounded-xl lg:w-full">
                ...
                <img src="{{ asset("assets/images/landing/produk/moodscan-tees/T-shirt-front.webp") }}" alt="T-shirt front" class="rounded-xl lg:w-full">
            ...
            <a href="https://www.tokopedia.com/berbinarin/moodscan-tees-by-berbinar-in-x-esize-kaos-edukatif-unisex-m-ea46b" target="_blank" class="lg:w-1/4 hover:scale-110 hover:rotate-3 transition-all">
                ...
                <img src="{{ asset("assets/images/landing/produk/moodscan-tees/MoodScan-Tees-Back.webp") }}" alt="T-shirt back" class="lg:w-full">
            ...
            {{-- <a href="https://www.tokopedia.com/berbinarin/moodscan-tees-by-berbinar-in-x-esize-kaos-edukatif-unisex-m-ea46b" target="_blank" class="bg-white rounded-xl shadow border p-2 lg:w-1/4 hover:scale-110 hover:rotate-3 transition-all">
                ...
                <img src="{{ asset("assets/images/landing/produk/moodscan-tees/T-shirt-back.webp") }}" alt="T-shirt back" class="rounded-xl lg:w-full">
                <div class="absolute -translate-y-7 lg:-translate-y-11 rounded-r-lg lg:rounded-r-xl bg-white px-2 py-1">
                    <div class="bg-black rounded-2xl px-4 py-1 text-white text-sm lg:text-3xl lg:px-6">Beli</div>
                </div>
            </a> --}}
                    ...
                    <ul class="splide__list mb-12">
                        <li class="splide__slide mb-2">
                            ...
                            <div class="flex flex-col mb-2 items-center rounded-2xl shadow bg-white h-full px-5 py-4">
                                <img src="{{ asset("assets/images/landing/produk/moodscan-tees/reason-1.webp") }}" alt="" class="w-20 h-20 mb-4">
                        ...
                        <li class="splide__slide mb-2">
                            <!-- Card 2 -->
                            <div class="flex flex-col mb-2 items-center rounded-2xl shadow bg-white h-full px-5 py-4">
                                <img src="{{ asset("assets/images/landing/produk/moodscan-tees/reason-2.webp") }}" alt="" class="w-20 h-20 mb-4">
                        ...
                        <li class="splide__slide mb-2">
                            <!-- Card 3 -->
                            <div class="flex flex-col mb-2 items-center rounded-2xl shadow bg-white h-full px-5 py-4">
                                <img src="{{ asset("assets/images/landing/produk/moodscan-tees/reason-3.webp") }}" alt="" class="w-20 h-20 mb-4">
                        ...
                        <li class="splide__slide mb-2">
                            <!-- Card 4 -->
                            <div class="flex flex-col mb-2 items-center rounded-2xl shadow bg-white h-full px-5 py-4">
                                <img src="{{ asset("assets/images/landing/produk/moodscan-tees/reason-4.webp") }}" alt="" class="w-20 h-20 mb-4">
                        ...
                        <li class="splide__slide mb-2">
                            <!-- Card 5 -->
                            <div class="flex flex-col mb-2 items-center rounded-2xl shadow bg-white h-full px-5 py-4">
                                <img src="{{ asset("assets/images/landing/produk/moodscan-tees/reason-5.webp") }}" alt="" class="w-20 h-20 mb-4">
