...
@section("style")
    <style>
        ...
        @keyframes slide {
            ...
            to {
                transform: translateX(calc(-60% - 8px));
            }
        }

        .profile-slide {
            animation: 100s slide linear infinite;
        }
...
@section("content")
            ...
            <div class="w-full text-center md:flex md:flex-wrap md:items-center md:justify-center">
                ...
                <div class="md:z-10 md:w-1/2 md:items-start md:justify-start md:text-start">
                    ...
                    <div class="mb-2 md:mb-8">
                        <h1 class="mb-4 bg-gradient-to-r from-[#1C4352] to-[#3986A3] bg-clip-text py-1 font-[inter] text-4xl font-semibold text-transparent lg:text-5xl lg:tracking-wide">
                            Gabung & Jadilah
                    ...
                    {{-- button --}}
                    <a href="{{ route("career.positions.index") }}" class="mx-auto flex h-12 w-fit items-center justify-center rounded-lg bg-gradient-to-tr from-[#F7B23B] to-[#AD7D29] px-4 py-2 text-center text-lg text-white transition duration-300 hover:opacity-80 hover:shadow-lg md:mx-0 lg:text-xl">Lihat Posisi Tersedia</a>
                </div>
    ...
    <section class="mx-auto mt-16 flex w-full items-center justify-center overflow-hidden lg:mt-32">
        <div class="container mx-auto md:mx-14">
            ...
            <div class="mb-12 md:mb-32">
                <h1 class="mb-4 bg-gradient-to-r from-[#1C4352] to-[#3986A3] bg-clip-text py-3 text-center font-plusJakartaSans text-3xl font-semibold text-transparent md:text-4xl lg:text-5xl lg:tracking-wide">
                    Alur Pendaftaran
    ...
    <section class="mx-auto mt-16 flex w-full items-center justify-center overflow-hidden lg:mt-32">
        <div class="container mx-auto md:mx-14">
            {{-- captions --}}
            <div class="mb-12 md:mb-32">
                <h1 class="mb-4 bg-gradient-to-r from-[#1C4352] to-[#3986A3] bg-clip-text py-1 text-center font-plusJakartaSans text-3xl font-semibold text-transparent md:text-4xl lg:text-5xl lg:tracking-wide">Manfaat Bergabung di Berbinar</h1>
            </div>
            {{-- grid benefit --}}
    ...
    <section class="mx-auto mt-16 flex w-full items-center justify-center lg:mt-32">
        <div class="container mx-auto md:mx-14">
            ...
            <div class="mx-auto mb-4 w-full md:mb-8">
                <h2 class="mb-4 bg-gradient-to-r from-[#1C4352] to-[#3986A3] bg-clip-text py-1 text-center font-plusJakartaSans text-3xl font-semibold text-transparent md:text-4xl lg:text-5xl lg:tracking-wide">Posisi Tersedia</h2>
            </div>
            {{-- caption END --}}

            {{-- list START --}}
            <div class="mx-auto flex w-full flex-wrap items-center justify-center gap-x-8 gap-y-12 border-orange-500 py-12">
                @forelse ($positions->take($positions->count() / 2)->chunk(ceil($positions->count() / 2)) as $chunk)
                    @foreach ($chunk as $position)
                        {{-- card start --}}
                        <div id="{{ $position->id }}" class="w-72 flex-col rounded-xl bg-white p-2 shadow-benefit-icon">
                            {{-- banner start --}}
                            <div class="relative mb-8 h-24 w-full md:mb-4 md:h-32">
                                {{-- image-banner start --}}
                                <div class="h-full w-full overflow-hidden rounded-t-lg">
                                    <img src="{{ asset("image/positions/banner/" . $position->banner_path) }}" alt="{{ $position->name . " banner" }}" class="h-full w-full object-cover" />
                                </div>
                                {{-- image-banner end --}}
                            ...
                            <div class="mb-4 hidden w-full items-start md:flex">
                                <div class="flex items-center justify-center rounded-full bg-[#F7B23B4D] px-2 py-1 shadow-magang">
                            ...
                            <div class="mb-8 w-full md:mb-4">
                                <h3 class="h-10 text-center font-inter text-base font-normal text-black md:text-start">
                                    {{ $position->name }}
                                </h3>
                            </div>
                            {{-- caption end --}}
                            ...
                            <div class="mb-4 flex w-full items-center justify-center md:mb-1">
                                <a href="{{ route("career.positions.detail", $position->id) }}" class="w-3/4 rounded-lg bg-primary px-2 py-2 text-center text-sm font-normal text-white hover:opacity-80 hover:shadow-lg md:w-full">Lihat Selengkapnya</a>
                            </div>
                            {{-- button end --}}
            ...
            <div class="flex w-full items-center justify-center py-4">
                <a href="{{ route("career.positions.index") }}" class="rounded-xl bg-gradient-to-r from-[#3986A3] to-[#15323D] px-12 py-3 font-plusJakartaSans text-base font-normal tracking-wide text-white hover:opacity-70 hover:shadow-lg md:px-16 md:text-lg">Posisi Lainnya</a>
            </div>
            {{-- posissi lainnya end --}}
        </div>
    </section>
    ...
    <section class="mx-auto mt-16 flex w-full items-center justify-center lg:mt-32">
        <div class="container mx-auto md:mx-14">
            ...
            <div class="mx-auto mb-10 w-full md:mb-16">
                <h2 class="mb-4 bg-gradient-to-r from-[#1C4352] to-[#3986A3] bg-clip-text py-1 text-center font-plusJakartaSans text-3xl font-semibold tracking-wide text-transparent md:text-4xl md:tracking-normal lg:text-5xl lg:tracking-wide">Kata Mereka Tentang Magang di Berbinar</h2>
            </div>
            {{-- caption END --}}
                            ...
                            <div class="swiper-slide">
                                <div class="relative h-96 w-full max-w-sm rounded-3xl bg-white px-4 pb-2 pt-4 shadow-md md:h-[480px]">
                                    ...
                                    <div class="absolute bottom-4 left-1/2 w-full -translate-x-1/2">
                                        <img src="{{ asset($testimoni["image"]) }}" alt="Kutip" class="mx-auto -mt-3 mb-4 h-[70px] w-[70px] rounded-full object-cover max-sm:h-[62px] max-sm:w-[62px]" />
                                        <p class="mx-auto mb-2 block text-center text-base font-semibold text-black">
                                            {{ $testimoni["name"] }}
                                        </p>
