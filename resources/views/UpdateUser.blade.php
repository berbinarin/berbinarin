...
<body>
    ...
    <div class="container">
        ...
        <div class="card" style="margin-top: 40px">
            ...
            <form method="POST" action="/HiringPositions/{{ $HiringPositions->id }}" style="padding: 50px">
                @csrf
                @method('put')
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Username</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="username" aria-describedby="emailHelp" value="{{ $user->username }}">
                  </div>
                <div class="mb-3">
