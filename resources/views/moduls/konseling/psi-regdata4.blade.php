    ...
    <div id="data4">
        <div class="flex items-center justify-center w-screen lg:w-screen h-full">
            <div class="flex flex-col w-full h-screen sm:flex-row">
                <div class="w-full md:pt-5 pl-7 lg:pl-13 lg:ml-0 items-center">
                    ...
                    <div class="mt-6 mx-0 sm:mx-20 md:mx-30 lg:mx-0 justify-items-center">
                        <div class="text-center justify-items-center">
                            <textarea placeholder="Tulislah hal yang ingin anda konsultasikan" class="bg-[#F1F3F6] text-[#555555] border-2 w-[350px] h-64 rounded-lg p-4 mt-3 mr-5 sm:mr-0"></textarea>
                        </div>
