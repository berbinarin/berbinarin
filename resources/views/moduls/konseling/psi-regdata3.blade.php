                    ...
                    <form>
                        <div class="mt-6 mx-0 sm:mx-20 md:mx-30 lg:mx-0 justify-items-start">
                            <div class="anak-ke mt-4">
                                ...
                                <input type="text" placeholder="Anak ke 2 dari 3 bersaudara" class="bg-[#F1F3F6] text-[#555555] border-2 h-11 w-[300px] lg:w-[420px] rounded-lg px-3 mt-1" required>
                            </div>
                            <div class="pendidikan mt-4">
                                <p class="text-left text-[#555555]">Pendidikan Saat Ini</p>
                                <input type="text" placeholder="S1 Universitas Airlangga (semester 2)" class="bg-[#F1F3F6] text-[#555555] border-2 h-11 w-[300px] lg:w-[420px] rounded-lg px-3 mt-1" required>
                            </div>
                            <div class="workex mt-4">
                                <p class="text-left text-[#555555]">Riwayat Pekerjaan</p>
                                <input type="text" placeholder="Sales - PT. Berbinar Insightful Indonesia (2022)" class="bg-[#F1F3F6] text-[#555555] border-2 h-11 w-[300px] lg:w-[420px] rounded-lg px-3 mt-1" required>
                            </div>
                            <div class="hobby mt-4">
                                <p class="text-left text-[#555555]">Hobi</p>
                                <input type="text" placeholder="Masukkan Hobi Anda" class="bg-[#F1F3F6] text-[#555555] border-2 h-11 w-[300px] lg:w-[420px] rounded-lg px-3 mt-1" required>
                            </div>
                            <div class="sosact mt-4">
                                <p class="text-left text-[#555555]">Kegiatan Sosial Yang diikuti</p>
                                <input type="text" placeholder="Pengabdian Pemuda Masa Kini (2023)" class="bg-[#F1F3F6] text-[#555555] border-2 h-11 w-[300px] lg:w-[420px] rounded-lg px-3 mt-1" required>
                            </div>
                            <div class="text-start">
                                <button onclick="window.location.href='{{ route('psi-regData4') }}'" class="button-con-reg inline-block rounded-lg w-fit my-6 px-5 py-3 text-base font-medium text-white">
                                    Selanjutnya
                                </button>
                            </div>
                        </div>
