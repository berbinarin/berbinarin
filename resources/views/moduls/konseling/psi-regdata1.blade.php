                    ...
                    <form>
                        <div class="mt-6 mx-0 sm:mx-20 md:mx-30 lg:mx-0 justify-items-start">
                            ...
                            <div class="text-start">
                                <button onclick="window.location.href='{{ route('psi-regData2') }}'" class="button-con-reg inline-block rounded-lg w-fit my-6 px-5 py-3 text-base font-medium text-white">
                                    Selanjutnya
                                </button>
                            </div>
                        </div>
