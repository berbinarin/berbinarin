    ...
    <div class="flex w-screen mt-10">   
        <div class="w-2/5 mx-auto items-center">
            ...
            <div class="text-center">
                <button onclick="window.location.href='{{ route('regData4') }}'" class="button-con-reg inline-block rounded-lg w-[420px] my-6 px-5 py-3 text-base font-medium text-white">
                    Selanjutnya
                </button>  
            </div>     
        </div>
