                    ...
                    <form action="{{ route('post-peer-regData2') }}" method="POST">
                        ...
                        <div class="mt-6 mx-0 sm:mx-20 md:mx-30 lg:mx-0 justify-items-start">
                            <div class="placebirth mt-4">
                                ...
                                <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $konselling->tempat_lahir ?? '') }}" placeholder="Masukkan Tempat Lahir" class="bg-[#F1F3F6] text-[#555555] border-2 h-11 w-full rounded-lg px-3 mt-1" required>
                            </div>
