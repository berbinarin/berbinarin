                        ...
                        <tbody>
                            ...
                            <tr id="adminDataPsikotesFree_{{ $user->id }}" class="data-consume">
                                ...
                                <td class="flex gap-2">
                                    ...
                                    {{-- BUTTON EDIT  --}}
                                    <button onclick="toggleModal('edit-modal-{{ $user->id }}')" type="button"
...
<div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center"
    ...
    <div class="relative w-auto my-6 mx-auto max-w-3xl">
        ...
        <div
            ...
            <!--body-->
            <div class="relative p-6 flex-auto">
                <form action="{{ route('dashboard.psikotestfree.data.edit', $user->id) }}" class="flex flex-col gap-1"
                    method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex gap-1 mb-2">
                        <div class="mb-1 pt-0 flex-1">
                            <label for="pukul_mulai" class="text-blueGray-600 text-base">Pukul Mulai</label>
                            <input name="pukul_mulai" id="pukul_mulai" value="{{ $user->date_of_birth }}" type="time"
                                class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full"
                                required />
                        </div>
                        <div class="mb-6 pt-0 flex-1">
                            <label for="pukul_selesai" class="text-blueGray-600 text-base">Pukul Selesai</label>
                            <input name="pukul_selesai" id="pukul_selesai" value="{{ $user->email }}" type="time"
                                class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full"
                                required />
                        </div>
                        <div class="mb-6 pt-0 flex-1">
                            <label for="pukul_selesai" class="text-blueGray-600 text-base">Pukul Selesai</label>
                            <input name="pukul_selesai" id="pukul_selesai" value="{{ $test->test_date }}" type="time"
                                class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full"
                                required />
                        </div>
                    </div>
