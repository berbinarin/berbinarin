                    ...
                    <table id="example" class="display" style="overflow-x: scroll;">
                        ...
                        <tbody>
                            ...
                            <tr class="data-consume">
                                ...
                                <td class="flex gap-2">
                                    <button onclick="toggleModal('edit-modal-{{ $question->id}}')" type="button" class="focus:ring-2 focus:ring-offset-2 mt-0 inline-flex items-start justify-start p-3 bg-yellow-500 hover:bg-yellow-500 rounded">
                                        <i class='bx bxs-edit-alt text-dark'></i>
                                    </button>
                                </td>
                            </tr>

                            <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="edit-modal-{{ $question->id}}">
                                <div class="relative w-auto my-6 mx-auto max-w-3xl">
                                    ...
                                    <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                        ...
                                        <div class="flex flex-row justify-between gap-16 w-full p-5 border-b border-solid border-blueGray-200 rounded-t">
                                            ...
                                            <div>
                                                <button class="bg-red-600 h-[30px] w-[30px] rounded-full text-white" onclick="toggleModal('edit-modal-{{ $question->id}}')">
                                        ...
                                        <div class="relative p-6 flex-auto">
                                            <form action="{{ route('dashboard.psikotestfree.question.update', $question->id) }}" class="flex flex-col gap-1" method="post">
                                                @csrf
                                                @method('PUT')
                                                <div class="flex flex-col gap-5">
                                                    <div class="flex flex-row gap-10">
                                                        <div class="mb-1 pt-0 flex-1">
                                                            <label for="category" class="text-blueGray-600 text-base font-semibold">Kategori</label>
                                                            <select disabled name="category" id="category" style="height: 50px" class="appearance-none px-3 py-3 text-disabled relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full">
                                                        ...
                                                        <div class="mb-1 pt-0 flex-1">
                                                            <label for="rn" class="text-blueGray-600 text-base font-semibold">R/N</label>
                                                            <select disabled name="rn" id="rn" style="height: 50px" class="appearance-none px-3 py-3 text-disabled relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full">
                                                                <option value="{{ $question->rn }}">{{ $question->rn }}
                                                                </option>
                                                    ...
                                                    <div class="mb-3 flex flex-col">
                                                        <label for="question_text" class="text-blueGray-600 text-base font-semibold">Soal</label>
                                                        <textarea required name="question_text" value="{{ $question->question_text }}" class="p-4 py-3 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-96 h-full">{{ $question->question_text }}</textarea>
                                                    </div>
                                                </div>
                                                <!--footer-->
                            ...
                            <div class="hidden opacity-25 fixed inset-0 z-40 bg-black" id="edit-modal-{{ $question->id}}-backdrop"></div>
