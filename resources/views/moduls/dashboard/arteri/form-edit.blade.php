    ...
    <div class="flex flex-col w-full h-full">
        ...
        <div class="grid-cols-2 grid gap-10 w-full" style="color: #9B9B9B">
            <div class="flex flex-col gap-2 w-full">
                ...
                id="nama_judul" type="text" name="nama_judul" placeholder="Masukkan nama judul" required>
            </div>
            <div class="flex flex-col gap-2 w-full">
                <p>Penulis</p>
                <div class="relative">
                    ...
                    id="nama_penulis" name="nama_penulis" required>
                        <option value="morgan-vero">Morgan Vero</option>
                        <option value="john-doe">Penaldo</option>
                        <option value="jane-smith">Pedri > Bellingham</option>
                    </select>
            ...
            <div class="flex flex-col gap-2 w-full" style="color: #9B9B9B">
                <p>Sampul</p>
                <label for="file-upload" class="flex flex-col items-center justify-center w-full h-48 rounded border-2 border-gray-300 bg-white cursor-pointer hover:bg-gray-100 transition-colors duration-200" style="height: 300px">
                    ...
                    <input id="file-upload" name="answer_image" type="file" class="hidden" accept="image/*"
                        onchange="showFilename()" />
                </label>
                <p id="filename-display" class="mt-2 text-sm text-gray-500 hidden"></p>
            </div>
            <div class="flex flex-col gap-2 w-full">
                <p>Kategori</p>
                <div class="relative">
                    ...
                    id="nama_kategori" name="nama_kategori" required>
                        <option value="morgan-vero">Horror</option>
                        <option value="john-doe">Barcelona</option>
                        <option value="jane-smith">Madrid kalah WKWKWKW</option>
                    </select>
                    <div class="absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                        <i class='bx bx-chevron-down'></i>
                    </div>
