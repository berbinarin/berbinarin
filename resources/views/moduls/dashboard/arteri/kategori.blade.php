                            ...
                            <tbody>
                                @foreach ($categories as $index => $category)
                                    <tr class="data-consume">
                                        ...
                                        <td class="break-words whitespace-normal" style="max-width: 300px">
        ...
        <div class="relative my-5 mx-auto justify-center items-center" style="width: 500px">
            ...
            <div
                ...
                <div class="relative p-6 flex-auto">
                    <form method="POST" action="{{ route('dashboard.article.kategori.add') }}">
                        @csrf
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="nama_kategori" type="text" name="name_category" placeholder="Masukkan nama kategori"
                                required>
                        </div>
