                            ...
                            @foreach($articles as $article)
                                <tr class="data-consume">
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap text-center">
                                        <button type="button"
                                            class="focus:ring-2 focus:ring-offset-2 mt-4 sm:mt-0 inline-flex items-center justify-center py-2 px-4 focus:outline-none rounded-3xl bg-green-400">
                                            <p class="font-medium leading-none text-white">Terupload</p>
                                        </button>
                                    </td>
                                    <td class="px-6 py-4 whitespace-no-wrap text-center">
