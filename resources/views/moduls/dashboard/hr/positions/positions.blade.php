                            ...
                            <tbody>
                                @forelse ($positions as $key=>$item)
                                            ...
                                            <div
                                                ...
                                                <div class="relative p-6 flex-auto">
                                                    <form action="{{ route('dashboard.positions.destroy', $item->id) }}"
                                                        ...
                                                        @method('DELETE')
                                                        <input type="hidden" name="id">
                                                        <p class="mb-6">Apakah anda yakin ingin menghapus posisi
                                                            <b>{{ $item->name }}</b> dari divisi
                                                            <b>{{ $item->divisi }}</b> ?
                                                        </p>
                                                        <!--footer-->
                                                        <div
                                    ...
                                    <div class="hidden opacity-25 fixed inset-0 z-40 bg-black"
                                        id="delete-modal-{{ $item->id }}-backdrop"></div>
                                @empty
                                @endforelse
                                {{-- <tr class="data-consume">
                                    <td>2</td>
                    ...
                    <form action="{{ route('dashboard.positions.store') }}" class="flex flex-col gap-1" method="post">
                        ...
                        <div class="flex gap-1">
                            ...
                            <div class="mb-1 pt-0 flex-1">
                                ...
                                <select id="divisi" name="divisi" placeholder="Placeholder" required
                                    class="px-3 py-3 appearance-none placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full">
