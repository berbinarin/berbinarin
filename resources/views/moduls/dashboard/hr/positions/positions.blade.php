                    ...
                    <form action="{{ route("HiringPositions.store") }}" class="flex flex-col gap-1" method="post">
                        ...
                        <div class="flex gap-1">
                            <div class="mb-1 pt-0 w-full">
                                ...
                                <input id="name" name="name" type="text" placeholder="Human Resource Development"
                                    class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full"  required/>
                            </div>
                        ...
                        <div class="flex gap-1">
                            <div class="mb-1 pt-0 flex-1">
                                ...
                                <select id="type" name="type" placeholder="Placeholder"
                                    class="px-3 py-3 appearance-none placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full" required>
                            ...
                            <div class="mb-1 pt-0 flex-1">
                                ...
                                <select id="positions" name="positions" placeholder="Placeholder" required
                        ...
                        <div class="mb-1 pt-0">
                            ...
                            <select id="location" name="location" placeholder="Placeholder" required
                                class="px-3 py-3 appearance-none placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full">
                        ...
                        <div class="mb-1 pt-0 w-full">
                            ...
                            <input id="link" name="link" type="text" placeholder="Link Registrasi" required
