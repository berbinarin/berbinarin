                ...
                <div class="py-4 md:pt-12 md:pb-7">
                    <div class="">
                        <p tabindex="0"
                            ...
                            Edit Data Position Requirements </p>
                        <p class="w-2/4 text-disabled">Dashboard > <a
                                href="{{ route('dashboard.positions.descriptions') }}">Positions Requirements</a>
                            > Edit</p>
                    </div>
                </div>
                <form action="{{ route('Position-Requirement.update', $HiringPosisitonsRequirement->id) }}" class="flex flex-col gap-1" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-1 pt-0 w-full">
                        ...
                        <input id="requirement" name="requirement" type="text" placeholder="Requirement" value="{{ $HiringPosisitonsRequirement->requirement }}"
