                                        ...
                                        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                            ...
                                            <div class="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                                                <h3 class="text-3xl font-semibold">
                                                    Delete Position Description Data
                                                </h3>
                                            ...
                                            <div class="relative p-6 flex-auto">
                                                <form action="{{ route('dashboard.position-requirements.destroy', $item->id) }}" method="post">
                                                        ...
                                                        @method("DELETE")
                                                        <input type="hidden" name="id">
                                                        <p class="mb-6">Apakah anda yakin ingin menghapus syarat untuk <b>{{ $item->HiringPositions->name }}</b> dengan deskripsi <i>{{ $item->requirement }}</i> ?</p>
                                                    <!--footer-->
