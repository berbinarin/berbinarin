                            ...
                            <tbody>
                                @forelse ($PeerConsellorData as $key=>$item)
                                    <tr class="data-consume">
                                        ...
                                        <td>
                                            <a href="/dashboard/admin/counselorDataDetails/{{ $item->id }}"
        ...
        <div class="relative w-auto my-auto mx-auto" style="max-width: 62rem">
            ...
            <div
                ...
                <div class="relative p-6 flex-auto">
                    <form action="{{ route('dashboard.add.PeerConsellorData') }}" class="flex flex-col gap-1"
                        method="post">
                        @csrf
                                ...
                                @if (!is_null($konselling))
                                    <select name="jadwal_pukul" id="jadwal_pukul" style="height: 50px"
                                        ...
                                        <option value="default"
                                            {{ $konselling->jadwal_pukul == 'default' ? 'selected' : '' }} selected
                                            disabled>Pilih Jam</option>
                                        @foreach ($senin as $jadwal)
                                            <option value="{{ $jadwal }}"
                                                {{ $konselling->jadwal_pukul == $jadwal ? 'selected' : '' }}>
                                                {{ $jadwal }}</option>
                                        @endforeach
                                    </select>
                                @else
                        ...
                        <div class="flex gap-1">
                            <div class="mb-1 pt-0 flex-1">
                                ...
                                <select name="daerah" id="daerah" style="height: 50px"
                                    ...
                                    <option value="Bekasi"
                                        {{ old('daerah', $konselling->daerah ?? '') == 'Bekasi' ? 'selected' : '' }}>
                                        Bekasi</option>
