            ...
            <div class="w-full">
                <div class="py-4 md:pt-12 md:pb-7">
                    <div class="">
                        ...
                        <p class="w-full text-disabled">Fitur ini digunakan untuk menampilkan data pendaftar konseling yang mendaftar melalui situs web Berbinar.</p>
                            ...
                            <tbody>
                                @forelse ($PsikologData as $key=>$item)
                                    <tr class="data-consume" >
                                        ...
                                        <td><a href="/dashboard/admin/psikologDataDetails/{{ $item->id}}">View Details -></a></td>
                                    </tr>
                                    @empty
                                @endforelse
                            </tbody>
                    ...
                    <form action="{{ route('dashboard.add.PsikologData') }}" class="flex flex-col gap-1" method="post">
                        ...
                        <div class="flex gap-1">
                            ...
                            <div class="mb-1 pt-0 flex-1">
                                ...
                                <input name="jadwal_pukul" id="jadwal_pukul" type="time" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full"  required/>
                            </div>
                            <div class="mb-1 pt-0 flex-1">
