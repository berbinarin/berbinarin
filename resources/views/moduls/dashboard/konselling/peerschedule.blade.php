                                        ...
                                        <div class="relative w-auto my-6 mx-auto max-w-3xl">
                                            ...
                                            <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                                ...
                                                <div class="relative p-6 flex-auto">
                                                    <form action="{{ route("dashboard.edit.PeerConsellorSchedule",  $item->id) }}" class="flex flex-col gap-1" method="post">
                                                        @csrf
                                                        @method('PUT')
                                    ...
                                    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="delete-modal-{{ $item->id}}">
                                        <div class="relative w-auto my-6 mx-auto max-w-3xl">
                                            ...
                                            <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                                ...
                                                <!--body-->
                                                <div class="relative p-6 flex-auto">
                                                    <form action="{{ route('dashboard.delete.PeerConsellorSchedule', $item->id) }}"  method="get">
                                                        @csrf
                                                        @method("DELETE")
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center"
        ...
        <div class="relative w-auto my-6 mx-auto max-w-3xl">
            ...
            <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <!--body-->
                <div class="relative p-6 flex-auto">
                    <form action="{{ route('dashboard.add.PeerConsellorSchedule') }}" class="flex flex-col gap-1" method="post">
