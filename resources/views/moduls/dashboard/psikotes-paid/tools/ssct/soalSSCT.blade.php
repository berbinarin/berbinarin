...
<div class="relative h-11/12 md:min-h-screen flex flex-col items-center bg-gray-100 justify-center">
  ...
  <div class="relative text-center z-10 w-3xl mx-auto p-7 mt-8" style="width: 750px;">
    <p class="text-lg mt-7 px-8">
      Saya merasa bahwa Ayah saya jarang ...
    </p>

    <div class="mt-6">
      <input type="text" placeholder="Ketik disini..." class="input-field rounded-lg">
    </div>

    <div class="mb-4 flex justify-center mt-10">
      <a href="{{ route('endSSCT') }}">
      <button type="button" class="w-xl bg-primary  items-center text-white py-2 px-10 rounded-full hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Soal Selanjutnya</button>
      </a>
    </div>
  </div>
</div>
