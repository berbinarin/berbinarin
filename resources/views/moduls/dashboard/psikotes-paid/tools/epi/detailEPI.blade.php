                    ...
                    <div class="bg-white shadow-lg p-8 rounded-lg max-h-[500px] overflow-hidden flex flex-col"
                        ...
                        <div class="overflow-y-auto flex-1" style="max-height: 400px;">
                            <div class="pb-10">
                                ...
                                <p class="mt-4">Kategori yang paling tinggi nilainya adalah <b>Extroversion</b> dengan skor
                                    <b>13
                                ...
                                <table class="w-full text-lg border-collapse table-fixed">
                                    <tbody class="flex flex-col border-b">
                                        <tr class="border-b">
                                            ...
                                            <td class="text-center p-4" style="width: 25%">Ya</td>
                                            <td class="p-4 text-center" style="width: 25%">3</td>
                                        </tr>
                                        <tr class="border-b">
                                            <td class="p-4" style="width: 50%">
                                                Apakah Anda sering membutuhkan kawan untuk membuat Anda gembira?
                                            </td>
                                            <td class="text-center p-4" style="width: 25%">Ya</td>
                                        ...
                                        <tr class="border-b">
                                            <td class="p-4" style="width: 50%">
                                                Apakah Anda adalah orang yang santai dan tidak terbebani oleh masalah?
                                            </td>
                                            <td class="text-center p-4" style="width: 25%">Tidak</td>
                                            <td class="p-4 text-center" style="width: 25%">1</td>
                                        </tr>
                                        <tr class="border-b">
                                            <td class="p-4" style="width: 50%">
                                                Apakah biasanya Anda melakukan dan mengatakan sesuatu dengan cepat,
                                                tanpa Anda pikirkan terlebih dahulu?
                                            </td>
                                            <td class="text-center p-4" style="width: 25%">Ya</td>
                                            <td class="p-4 text-center" style="width: 25%">3</td>
                                        </tr>
