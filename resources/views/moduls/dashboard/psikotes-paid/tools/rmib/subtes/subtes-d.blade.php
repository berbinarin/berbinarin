            ...
            <tbody class="border-b flex flex-col">
                <tr class="border-b">
                    <td class="p-4" style="width: 50%">
                        Menyetir mobil antar-jemput dari satu tempat ke tempat lain
                        bagi para anggota yang sibuk dengan urusan.
                    </td>
                    <td class="text-center p-4" style="width: 25%">Subtes D</td>
                ...
                <tr class="border-b">
                    ...
                    <td class="text-center p-4" style="width: 25%">Outdoor</td>
                    <td class="p-4 text-center" style="width: 25%">1</td>
                </tr>
                <tr class="border-b">
                    <td class="p-4" style="width: 50%">
