            ...
            <div class="w-full">
                <div class="py-4 md:py-4">
                    <div>
                        ...
                        <p class="text-start w-3/5 text-disabled">Fitur ini menampilkan data responden seperti Nama, Jenis
                            kelamin, Tanggal lahir, Email yang telah mengisi Tes Psikotes Berbinar</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="w-full md:w-1/2 bg-[#68BC40] rounded-md p-4 text-white relative"
                            ...
                            <div class="flex items-center justify-center">
                                <div class="absolute bottom-4 left-4">
                                    <span class="text-white font-bold text-5xl ml-2">{{ $done }}</span>
                                    <p class="text-white font-bold text-md mt-2 ml-2">User</p>
                                </div>
                            </div>
                            <p class="absolute bottom-4 right-4 text-white text-xl">1</p>
                        </div>

                        <!-- Card 2 -->
                        <div class="md:w-1/2 bg-[#75BADB] rounded-md p-4 text-white relative"
                            style="background-color: #75BADB; height: 400px; width: 350px;">
                            <p class="font-bold text-lg mb-4">Sedang Mengerjakan</p>

                            <div class="flex items-center justify-center">
                                <div class="absolute bottom-4 left-4">
                                    <span class="text-white font-bold text-5xl ml-2">{{ $onprogress }}</span>
                                    <p class="text-white font-bold text-md mt-2 ml-2">User</p>
                                </div>
                            </div>
                            <p class="absolute bottom-4 right-4 text-white text-xl">1</p>
