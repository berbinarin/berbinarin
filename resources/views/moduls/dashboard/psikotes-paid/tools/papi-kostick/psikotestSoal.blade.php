        ...
        <div class="flex flex-col w-full">
            ...
            <div class="flex flex-col md:flex-row w-full gap-6">
                <div class="w-full bg-white rounded-md p-4">
                    <h2 class="text-xl font-bold mb-4" style="margin-left: 20px;">List Soal</h2>

                    <table id="example" class="w-full table-auto text-center border-collapse"
                            ...
                            @foreach ($questions as $question)
                                <tr class="border-b border-gray-200">
                                    ...
                                    <td class="px-4 py-2 flex justify-center space-x-2">
                                        ...
                                        <a href="{{ route('dashboard.psikotespaid.psikotestSoal.page-edit', $question->id) }}"
