            ...
            <div class="flex justify-center mt-2 space-x-8">
                <div class="relative bg-white shadow-lg p-8 rounded-lg w-1/2">
                    ...
                    <div class="space-y-4 mb-4 relative" style="padding-left: 0;">
                        {{-- diagram --}}
                        <div class="bg-blue-400 h-10 w-[300px] rounded-r-full ml-1"></div>
                        <div class="bg-purple-500 h-10 w-[500px] rounded-r-full ml-1"></div>
                        <div class="bg-pink-300 h-10 w-[600px] rounded-r-full ml-1"></div>
                        {{-- garis pinggir --}}
                ...
                <div class="bg-white shadow-lg p-8 rounded-lg w-1/2">
                    ...
                    <div class="flex justify-between mb-6 mt-6 space-x-2">
                        <button id="subtes1" 
                            class="subtes-btn text-lg font-semibold py-2 px-4 rounded-full border-2 transition">Subtes 1</button>
                        <button id="subtes2" 
                            class="subtes-btn text-lg font-semibold py-2 px-4 rounded-full border-2 transition">Subtes 2</button>
                        <button id="subtes3" 
                            class="subtes-btn text-lg font-semibold py-2 px-4 rounded-full border-2 transition">Subtes 3</button>
                    </div>
