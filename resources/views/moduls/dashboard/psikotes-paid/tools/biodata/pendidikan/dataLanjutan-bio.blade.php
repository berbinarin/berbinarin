  ...
  <div class="relative text-justify z-10 w-3xl mx-auto bg-white bg-opacity-50 shadow-lg rounded-lg p-6 mt-10 " style="width: 950px;">
    ...
    <div class="grid grid-cols-6 gap-x-6 gap-y-4">
      <div class="col-span-3">
        <label for="email"
          class="block text-lg font-semibold leading-6 text-black">Alamat Email</label>
        <div class="mt-2">
      ...
      <div class="col-span-3">
        <label for="work"
            class="block text-lg font-semibold leading-6 text-black">Unit Kerja</label>
        <div class="mt-2">
      ...
      <div class="col-span-3">
          <label for="work"
            class="block text-lg font-semibold leading-6 text-black">Jabatan Saat ini</label>
          <div class="mt-2">
            <input type="text" name="work" id="work"
              class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6"
              placeholder="CEO">
      ...
      <div class="col-span-3">
          <label for="work"
            class="block text-lg font-semibold leading-6 text-black">Jabatan yang Diinginkan</label>
        <div class="mt-2">
      ...
      <div class="col-span-3">
          <label for="sosmed"
            class="block text-lg font-semibold leading-6 text-black">Akun Instagram</label>
            <div class="mt-2">
      ...
      <div class="col-span-3">
          <label for="sosmed"
            class="block text-lg font-semibold leading-6 text-black">Akun Facebook</label>
          <div class="mt-2">
            <input type="text" name="sosmed"
              id="sosmed"
              class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6"
      ...
      <div class="col-span-3">
          <label for="sosmed"
            class="block text-lg font-semibold leading-6 text-black">Akun X (Twitter)</label>
        <div class="mt-2">
            <input type="text" name="sosmed"
                id="sosmed"
                class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6"
    ...
    <div class="mb-4 flex justify-center mt-10">
      <a href="{{ route('riwayatPendPendBio') }}">
