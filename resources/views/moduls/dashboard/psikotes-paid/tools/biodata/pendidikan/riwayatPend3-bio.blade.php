  ...
  <div class="relative text-justify z-10 w-3xl mx-auto bg-white bg-opacity-50 shadow-lg rounded-lg p-6 mt-10" style="width: 950px;">
    ...
    <div id="diploma-container" class="max-h-60 overflow-y-auto">
      <div class="diploma-entry grid grid-cols-6 gap-x-6 gap-y-4 mb-4">
        <div class="col-span-3">
          <label for="magister-name" class="block text-lg font-semibold leading-6 text-black">Asal Sekolah/Bidang</label>
          <div class="mt-2">
            <input type="text" name="magister-name[]" class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6" placeholder="Asal Sekolah/Bidang">
          </div>
        </div>
        <div class="col-span-3 flex space-x-2">
          <div class="w-1/2">
            <label for="start_year" class="block text-lg font-semibold leading-6 text-black">Jurusan</label>
              <div class="mt-2">
                <input type="text" name="start_year" id="start_year" class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6" placeholder="Manajemen">
              </div>
          </div>
          <div class="w-1/2">
            <label for="year" class="block text-lg font-semibold leading-6 text-black invisible">Tahun</label>
              <div class="mt-2">
                <input type="number" name="year" id="year" class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6" placeholder="2003">
              </div>
          </div>
        </div>
      </div>
    ...
    <div id="PhD-container" class="max-h-60 overflow-y-auto">
      <div class="PhD-entry grid grid-cols-6 gap-x-6 gap-y-4 mb-4">
        <div class="col-span-3">
          <label for="PhD-name" class="block text-lg font-semibold leading-6 text-black">Asal Sekolah/Bidang</label>
          <div class="mt-2">
            <input type="text" name="PhD-name[]" class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6" placeholder="Asal Sekolah/Bidang">
          </div>
        </div>
        <div class="col-span-3 flex space-x-2">
          <div class="w-1/2">
        ...
        <form action="{{ route('psikotest-paid.tool.BIODATA_PENDIDIKAN.post') }}" method="post">
          @csrf
            <div class="relative text-justify z-10 w-3xl mx-auto bg-white bg-opacity-50 shadow-lg rounded-lg p-6 mt-10"
                ...
                <!-- Tombol Navigasi -->
                <div class="flex justify-center gap-5 mt-10">
                    <a href="{{ route('psikotest-paid.tool.BIODATA_PENDIDIKAN.showPage', ['page' => 5]) }}">
                        <button type="button"
