    ...
    <div id="diploma-container" class="max-h-60 overflow-y-auto">
      <div class="diploma-entry grid grid-cols-6 gap-x-6 gap-y-4 mb-4">
        <div class="col-span-3">
          ...
          <div class="mt-2">
            <input type="text" name="diploma_name[]" class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6" placeholder="PT. Berbinar">
          </div>
        </div>
        <div class="col-span-3">
          <label for="smp_start_year" class="block text-lg font-semibold leading-6 text-black">Posisi Terakhir</label>
            <div class="mt-2">
              <input type="text" name="smp_start_year" id="smp_start_year" class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6" placeholder="Digital Marketing">
            </div>
        </div>
      </div>
    </div>
