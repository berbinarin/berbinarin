...
<div class="relative h-11/12 md:min-h-screen flex flex-col items-center bg-gray-100 justify-center">
  ...
  <div class="relative text-justify z-10 w-3xl mx-auto bg-white bg-opacity-50 shadow-lg rounded-lg p-6 mt-10" style="width: 950px;">
    ...
    <div id="diploma-container" class="max-h-60 overflow-y-auto">
      <div class="diploma-entry grid grid-cols-6 gap-x-6 gap-y-4 mb-4">
        ...
        <div class="col-span-3 flex space-x-2">
          <div class="w-1/2">
            <label for="d_start_year" class="block text-lg font-semibold leading-6 text-black">Jurusan</label>
              <div class="mt-2">
                <input type="text" name="d_start_year" id="d_start_year" class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6" placeholder="Manajemen">
              </div>
          </div>
          <div class="w-1/2">
            <label for="d" class="block text-lg font-semibold leading-6 text-black invisible">Tahun</label>
              <div class="mt-2">
                <input type="number" name="d" id="d" class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6" placeholder="2003">
              </div>
          </div>
        </div>
      </div>
    ...
    <div class="flex justify-center gap-5 mt-10">
      ...
      <a href="{{ route('riwayatPend3CommBio') }}">
        ...
        <form action="{{ route('psikotest-paid.tool.BIODATA_KOMUNITAS.post') }}" method="post">
          @csrf
            <div class="relative text-justify z-10 w-3xl mx-auto bg-white bg-opacity-50 shadow-lg rounded-lg p-6 mt-10"
                ...
                <div id="diploma-container" class="max-h-60 overflow-y-auto">
                    <div class="diploma-entry grid grid-cols-6 gap-x-6 gap-y-4 mb-4">
                        <input type="hidden" name="level_education_id[]" value="5">
                        <div class="col-span-3">
                            <label for="diploma_name" class="block text-lg font-semibold leading-6 text-black">Asal
                        ...
                        <div class="col-span-3 flex space-x-2">
                            <div class="w-1/2">
                                <label for="diploma_start_year"
                                    class="block text-lg font-semibold leading-6 text-black">Jurusan</label>
                                <div class="mt-2">
                                    <input type="text" name="major[]" id="diploma_start_year"
                                        class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6"
                            ...
                            <div class="w-1/2">
                                ...
                                <div class="mt-2">
                                    <input type="number" name="year[]" id="diploma"
                                        class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6"
                                        placeholder="2003">
                                </div>
                            </div>
                ...
                <div id="degree-container" class="max-h-60 overflow-y-auto">
                    <div class="degree-entry grid grid-cols-6 gap-x-6 gap-y-4 mb-4">
                        <input type="hidden" name="level_education_id[]" value="6">
                        <div class="col-span-3">
                            <label for="diploma_name" class="block text-lg font-semibold leading-6 text-black">Asal
                                Sekolah/Bidang</label>
                            <div class="mt-2">
                        ...
                        <div class="col-span-3 flex space-x-2">
                            <div class="w-1/2">
                                <label for="bachelor_start_year"
                                    class="block text-lg font-semibold leading-6 text-black">Jurusan</label>
                                <div class="mt-2">
                                    <input type="text" name="major[]" id="bachelor_start_year"
                                        class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6"
                                        placeholder="Manajemen">
                                </div>
                            </div>
                            <div class="w-1/2">
                                <label for="bachelor"
                                    class="block text-lg font-semibold leading-6 text-black invisible">Tahun</label>
                                <div class="mt-2">
                                    <input type="number" name="year[]" id="bachelor"
                                        class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6"
                                        placeholder="2003">
                                </div>
                            </div>
...
=======
          <label for="diploma_start_year" class="block text-lg font-semibold leading-6 text-black">Jurusan</label>
            <div class="mt-2">
              <input type="text" name="major[]" id="diploma_start_year" class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6" placeholder="Manajemen">
            </div>
        </div>
        <div class="w-1/3">
          <label for="diploma" class="block text-lg font-semibold leading-6 text-black invisible">Tahun</label>
            <div class="mt-2">
              <input type="number" name="year[]" id="diploma" class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6" placeholder="2003">
            </div>
        </div>
        <div class="w-1/3">
            <label for="bachelor"
