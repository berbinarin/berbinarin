              ...
              @csrf
                ...
                <div id="activity-container" class="max-h-60 overflow-y-auto">
                    <div class="activity-entry grid grid-cols-6 gap-x-6 gap-y-4 mb-4">
                        ...
                        <div class="col-span-2">
                            <label for="provider"
                                class="block text-lg font-semibold leading-6 text-black">Penyelenggara</label>
                            <div class="mt-2">
                                <input type="text" name="organizer_course[]" id="provider"
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="mt-2">
                                <input type="number" name="year_course[]" id="smp"
                                    class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6"
                                    placeholder="2013">
                            </div>
                        </div>
                ...
                <div class="flex justify-center gap-5 mt-10">
                    <button type="submit" class="w-xl bg-primary text-white py-2 px-10 rounded-full shadow-lg hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Selanjutnya</button>
                </div>
            </form>
        </div>
    </div>
      ...
      <div class="col-span-3 flex space-x-2">
        ...
        <div class="col-span-2">
          <label for="smp" class="block text-lg font-semibold leading-6 text-black invisible">Tahun</label>
            <div class="mt-2">
              <input type="number" name="year_course[]" id="smp" class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6" placeholder="2003">
            </div>
        </div>
        <div class="col-span-2">
            <label for="bachelor"
