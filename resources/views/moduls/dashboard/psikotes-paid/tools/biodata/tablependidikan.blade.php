            ...
            <div class="py-4 md:pt-12 md:pb-7">
                <div>
                    <p class="focus:outline-none text-base sm:text-lg md:text-2xl lg:text-4xl font-bold leading-normal text-gray-800 mb-2">
                        Detail Jawaban Test Biodata Pendidikan</p>
                    ...
                    <div id="tab1Detail" class="overflow-y-scroll" style="height: 90%">
                        ...
                        <table class="w-full text-lg">
                            <tbody>
                                ...
                                <tr class="mb-4">
                                    <td class="font-medium">{{ $user_education->identity->fullname }}</td>
                                    <td class="font-medium">{{ $user_education->identity->no_ktp }}</td>
                                </tr>
                                ...
                                <tr class="mb-4">
                                    <td class="font-medium">{{ $user_education->identity->place_of_birth }}</td>
                                    <td class="font-medium">{{ $user_education->identity->date_of_birth }}</td>
                                </tr>
                                <tr><td colspan="2" class="h-6"></td></tr>
                                <tr>
                                ...
                                <tr class="mb-4">
                                    <td class="font-medium">{{ $user_education->identity->gender }}</td>
                                    <td class="font-medium">{{ $user_education->identity->marriage_status }}</td>
                                </tr>
                                <tr><td colspan="2" class="h-6"></td></tr>
                                <tr>
                                ...
                                <tr class="mb-4">
                                    <td class="font-medium">{{ $user_education->identity->no_hp }}</td>
                                    <td class="font-medium">{{ $user_education->identity->address }}</td>
                                </tr>
                                <tr><td colspan="2" class="h-6"></td></tr>
                                <tr>
                                ...
                                <tr class="mb-4">
                                    <td class="font-medium">{{ $user_education->identity->email }}</td>
                                    <td class="font-medium">{{ $user_education->identity->work_unit }}</td>
                                </tr>
                                <tr><td colspan="2" class="h-6"></td></tr>
                                <tr>
                                ...
                                <tr class="mb-4">
                                    <td class="font-medium">{{ $user_education->identity->current_position }}</td>
                                    <td class="font-medium">{{ $user_education->identity->desired_position }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>          
