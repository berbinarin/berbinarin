  ...
  <div class="relative text-justify z-10 w-xl mx-auto bg-white bg-opacity-50 shadow-lg rounded-lg p-6 mt-10 " style="width: 950px;">
    ...
    <div class="grid grid-cols-6 gap-x-6 gap-y-4">
      <div class="col-span-3">
          ...
          <div class="mt-2">
            <input type="text" name="sma_name" id="sma_name" class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6" placeholder="SMA Harapan 1">
          </div>
      </div>
      <div class="col-span-3 flex space-x-2">
        <div class="w-1/2">
          <label for="sma_start_year" class="block text-lg font-semibold leading-6 text-black">Jurusan</label>
            <div class="mt-2">
              <input type="text" name="sma_start_year" id="sma_start_year" class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6" placeholder="MIPA">
            </div>
        </div>
        <div class="w-1/2">
          <label for="sma" class="block text-lg font-semibold leading-6 text-black invisible">Tahun</label>
            <div class="mt-2">
    ...
    <div class="mb-4 flex justify-center mt-10">
      <a href="{{ route('riwayatPend3CompBio') }}">
