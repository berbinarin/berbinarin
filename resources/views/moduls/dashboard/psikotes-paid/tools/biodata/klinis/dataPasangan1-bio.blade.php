  ...
  <div class="relative text-justify z-10 w-3xl mx-auto bg-white bg-opacity-50 shadow-lg rounded-lg p-6 mt-10 " style="width: 950px;">
    ...
    <div class="grid grid-cols-6 gap-x-6 gap-y-4">
      <div class="col-span-3">
          <label for="name"
            class="block text-lg font-semibold leading-6 text-black">Nama Suami/Istri</label>
          <div class="mt-2">
      ...
      <div class="col-span-3">
          <label for="religion"
            class="block text-lg font-semibold leading-6 text-black">Agama</label>
            <div class="mt-2">
