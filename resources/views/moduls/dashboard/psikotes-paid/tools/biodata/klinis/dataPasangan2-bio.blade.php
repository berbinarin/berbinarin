...
<div class="relative h-11/12 md:min-h-screen flex flex-col items-center bg-gray-100 justify-center">
  ...
  <div class="relative text-justify z-10 w-3xl mx-auto bg-white bg-opacity-50 shadow-lg rounded-lg p-6 mt-10 " style="width: 950px;">
    ...
    <p class="font-bold text-xl text-left text-gray-800 mb-6">Data Diri Suami/Istri</p>
    <div class="grid grid-cols-6 gap-x-6 gap-y-4">
      <div class="col-span-3">
          <label for="phone"
            class="block text-lg font-semibold leading-6 text-black">Nomor Telepon</label>
          <div class="mt-2">
      ...
      <div class="col-span-3">
        <label for="lastEdu"
        class="block text-lg font-semibold leading-6 text-black">Pendidikan Terakhir</label>
        <div class="mt-2">
          <input type="text" name="lastEdu" id="lastEdu"
            class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6"
            placeholder="S1">
        </div>
      </div>
      <div class="col-span-3">
          <label for="work"
              class="block text-lg font-semibold leading-6 text-black">Pekerjaan</label>
          <div class="mt-2">
      ...
      <div class="col-span-3">
          <label for="numberKid"
            class="block text-lg font-semibold leading-6 text-black">Anak Ke-</label>
        <div class="mt-2">
            <input type="text" name="numberKid"
                id="numberKid"
                class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6"
                placeholder="9">
        </div>
              ...
              @csrf
                ...
                <div class="grid grid-cols-6 gap-x-6 gap-y-4">
                    <div class="col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="text" name="no_hp_family[0]" id="phone"
                                class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6"
                                placeholder="+62123456789">
                        </div>
                    </div>
                    <div class="col-span-3">
                        <label for="lastEdu" class="block text-lg font-semibold leading-6 text-black">Pendidikan
                            Terakhir</label>
                        <div class="mt-2">
                            <input type="text" name="last_education_family[0]" id="lastEdu"
                                class="block w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg sm:leading-6"
                                placeholder="S1">
                        </div>
                    </div>
                    ...
                    <div class="col-span-3">
                        <label for="numberKid" class="block text-lg font-semibold leading-6 text-black">Anak Ke-</label>
                        <div class="mt-2">
