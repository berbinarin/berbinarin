            ...
            <div class="py-4 md:pt-12 md:pb-7">
                <div>
                    <p tabindex="0"
                        ...
                        Data Jawaban Alat Test Biodata Individual</p>
            ...
            <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10 rounded-md">
                <div class="mt-4 overflow-x-auto">
                    <table id="example" class="display w-full" style="overflow-x: scroll;">
                        ...
                        <tbody>
                            @foreach ($user_individuals as $item)    
                            <tr class="data-consume">
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap text-center text-center">
                                    <a href="{{ route('dashboard.psikotespaid.tableindividual',['id' => $item->id]) }}">
                                    <button type="button"
