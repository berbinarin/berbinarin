                ...
                <div class="py-4 md:pt-12 md:pb-7">
                    <div>
                        <p tabindex="0"
                            ...
                            Data Jawaban Alat Test OCEAN</p>
                            ...
                            <tbody>
                                @foreach ($test_ocean as $item)
                                    <tr class="data-consume">
                                        ...
                                        <td class="text-center">{{ $item->PsikotestPaidTest->created_at->format('d-m-Y') }}</td>
                                        <td class="px-6 py-4 whitespace-no-wrap text-center">
                                            <a href="{{ route('dashboard.psikotespaid.detailocean', ['id' => $item->id]) }}">
                                                <button type="button"
