    ...
    <div class="flex flex-col w-full">
        <div class="w-full">
            ...
            <div class="rounded-lg shadow-md w-full h-full p-7 bg-white" style="height: 150%;">
                <div class="text-white rounded-lg flex flex-col justify-between p-6 h-1/2 w-1/2 relative"
                    style="background-color: #6482AD;">
                    <h3 class="block text-2xl font-bold">Dass-42</h3>
                    <div>
