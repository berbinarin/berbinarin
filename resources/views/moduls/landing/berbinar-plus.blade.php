...
<section class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center relative px-5 md:px-0 mt-28 md:mt-13">
    ...
    <div class="relative flex items-center">
        ...
        <div class="flex flex-col gap-5 z-40 relative">
            ...
            <p class="text-lg text-disabled"><span class="text-primary font-semibold">BERBINAR<span class="text-[20px]">+</span></span> adalah layanan ONE-PACKAGE yang terdiri dari kelas daring
...
<section class="max-w-6xl mx-auto flex flex-col gap-10 z-40 mt-10">
    <div class="flex items-center justify-center flex-col gap-1">
        <h1 class="text-black fomt-semibold text-3xl p-5 md:px-0 text-center">
            Layanan <span class="text-primary font-bold">BERBINAR<span class="text-[30px]">+</span></span>
        </h1>
        {{--<p class="text-disabled text-lg">Layanan yang kami sediakan</p>--}}
    </div>

    <div class="flex flex-col md:flex-row gap-5 md:gap-3">
        <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white border border-gray-300 relative pb-6 flex-1" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="500">
        ...
        <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white border border-gray-300 relative pb-6 flex-1" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="1000">
            ...
            <div class="flex flex-col gap-1 text-center px-5 items-center justify-center">
                ...
                <ul class="list-disc">
                    <li>Psikolog counseling adalah proses pemberian bantuan yang dilakukan oleh seorang ahli kepada
                        individu yang mengalami sesuatu masalah seperti kepribadian, mental dll.</li>
                    <li>Peer Counseling (konseling sebaya) adalah seseorang yang telah dilatih oleh psikolog yang sudah
                        memiliki izin praktek dan umum nya melayani klien yang usianya seumuran atau sebaya.</li>
                </ul>
                </p>
        ...
        <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white border border-gray-300 relative pb-6 flex-1" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="1500">
            ...
            <div class="flex flex-col gap-1 text-center px-5 items-center justify-center">
                ...
                <a href="https://youtu.be/6s0zmkefWkQ?si=9ssA783fAvBYyVmT" class="text-base text-white bg-primary-alt rounded-md hover:bg-primary duration-700 px-5 py-2 absolute bottom-5">Lihat</a>
            </div>
        </div>
    </div>
</section>
...
<section class="max-w-6xl mx-auto flex flex-col gap-10 z-40 mt-10">
    ...
    <div class="flex flex-col md:flex-row gap-5 md:gap-3">
        <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white shadow-md relative pb-6 flex-1" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="500">
            ...
            <img src="{{ asset('assets/images/products/bisikan/bisikan-2.png') }}" alt="Ilustrasi Peer Counselor Berbinar" title="Ilustrasi Peer Counselor Berbinar" class="w-full rounded-tl-xl rounded-tr-xl p-4">
        ...
        <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white shadow-md relative pb-6 flex-1" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="1000">
            ...
            <img src="{{ asset('assets/images/products/bisikan/bisikan-3.png') }}" alt="Ilustrasi Asesmen Psikologi Berbinar" title="Ilustrasi Asesmen Psikologi Berbinar" class="w-full rounded-tl-xl rounded-tr-xl p-4">
        ...
        <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white shadow-md relative pb-6 flex-1" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="1500">
            ...
            <img src="{{ asset('assets/images/products/bisikan/bisikan-4.png') }}" alt="Ilustrasi Kelas Berbinar" title="Ilustrasi Kelas Berbinar" class="w-full rounded-tl-xl rounded-tr-xl p-4">
            <div class="flex flex-col gap-1 text-center px-5 items-center justify-center">
