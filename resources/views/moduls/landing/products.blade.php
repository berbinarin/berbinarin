...
@section('content')
    ...
    <section class="max-w-6xl mx-auto mt-40 z-40 flex flex-col gap-5 px-5 relative items-center">
        ...
        <p class="text-lg text-disabled text-center z-40">Kesehatan mental sering timbul di kalangan masyarakat. Namun, masih
            banyak dari
        ...
        <div class="flex flex-col gap-14">
            ...
            <div class="flex flex-col items-center justify-center w-full">
                ...
                <div class="flex flex-col md:flex-row items-center">
                    ...
                    <div aria-hidden="true" class="mt-0 lg:mt-0">
                        <img src="https://i.ibb.co/CwyfsBG/konseling.png" alt=""
                            class="mx-auto w-[120rem] hidden md:block" data-aos="fade-left" data-aos-duration="1500">
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center justify-center w-full">
                ...
                <div aria-hidden="true" class="mt-0 lg:mt-0">
                    <img src="https://i.ibb.co/PDBMx5m/webinar.png" alt=""
                        class="mx-auto w-[50rem] block md:hidden mt-10" data-aos="fade-up" data-aos-duration="1500">
                </div>
                ...
                <div class="flex flex-col md:flex-row items-center mt-4">
                    ...
                    <div aria-hidden="true" class="mt-0 lg:mt-0">
                        <img src="https://i.ibb.co/PDBMx5m/webinar.png" alt=""
                            class="mx-auto w-[50rem] hidden md:block" data-aos="fade-left" data-aos-duration="1500">
                    </div>
                </div>
            </div>
        </div>
