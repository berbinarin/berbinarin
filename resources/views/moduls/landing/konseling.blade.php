...
<section
    ...
    <div class="relative flex items-center">
        ...
        <div class="flex flex-col gap-5 z-40 relative">
            ...
            <button
                class="text-lg text-white bg-primary-alt rounded-md hover:bg-primary duration-700 px-5 py-2 w-fit showModal">Lakukan
                Konseling</button>
        </div>
    </div>
                ...
                <div class="modal">
                    <div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-left text-pretty font-light text-white px-20">
