...
@section('content')
    ...
    <section
        ...
        {{-- HERO IMG MOBILE --}}
        <img src="{{ asset('assets/images/products/ilustrasi-webinar.png') }}" alt="Ilustrasi Konseling Berbinar"
    ...
    <section
        ...
        <div class="relative flex items-center ">
            ...
            <div class="flex flex-col gap-5 z-40 relative">
                ...
                <a href="https://www.youtube.com/live/nfKC0Udhnfk?si=Vozb1x_jkiIhGTg0"
    ...
    <section class="max-w-6xl mx-auto flex flex-col gap-10 z-40 mt-10">
        ...
        <div class="flex flex-col md:flex-row gap-5 md:gap-3">
            <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white shadow-md relative pb-6 flex-1"
                ...
                <img src="{{ asset('assets/images/products/webinar/webinar-2.png') }}"
                ...
                <div class="flex flex-col gap-1 text-center px-5 items-center justify-center">
                    ...
                    <a href="https://youtu.be/qQalLh7eFYk?si=nfZmEnjTJyKKmE0R"
            ...
            <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white shadow-md relative pb-6 flex-1"
                ...
                <img src="{{ asset('assets/images/products/webinar/webinar-4.png') }}"
                ...
                <div class="flex flex-col gap-1 text-center px-5 items-center justify-center">
                    ...
                    <a href="https://www.youtube.com/live/N-tDIkQw90s?si=Po4rJOjrOVN3X2Ot"
                        class="text-base text-white bg-primary-alt rounded-md hover:bg-primary duration-700 px-5 py-2 absolute bottom-5">Lihat</a>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white shadow-md relative pb-6 flex-1"
                ...
                <img src="{{ asset('assets/images/products/webinar/webinar-3.png') }}" alt="Ilustrasi Kelas Berbinar"
                ...
                <div class="flex flex-col gap-1 text-center px-5 items-center justify-center">
                    ...
                    <a href="https://www.youtube.com/live/p3bhLaNkxs0?si=xpkflM_j289QBoSB"
                        class="text-base text-white bg-primary-alt rounded-md hover:bg-primary duration-700 px-5 py-2 absolute bottom-5">Lihat</a>
                </div>
            </div>
        </div>
