...
{{-- HERO SECTION --}}
<section
    class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center relative px-5 md:px-0 mt-28 md:mt-13">
    {{-- HERO IMG MOBILE --}}
...
{{-- UPCOMING SECTION --}}
<section
    class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center relative px-5 py-5 md:px-0 -mt-5 gap-10">
    {{-- HERO IMG MOBILE --}}
...
<section class="max-w-6xl mx-auto flex flex-col gap-10 z-40 mt-10">
    ...
    <div class="flex flex-col md:flex-row gap-5 md:gap-3">
        <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white shadow-md relative pb-6 flex-1"
            ...
            <img src="{{ asset('assets/images/products/bisikan/bisikan-Secretary and Finance.png') }}"
        ...
        <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white shadow-md relative pb-6 flex-1"
            ...
            <img src="{{ asset('assets/images/products/bisikan/bisikan-Researcher.png') }}"
