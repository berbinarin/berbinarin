...
<section
    ...
    {{-- HERO IMG MOBILE --}}
    <img src="{{ asset('assets/images/product-berbinar/asesmen-psikologi.png') }}" alt="Ilustrasi Psikotest Berbinar"
        title="Ilustrasi Psikotest Berbinar" class="w-full block md:hidden" data-aos="fade-up" data-aos-duration="1500">
    ...
    {{-- HERO IMG DESKTOP --}}
    <img src="{{ asset('assets/images/product-berbinar/asesmen-psikologi.png') }}"
        alt="Ilustrasi Tes Psikotest Berbinar" title="Ilustrasi Tes Psikotest Berbinar" class="w-1/2 hidden md:block"
...
<section
    ...
    <img src="{{ asset('assets/images/ilustrasi-asesmen-psikologi-indivdu.png') }}"
        alt="Ilustrasi Tes Psikotest Berbinar" title="Ilustrasi Tes Psikotest Berbinar" class="w-full block md:hidden"
    ...
    <img src="{{ asset('assets/images/ilustrasi-asesmen-psikologi-indivdu.png') }}"
        alt="Ilustrasi Tes Psikotest Berbinar" title="Ilustrasi Tes Psikotest Berbinar" class="w-[45%] hidden md:block"
    ...
    <div class="flex flex-col md:flex-row gap-5 md:gap-3">
        <div class="flex flex-col gap-4 md:mx-0  rounded-xl bg-white shadow-md relative pb-4 flex-1 w-full md:w-[500px]"
            ...
            <div class="flex flex-col gap-2 text-center items-center px-5 pt-10">
                ...
                <div
                    class="text-disabled text-base pb-12 text-left mt-3 flex flex-col items-left justify-left gap-1 -ml-10">
        ...
        <div class="flex flex-col gap-4 md:mx-0  rounded-xl bg-primary shadow-md relative pb-4 flex-1 w-full md:w-[500px]"
            ...
            <div class="flex flex-col gap-2 text-center items-center px-5 pt-10">
                ...
                <div
                    class="text-white text-base pb-12 text-left mt-3 flex flex-col items-left justify-left gap-1 -ml-10">
                    <span>Termasuk :</span><br>
                    <span class="flex flex-row gap-1 -mt-6">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
                            <path
...
<section class="max-w-6xl mx-5 md:mx-auto flex flex-col gap-10 z-40">
    ...
    <div class="flex flex-col md:flex-row md:flex-wrap gap-5 md:gap-3 w-full items-center justify-center">
        <div class="flex flex-col gap-4 md:mx-0  rounded-xl bg-white shadow-md relative pb-4 w-full md:w-[300px] "
            data-aos="fade-right" data-aos-duration="500" data-aos-delay="0">
            <div class="flex flex-col gap-2 text-center items-center px-5 pt-10">
                <h3 class="text-black text-xl font-medium">Staf Karyawan</h3>
                <h1 class="text-black text-5xl font-medium">IDR 450k</h1>
                <div
                    class="text-disabled text-base pb-12 text-left mt-3 flex flex-col items-left justify-left gap-1 ml-5">
                    <span>Termasuk :</span><br>
                    <span class="flex flex-row gap-1 -mt-6">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
                            <path
                    ...
                    <span class="flex flex-row gap-1 -mt-6">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
                            <path
                                d="M13 26C20.1799 26 26 20.1799 26 13C26 5.8201 20.1799 0 13 0C5.8201 0 0 5.8201 0 13C0 20.1799 5.8201 26 13 26Z"
                                fill="#F31559" />
                            <path d="M7.1167 13.8406L10.4785 17.2024L18.8831 8.79785" stroke="" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" />
        ...
        <div class="flex flex-col gap-4 md:mx-0  rounded-xl bg-primary shadow-md relative pb-4 w-full md:w-[300px] "
            data-aos="fade-right" data-aos-duration="1000" data-aos-delay="500">
            <div class="flex flex-col gap-2 text-center items-center px-5 pt-10">
...
{{-- FAQ SECTION --}}
<section class="max-w-6xl mt-10 z-40 mx-5 md:mx-auto">
