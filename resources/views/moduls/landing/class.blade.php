...
<section class="max-w-6xl mx-auto h-screen flex flex-col md:flex-row items-center justify-center relative px-5 md:px-0 mt-28 md:mt-10">
    {{-- HERO IMG MOBILE --}}
    <img src="{{ asset('assets/images/product-berbinar/webinar.png') }}" alt="Ilustrasi Kelas Berbinar" title="Ilustrasi Kelas Berbinar" class="w-full block md:hidden" data-aos="fade-up" data-aos-duration="1500">
    ...
    <div class="relative flex items-center">
        ...
        <div class="flex flex-col gap-5 z-40 relative">
            ...
            <a href="{{ route('class') }}" class="text-lg text-white bg-primary-alt rounded-md hover:bg-primary duration-700 px-5 py-2 w-fit">Lihat
                Kelas</a>
        </div>
    </div>

    {{-- HERO IMG DESKTOP --}}
    <img src="{{ asset('assets/images/product-berbinar/webinar.png') }}" alt="Ilustrasi Kelas Berbinar" title="Ilustrasi Kelas Berbinar" class="w-1/2 hidden md:block" data-aos="fade-left" data-aos-duration="1500">
</section>
...
<section class="max-w-6xl mx-auto flex flex-col gap-10 z-40">
    ...
    <div class="flex flex-col md:flex-row gap-5 md:gap-3">
        <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white shadow-md relative pb-6 flex-1" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="500">
            <div class="flex items-center justify-center bg-gradient-to-r from-primary to-blur-bg rounded-tl-xl rounded-tr-xl">
                <img src="{{ asset('assets/images/ilustrasi-webinar.png') }}" alt="Ilustrasi Peer Counselor Berbinar" title="Ilustrasi Peer Counselor Berbinar" class="w-[250px] rounded-tl-xl rounded-tr-xl">
            </div>
            <div class="flex flex-col gap-2 text-center px-5 items-center justify-center">
                ...
                <a href="{{ route('webinar') }}" class="text-base text-white bg-primary-alt rounded-md hover:bg-primary duration-700 px-5 py-2 absolute bottom-5">Pelajari
                    Selengkapnya</a>
            </div>
        </div>
        ...
        <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white shadow-md relative pb-6 flex-1" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="1000">
            <div class="flex items-center justify-center bg-gradient-to-r from-primary to-blur-bg rounded-tl-xl rounded-tr-xl">
                <img src="{{ asset('assets/images/ilustrasi-bisikan.png') }}" alt="Ilustrasi Asesmen Psikologi Berbinar" title="Ilustrasi Asesmen Psikologi Berbinar" class="w-[250px] rounded-tl-xl rounded-tr-xl">
            </div>
            <div class="flex flex-col gap-2 text-center px-5 items-center justify-center">
                ...
                <a href="{{ route('bisikan') }}" class="text-base text-white bg-primary-alt rounded-md hover:bg-primary duration-700 px-5 py-2 absolute bottom-5">Pelajari
                    Selengkapnya</a>
            </div>
        </div>
        ...
        <div class="flex flex-col gap-4 mx-8 md:mx-0  rounded-xl bg-white shadow-md relative pb-6 flex-1" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="1500">
            <div class="flex items-center justify-center bg-gradient-to-r from-primary to-blur-bg rounded-tl-xl rounded-tr-xl">
                <img src="{{ asset('assets/images/ilustrasi-berbinar-plus.png') }}" alt="Ilustrasi Kelas Berbinar" title="Ilustrasi Kelas Berbinar" class="w-[250px] rounded-tl-xl rounded-tr-xl">
            </div>
            <div class="flex flex-col gap-2 text-center px-5 items-center justify-center">
                ...
                <a href="{{ route('berbinarPlus') }}" class="text-base text-white bg-primary-alt rounded-md hover:bg-primary duration-700 px-5 py-2 absolute bottom-5">Pelajari
                    Selengkapnya</a>
            </div>
        </div>
    </div>
...
{{-- FAQ SECTION --}}
<section class="max-w-6xl z-40 mt-10 mx-5 md:mx-auto">
