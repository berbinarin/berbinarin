    ...
    <div class="bg-primary">
        <div class="flex flex-col justify-start items-left mx-10 md:mx-20 mt-8">
            ...
            <div class="progress w-full h-5 my-10 bg-blue-200 rounded-full">
                <div class="progress-bar w-[20px] h-5 bg-amber-500 ml-[1px] md:ml-0 rounded-full text-[13px] text-end" role="progressbar" style="width: {{ $progress }}%;" aria-valuenow="{{ $progress }}" aria-valuemin="0" aria-valuemax="100"><span class="font-semibold ml-1 mr-2 text-white">{{ round($progress) }}%</span>
                </div>
            </div>
                            ...
                            <div class="flex flex-row md:flex-col">
                                <div class="radio flex flex-col md:flex-row inline-box gap-5 md:gap-10 mt-6">
                                    <div class="radio-tab flex flex-row md:flex-col">
                                        ...
                                        <div class="">
                                            <p class="text-sm">Sangat Tidak </br>Sesuai</p>
                                        </div>
                                    </div>

                                    <div class="radio-tab flex flex-row md:flex-col ">
                                        <div class="mr-3">
                                            <input type="radio" name="answer" value="2" class="answer_input" id="answer2" required></input>
                                            <label for="answer2" class="answer_label"><i class="fluent--number-circle-2-32-filled"></i></label>
                                        </div>
                                    ...
                                    <div class="radio-tab flex flex-row md:flex-col">
                                        <div class="mr-3">
                                            <input type="radio" name="answer" value="3" class="answer_input" id="answer3" required></input>
                                            <label for="answer3" class="answer_label"><i class="fluent--number-circle-3-32-filled"></i></label>
                                        </div>
                                        <div class="my-2 md:my-0">
                                    ...
                                    <div class="radio-tab flex flex-row md:flex-col">
                                        <div class="mr-3">
                                            <input type="radio" name="answer" value="4" class="answer_input" id="answer4" required></input>
                                            <label for="answer4" class="answer_label"><i class="fluent--number-circle-4-32-filled"></i></label>
                                        </div>
                                        <div class="my-2 md:my-0">
                                            <p class="text-sm">Tidak Sesuai</p>
                                        </div>
                                    ...
                                    <div class="radio-tab flex flex-row md:flex-col">
                                        <div class="mr-3">
                                            <input type="radio" name="answer" value="5" class="answer_input" id="answer5" required></input>
                                            <label for="answer5" class="answer_label"><i class="fluent--number-circle-5-32-filled"></i></label>
                                        </div>
                                        <div class="my-2 md:my-0">
