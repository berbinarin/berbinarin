        ...
        <div class="flex">
            <div class="t-container mt-24 ml-28 z-10">
                ...
                <div class="quest-container mt-6 w-[690px] h-[390px] bg-white rounded-3xl p-16">
                    ...
                    <p class="question ">$item->contentSoal</p>
                    @if ($item->tipePerhitungan == "R")
                    <div class="quest-choice flex gap-10 mt-6">
                        <button class="opt1 rounded-full bg-slate-200 text-slate-700 hover:bg-slate-400 w-12 h-12">5</button>
                        <button class="opt2 rounded-full bg-slate-200 text-slate-700 hover:bg-slate-400 w-12 h-12">4</button>
                        <button class="opt3 rounded-full bg-slate-200 text-slate-700 hover:bg-slate-400 w-12 h-12">3</button>
                        <button class="opt4 rounded-full bg-slate-200 text-slate-700 hover:bg-slate-400 w-12 h-12">2</button>
                        <button class="opt5 rounded-full bg-slate-200 text-slate-700 hover:bg-slate-400 w-12 h-12">1</button>
                    </div>  
                    @else
                    <div class="quest-choice flex gap-10 mt-6">
                    ...
                    <button type="submit" class="px-10 py-3 text-primary bg-white border-primary border-[1px] rounded-3xl hover:bg-sky-950 hover:text-white">Selesai</button>
                    </form>
                </div>     
                @empty
