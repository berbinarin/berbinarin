                ...
                <form action="{{ route('feedback.store', ['user_id' => $user_id, 'test_id' => $test_id]) }}"
                    ...
                    <div class="rating_list flex flex-row justify-center">
                        <div class="rating_item">
                            <input class="rating_input rating-5" id="rating-5-1" type="radio" value="5" name="rating">
                            <label class="rating_label rating-5 -pl-5 pr-2" for="rating-5-1"><i
                                    class="em em-wahoo"></i></label>
                            <p class="text-xs text-center text-disabled -mt-2 pr-2">Sangat Senang</p>
                        </div>
                        <div class="rating_item">
                            <input class="rating_input rating-3" id="rating-4-1" type="radio" value="4" name="rating">
                            <label class="rating_label rating-3 pr-2" for="rating-4-1"><i
                                    class="em em-happy"></i></label>
                            <p class="text-xs text-center text-disabled -mt-2 pr-2">Senang</p>
                        </div>
                        <div class="rating_item">
                            <input class="rating_input rating-3" id="rating-3-1" type="radio" value="3" name="rating">
                            <label class="rating_label rating-3 pr-2" for="rating-3-1"><i
                                    class="em em-neutral"></i></label>
                            <p class="text-xs text-center text-disabled -mt-2 pr-2">Netral</p>
                        </div>
                        <div class="rating_item">
                            <input class="rating_input rating-2" id="rating-2-1" type="radio" value="2" name="rating">
                            <label class="rating_label rating-2 pr-2" for="rating-2-1"><i
                                    class="em em-bummed"></i></label>
                            <p class="text-xs text-center text-disabled -mt-2 pr-2">Bosan</p>
                        </div>
                        <div class="rating_item">
                            <input class="rating_input rating-1" id="rating-1-1" type="radio" value="1" name="rating">
                            <label class="rating_label rating-1 pr-2" for="rating-1-1"><i
                                    class="em em-pissed"></i></label>
                            <p class="text-xs text-center text-disabled -mt-2 pr-2">Tidak<br>Suka</p>
                        </div>
                    </div>

                    <!-- <div class="flex flex-row justify-between text-sm text-disabled">
                        <p class="">Sangat<br>Senang</p>
                        <p class="text-sm text-disabled">Senang</p>
                        <p class="text-sm text-disabled">Netral</p>
                        <p class="text-sm text-disabled">Bosan</p>
                        <p class="text-sm text-disabled">Tidak<br>Suka</p>
                    </div> -->
