            ...
            <div class="flex relative bg-primary rounded-[30px] items-center mt-2">
                <div class="relative flex flex-col items-center">
                    ...
                    <p
                        ...
                        dari
                        tes
                        lima dimensi kepribadian yang dapat mengungkapkan potensi karir yang sesuai dengan kepribadian
                        SobatBinar.
                        Tes
                        Lima Dimensi Kepribadian secara luas dianggap sebagai cara paling kuat untuk menggambarkan
                        perbedaan
                        kepribadian yang SobatBinar miliki. Ini adalah dasar penelitian kepribadian paling modern.
                        <br><br>
                        Tes
                        Lima
                        Dimensi Kepribadian adalah salah satu alat tes untuk mengungkap kepribadian berdasarkan teori
        ...
        <div class="modal-dialog max-w-lg m-7 mx-2 sm:mx-auto pb-4 bg-white rounded-xl shadow-lg">
            ...
            <div>
                <div class="text-center">
                    ...
                    <p class="font-bold px-10 md:px-24">Perhatikan dengan seksama instruksi pengisian berikut untuk
                        mengisi free
                        tes psikotes berbinar</p>
                </div>
                <div class="px-16 pt-10 pb-2">
                    <p class="text-justify">Pada tes ini, setiap nomor berisikan satu pernyataan beserta lima pilihan
                        ...
                        setiap
                        pernyataan dengan keadaan diri Kamu yang sebenarnya. Tiap pilihan skor kesesuaian yang
                        SobatBinar
