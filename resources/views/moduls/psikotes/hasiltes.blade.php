        ...
        <div class="bg-primary items-center t-container z-38 w-full p-[22px]">
            <div class="quest-container w-full bg-white justify-center rounded-3xl p-5">
                ...
                <div class="flex flex-col md:flex-row w-full h-full mb-5 gap-5">
                    ...
                    <div class="float-left md:w-3/5 h-fit p-5 md:p-7 m-0 md:m-5 bg-sky-100 rounded-3xl font-semibold">
                        ...
                        <div class="progress mb-4 flex flex-col md:flex-row">
                            ...
                            <div class="progress-bar w-[20px] h-5 my-3 bg-[#FA933C] rounded-full text-[13px] text-end"
                                role="progressbar" style="width: {{ $result->agreeableness }}%;"
                        ...
                        <div class="progress mb-4 flex flex-col md:flex-row">
                            ...
                            <div class="progress-bar w-[20px] h-5 my-3 bg-[#FBB03B] rounded-full text-[13px] text-end"
                                role="progressbar" style="width: {{ $result->conscientiousness }}%;"
                        ...
                        <div class="progress mb-4 flex flex-col md:flex-row">
                            ...
                            <div class="progress-bar w-[20px] h-5 my-3 bg-[#FADF3C] rounded-full text-[13px] text-end"
                                role="progressbar" style="width: {{ $result->extraversion }}%;"
                        ...
                        <div class="progress mb-4 flex flex-col md:flex-row">
                            ...
                            <div class="progress-bar w-[20px] h-5 my-3 bg-[#FAD18F] rounded-full text-[13px] text-end"
                                role="progressbar" style="width: {{ $result->neuroticism }}%;"
                        ...
                        <div class="progress mb-0 md:mb-4 flex flex-col md:flex-row">
                            ...
                            <div class="progress-bar w-[20px] h-5 my-3 bg-[#FA713C] rounded-full text-[13px] text-end"
                                role="progressbar" style="width: {{ $result->openness }}%;"
                    ...
                    <div id="carousel-example"
                        class="relative h-fit md:h-full bg-sky-100 rounded-3xl md:w-2/5 m-0 md:m-5 px-5 pt-5 pb-12 md:p-5"
                        data-carousel="static">
                        <!-- Carousel wrapper -->
                        <div class="relative h-[25rem] mb-3 overflow-hidden rounded-lg md:h-[19rem]">
                            <!-- item 1 -->
                            <div id="carousel-item-1" class="hidden duration-700 ease-in-out overflow-auto"
                                ...
                                <p class="text-justify text-base leading-relaxed mt-5 mx-4">
                                    ...
                                    terhadap hal-hal baru dan keinginan untuk mengetahui clas serta mempelajari sesuatu
                                    yang baru.
                                </p>
                            </div>
                            <!-- item 2 -->
                            <div id="carousel-item-2" class="hidden duration-700 ease-in-out overflow-auto"
                                data-carousel-item>
                                ...
                                <p class="text-center text-base font-semibold mt-6 mb-5"><span
                                        class="italic">Conscientiousness </span><br />(Sifat berhati-hati)</p>
                                <p class="text-justify text-base leading-relaxed mt-5 mx-4">
                            ...
                            <!-- item 3 -->
                            <div id="carousel-item-3" class="hidden duration-700 ease-in-out overflow-auto"
                                data-carousel-item>
                                <h2 class="text-xl font-bold mt-2 mb-5 text-center">Uraian Hasil Tes</h2>
                                <p class="text-center text-base font-semibold mt-6 mb-5"><span
                                        class="italic">Extraversion </span><br />(Ekstraversi)</p>
                                <p class="text-justify text-base leading-relaxed mt-5 mx-4">
                            ...
                            <!--item 4 -->
                            <div id="carousel-item-4" class="hidden duration-700 ease-in-out overflow-auto"
                                data-carousel-item>
                                <h2 class="text-xl font-bold mt-2 mb-5 text-center">Uraian Hasil Tes</h2>
                                <p class="text-center text-base font-semibold mt-6 mb-5">
                                ...
                                <p class="text-justify text-base leading-relaxed mt-5 mx-4">
                                    ...
                                    lebih patuh dengan individu lainya dan memiliki
                                    kepribadian yang ingin menghindari konflik.
                                </p>
                            </div>
                            <!-- item 5 -->
                            <div id="carousel-item-5" class="hidden duration-700 ease-in-out overflow-auto"
                                data-carousel-item>
                                <h2 class="text-xl font-bold mt-2 mb-5 text-center">Uraian Hasil Tes</h2>
                                <p class="text-center text-base font-semibold mt-6 mb-5"><span
                                        class="italic">Neuroticism </span><br />(Neurotisme)</p>
                                <p class="text-justify text-base leading-relaxed mt-5 mx-4">
                        ...
                        <button type="button"
                            ...
                            data-carousel-prev>
                            <span
                                class="inline-flex items-center justify-center w-7 h-7 rounded-full dark:bg-gray-800/30 group-hover:bg-amber-300 dark:group-hover:bg-primary group-focus:ring-2 group-focus:ring-primary group-focus:outline-none">
                ...
                <div class="flex flex-col w-full md:flex-row gap-5 justify-end items-end">
                    <form action="{{ route('result.finishTest', ['test_id' => $test->id, 'user_id' => $user->id]) }}"
                        method="POST">
                        @csrf
                        <button type="submit"
                            class="mr-3 md:mr-5 text-xl text-white bg-primary rounded-full font-semibold border-3 border-white hover:border-amber-300 hover:bg-amber-300 hover:text-primary hover:font-semibold duration-500 px-10 py-2.5 w-fit">
                            Beranda
                        </button>
                    </form>
                </div>
