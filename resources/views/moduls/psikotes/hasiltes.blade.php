                ...
                <div class="quest-container w-full bg-white justify-center rounded-3xl p-5">
                        ...
                        <div class="float-left md:w-3/5 h-fit p-5 md:p-7 m-0 md:m-5 bg-sky-100 rounded-3xl font-semibold">
                            ...
                            <div class="progress mb-4 flex flex-col md:flex-row">
                                ...
                                <div class="progress-bar w-[20px] h-5 my-3 bg-[#FA933C] rounded-full text-[13px] text-end"
                                    ...
                                    aria-valuenow="{{ $result->agreeableness }}" aria-valuemin="0" aria-valuemax="100"><span
                                        class="mr-3">
                            ...
                            <div class="progress mb-4 flex flex-col md:flex-row">
                                ...
                                <div class="progress-bar w-[20px] h-5 my-3 bg-[#FADF3C] rounded-full text-[13px] text-end"
                                    ...
                                    aria-valuenow="{{ $result->extraversion }}" aria-valuemin="0" aria-valuemax="100"><span
                                        class="mr-3">
                            ...
                            <div class="progress mb-4 flex flex-col md:flex-row">
                                ...
                                <div class="progress-bar w-[20px] h-5 my-3 bg-[#FAD18F] rounded-full text-[13px] text-end"
                                    ...
                                    aria-valuenow="{{ $result->neuroticism }}" aria-valuemin="0" aria-valuemax="100"><span
                                        class="mr-3">
                            ...
                            <div class="progress mb-0 md:mb-4 flex flex-col md:flex-row">
                                ...
                                <div class="progress-bar w-[20px] h-5 my-3 bg-[#FA713C] rounded-full text-[13px] text-end"
                                    ...
                                    aria-valuenow="{{ $result->openness }}" aria-valuemin="0" aria-valuemax="100"><span
                                        class="mr-3">
                    ...
                    <div class="flex flex-col w-full md:flex-row gap-5 justify-end items-end">
                        <form action="{{ route('result.finishTest', ['test_id' => $test->id, 'user_id' => $user->id]) }}"
                            ...
                            @csrf
                            <button type="submit"
                                class="mr-3 md:mr-5 text-xl text-white bg-primary rounded-full font-semibold border-3 border-white hover:border-amber-300 hover:bg-amber-300 hover:text-primary hover:font-semibold duration-500 px-10 py-2.5 w-fit">Beranda</button>
                        </form>
