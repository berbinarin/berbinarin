...
@section('content')
    ...
    style="margin-top: 5px;">
        ...
        <div
            ...
            <p class="text-base text-disabled  text-center">Setelah mengetahui informasi terhadap posisi yang diinginkan, kandidat melakukan pengisian dan pendaftaran diri pada google formulir yang telah tertera.</p>
        </div>
        ...
        <div
            ...
            <p class="text-base text-disabled  text-center">Kandidat wajib mengirim berkas, seperti CV, Resume, Portofolio sesuai dengan persyaratan.</p>
        </div>
        ...
        <div
            ...
            <p class="text-base text-disabled  text-center">Kandidat menunggu pengumuman melalui email atau whatsapp terkait proses interview.</p>
        </div>
    </section>
    
    {{-- APA YANG DIDAPAT --}}
    <h1 class="text-black fomt-semibold text-3xl px-5 md:px-0 text-center mt-10 mb-0">Apa yang akan anda dapatkan dalam Internship Berbinar?</h1> 
    <section
    class="max-w-6xl mx-5 md:mx-auto md:px-0 flex flex-col md:flex-row gap-6 md:gap-2 md:items-center md:-mt-24 z-40"
    style="margin-top: 5px;">
        <div
            ...
            <p class="text-base text-disabled  text-center">Staf akan mendapatkan sertifikat elektronik di akhir masa jabatan sesuai dengan kontrak kerja yang berlaku.</p>
        </div>
        ...
        <div
            ...
            <p class="text-base text-disabled  text-center">Staf dapat memperluas relasi dan membangun lingkungan yang positif dengan praktisi psikologi dan mahasiswa dari berbagai Universitas.</p>
        </div>
        ...
        <div
            ...
            <p class="text-base text-disabled  text-center">Staf dapat menambah pengetahuan dan mengembangkan kemampuannya baik pada bidang psikologi maupun pelaksanaan operasional perusahaan.</p>
        </div>
        ...
        <div
            ...
            <p class="text-base text-disabled  text-center">Staf akan mendapatkan sesi konseling gratis sebulan sekali *S&K berlaku.</p>
        </div>
    </section>
    ...
    style="margin-top: 5px;">
        <div
            ...
            <p class="text-base text-disabled  text-center">Mendapatkan rangkaian tes psikologi secara gratis yang hasilnya dapat dikonsultasikan pada psikolog Berbinar.</p>
        </div>
        ...
        <div
            ...
            <p class="text-base text-disabled  text-center">Mendapatkan rekomendasi kerja, LinkedIn, dan lainnya dari CEO Berbinar apabila dalam masa kerjanya mampu menunjukkan kinerja yang baik secara lisan maupun tertulis.</p>
        </div>
        ...
        <div
            ...
            <p class="text-base text-disabled  text-center">Berbinar memberikan akomodasi penuh apabila staf ingin mengkonversi internship Berbinar ke SKP *S&K berlaku.</p>
        </div>
        ...
        <div
            ...
            <p class="text-base text-disabled  text-center">Mendapatkan pengalaman internship di bawah naungan perusahaan profesional yang andal di bidang Psikologi.</p>
        </div>
    </section>
