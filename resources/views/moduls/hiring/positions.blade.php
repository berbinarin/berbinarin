...
{{-- POSITIONS SECTION --}}
<section class="max-w-6xl mx-auto flex flex-col gap-8 z-40 items-center justify-center mt-40">
    ...
    <div class="flex flex-row flex-wrap items-center justify-center gap-5 mx-5 md:mx-0">
        ...
        <div class="flex flex-col bg-white shadow-md rounded-md gap-5 px-5 py-5 w-full md:w-[250px]" data-aos="fade-right" data-aos-duration="1000">
