                            ...
                            <div class="w-full md:w-1/2 pr-0 md:pr-10">
                                <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    <div class="col-span-full">
                                        <label for="reason" class="block text-lg font-semibold leading-6 text-black">Alasan Mengikuti
                                            Psikotes</label>
                                        <div class="mt-2">
                                            <textarea id="reason" name="reason" rows="3" class="block w-full h-[200px] rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-lg sm:leading-6"></textarea>
                                        </div>
                                    </div>

                                </div>
                                <div class="flex flex-row w-full gap-5 mt-10">
                                    <div class="flex flex-row px-5 py-2 w-auto bg-primary hover:shadow-lg hover:shadow-cyan-300/80 rounded-full">
                                        <button type="submit" class="flex flex-row text-lg text-white font-semibold duration-500">Selanjutnya
