    ...
    <div class="w-screen relative bg-[#BFE2F4]">
        ...
        <div class="flex flex-col justify-center items-center">
            ...
            <div class="flex justify-center top-0 bottom-0">
                <div
                    class="absolute top-0 bottom-0 my-36 w-[300px] h-[380px] md:w-[400px] md:h-[380px] backdrop-blur-md bg-white/10 shadow-lg ring-1 ring-black/5 gap-4 rounded-xl">
                    <div class="p-5">
                        <div class="mt-3">
                            ...
                            <form class="space-y-6" method="POST" action="{{ route('psikotest-paid.login') }}">
                                ...
                                <div>
                                    <div class="flex items-center justify-between">
                                        <label for="password"
                                            class="block text-base font-semibold leading-6 text-black">Password</label>
                                        <div class="text-sm">
                                        </div>
                                    </div>
                                    <div class="mt-2">
