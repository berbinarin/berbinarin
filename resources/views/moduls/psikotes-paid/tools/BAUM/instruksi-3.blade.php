...
<div class="relative h-11/12 md:min-h-screen flex flex-col items-center bg-gray-100 justify-center">
    ...
    <div class="relative text-justify z-10 w-3xl mx-auto p-6 mt-0" style="width: 750px;">
        ...
        <ul class="custom-list-c px-5">
            <li>Pada tes ini, <span class="font-semibold">tugas Anda adalah menggambar sebuah pohon</span>
                dan apabila anda sudah selesai menggambar pohon, <span class="font-semibold">silakan tuliskan nama pohon
                    yang Anda gambar di
                    halaman kertas yang ada identitasnya atau di halaman kertas sebaliknya.</span>
            </li>
        </ul>
        </p>
        ...
        <div class="mb-4 flex justify-center mt-10">
            <form action="" method="POST">
                @csrf
                <a href="{{ route('psikotest-paid.tool.baum.instruksi4') }}"
