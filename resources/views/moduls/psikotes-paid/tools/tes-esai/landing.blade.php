...
<div class="relative h-11/12 md:min-h-screen flex flex-col items-center bg-gray-100 justify-center">
  ...
  <p class="font-bold text-2xl text-center text-gray-800 mt-16 z-20 relative">Tes 17</p>
  ...
  <div class="relative text-justify z-10 w-3xl mx-auto bg-white bg-opacity-50 shadow-lg rounded-lg p-6 mt-4 " style="width: 750px;">
    <p class="text-black mt-4 px-5">
      Hai {{ $user->fullname }}, berikut adalah instruksi untuk test 17
    </p>
    <p class="text-black mt-4 px-5">
        Akan terdapat 6 pertanyaan yang disajikan. Jawablah pertanyaan tersebut pada kolom yang tersedia sesuai dengan kondisi Anda saat ini.
    </p>
    <div class="mb-4 flex justify-center gap-4 mt-10">
        ...
        <form action="{{ route('psikotest-paid.tool.Tes Esai.start') }}" method="POST" class="inline">
            @csrf
