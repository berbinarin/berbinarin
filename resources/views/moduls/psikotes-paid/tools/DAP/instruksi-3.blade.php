...
<div class="relative h-11/12 md:min-h-screen flex flex-col items-center bg-gray-100 justify-center">
    ...
    <div class="relative text-justify z-10 w-3xl mx-auto p-6 mt-0" style="width: 750px;">
        ...
        <ul class="custom-list-c px-5">
            <li>Apabila sudah selesai, silakan <span class="font-semibold">tuliskan atau ceritakan gambar yang baru
                    Anda gambar dengan satu
                    kalimat. Satu kalimat yang menggambarkan gambar yang telah Anda buat</span> pada lembaran kertas
                yang ada identitasnya atau di halaman kertas
                sebaliknya.
            </li>
        </ul>
        </p>
        ...
        <div class="mb-4 flex justify-center mt-10">
            <form action="" method="POST">
                @csrf
                <a href="{{ route('psikotest-paid.tool.dap.instruksi4') }}"
