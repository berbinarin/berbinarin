...
<div class="relative h-11/12 md:min-h-screen flex flex-col items-center bg-gray-100 justify-center">
    ...
    <div class="relative text-justify z-10 w-3xl mx-auto p-6 mt-0" style="width: 750px;">
        ...
        <ul class="custom-list-c px-5">
            <li>Pada tes ini,<span class="font-semibold"> tugas Anda adalah menggambar seorang
                    manusia.</span> Apabila sudah selesai silahkan pada lembaran kertas yang ada identitasnya atau di
                halaman kertas sebaliknya, <span class="font-semibold"> tuliskan</span>:
            </li>
        </ul>
        </p>
        ...
        <ul class="list-disc list-outside px-16 font-semibold">
            ...
            <li>Jenis Kelamin</li>
            <li>Profesi</li>
            <li>Aktivitas sedang apa</li>
            <li>Alasan mengapa menggambar itu</li>
        </ul>
        </p>
        ...
        <div class="mb-4 flex justify-center mt-10">
            <form action="" method="POST">
                @csrf
                <a href="{{ route('psikotest-paid.tool.htp.instruksi4') }}"
