...
{{-- PRODUK KELAS --}}
<section class="mt-10 relative w-full">
    ...
    <p class="max-sm:text-[29px] text-4xl font font-semibold text-black text-center mt-14 max-sm:mx-2 mx-20 relative z-10">Pilihan Terbaik Produk Kelas <span class="bg-primary text-white px-2 ">Berbinar</span></p>
