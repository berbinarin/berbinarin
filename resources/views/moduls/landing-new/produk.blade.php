        ...
        <section>
            <div class="swiper-container swiperProdukBerbinar hidden max-md:flex max-w-3xl overflow-hidden">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide produkBerbinar">
                        <div class="relative">
                            <img src="{{ asset('assets/images/landing/workshop/workshop-Secretary and Finance.png') }}" alt="Workshop" class="h-72 w-full object-cover rounded-xl">
                            <p class="absolute left-4 top-4 bg-[#FEF7EB] text-[#C78E2E] px-2 py-1 rounded-md text-sm">Workshop</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide produkBerbinar">
                        <div class="relative">
                            <img src="{{ asset('assets/images/landing/workshop/workshop-Researcher.png') }}" alt="Workshop" class="h-72 w-full object-cover rounded-xl">
                            <p class="absolute left-4 top-4 bg-[#FEF7EB] text-[#C78E2E] px-2 py-1 rounded-md text-sm">Workshop</p>
                        </div>
                    </div>
                </div>
...
<section>
    <div class="mx-14 my-5 max-lg:my-8 max-md:hidden">
        <div class="flex flex-wrap justify-center items-center w-full gap-x-8 gap-y-5 ">
            ...
            <div class="relative">
                <img src="{{ asset('assets/images/landing/workshop/workshop-Secretary and Finance.png') }}" alt="Workshop" class="h-52 w-[360px] max-lg:w-[450px] max-lg:h-[250px] object-cover rounded-xl">
                <p class="absolute left-4 top-4 bg-[#FEF7EB] text-[#C78E2E] px-2 py-1 rounded-md text-sm">Workshop</p>
            </div>
