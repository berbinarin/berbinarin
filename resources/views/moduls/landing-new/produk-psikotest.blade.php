...
@section("content")
    ...
    <div class="relative">
      ...
      >
        <div class="max-lg:min-w-auto flex max-w-xl flex-1 flex-col space-y-6 max-sm:space-y-2">
          ...
          >
            <img
              src="{{ asset("assets/images/landing/asset-psikotes/hero.png") }}"
              alt="Konseling"
          ...
          <div class="lg:order-4">
            ...
            >
              Psikotes berbinar Insightful Indonesia merupakan solusi unggul untuk perusahaan dan
              individu dalam pengembangan karier dan penilaian potensi. Memberikan wawasan mendalam
              tentang kepribadian, keterampilan, dan kemampuan, untuk membantu pengambilan keputusan
              yang tepat dalam mengoptimalkan potensi karier.
            </p>
          </div>
        </div>
  ...
  <section class="relative mt-24 w-full">
    <div class="absolute left-0 top-4 z-0 max-sm:top-40">
      <img
        src="/assets/images/landing/asset-konseling/vector/vector-line.svg"
        alt="Vector Image"
        class=""
      />
    </div>
    ...
    <div
      class="relative z-10 mx-20 mb-20 flex flex-row gap-x-1 rounded-xl bg-white p-10 shadow-md max-lg:flex-col max-lg:gap-y-4 max-sm:mx-4 max-sm:p-4"
    >
      <div class="hidden flex-initial items-center lg:flex">
        <img
          src="{{ asset("assets/images/landing/asset-psikotes/person.png") }}"
          alt="Vector"
          class="h-[350px] w-auto object-contain"
        />
      </div>
      ...
      <div class="flex items-center justify-center lg:hidden">
        <img
          ...
          alt="Berbinar"
          class="h-[320px] w-auto object-contain max-md:h-[290px] max-sm:h-[270px]"
        />
      </div>
      ...
      <div class="flex-1">
        <div class="flex flex-col gap-y-4">
            ...
            @foreach ($visimisis as $visimisi)
              <div class="flex w-auto items-center rounded-full bg-[#3986A3] p-2">
                <div class="flex flex-row items-center gap-x-1">
                  <img
                    src="{{ asset("assets/images/landing/asset-beranda/vector/tick.svg") }}"
                    alt="Vector"
          ...
          <div class="flex-col">
            <p class="text-justify text-[17px] font-[300] text-[#70787D] max-sm:text-[15px]">
              Berbinar memberikan produk yang dapat disesuaikan dengan kebutuhan SobatBinar dalam
              penggunaan jasa layanan psikologi, seperti konseling, psikotes, kelas, konsultan SDM,
              webinar/seminar, training, workshop, kaos motivasi, dan masih banyak lagi
            </p>
            <br />
            <div class="mb-2 flex flex-row items-start gap-x-1">
              <img
                src="{{ asset("assets/images/landing/asset-psikotes/icon/point.svg") }}"
                alt="Vector"
                class="mt-1 h-4 w-auto"
              />
            ...
            <ul class="ml-10 list-disc text-justify text-[17px] text-[#70787D] max-sm:text-[15px]">
              ...
              <li>
                Bisa merencanakan sesi tes offline sesuai kesepakatan di lokasi pilihan untuk
      ...
      @foreach ($testimoni_psikotes as $psikotes)
        <div class="rounded-xl bg-white p-6 shadow-md max-lg:p-4">
          <div class="flex flex-col">
            ...
            <img
              src="{{ asset("assets/images/landing/asset-konseling/vector/vector-divider.svg") }}"
              alt="Vector"
              class="my-2 w-full"
            />
  ...
  <section class="relative w-full">
    ...
    <div
      class="bg-individu relative z-10 mx-20 mt-12 h-auto rounded-3xl p-10 max-sm:mx-4 max-sm:p-5"
    >
      <div class="absolute inset-0 flex rounded-3xl bg-[#D7E6ED] mix-blend-multiply"></div>
      <div
        class="relative flex h-full flex-col justify-center space-y-3 text-left max-md:text-center"
      >
        <h1
          class="bg-gradient-to-l from-[#CF942E] to-[#F7B23B] bg-clip-text text-5xl font-semibold text-transparent max-md:text-4xl max-sm:text-3xl sm:text-black"
        >
          Psikotes Individu
        </h1>
        <p
        ...
        <a href="{{ route("psikotes-new/daftar-psikotes") }}">
          <div class="relative z-10 flex justify-start max-md:justify-center">
            ...
            href="{{ route('psikotestHome') }}"
              class="text-md rounded-xl bg-gradient-to-r from-[#3986A3] to-[#225062] px-4 py-2 text-white max-sm:rounded-md max-sm:px-6 max-sm:text-[15px]"
            >
              Daftar Psikotes Individu
          </a>
          </div>
        </a>
      </div>
  ...
  <section class="relative">
    ...
    <div class="swiperContainer relative z-10 hidden md:block">
      <div class="swiper" id="swiperIndividu">
        <div class="swiper-wrapper">
          @foreach ($individus as $individu)
            <div class="swiper-slide">
              <div
                class="flex h-full max-h-[300px] w-full max-w-[250px] flex-col items-center justify-center rounded-2xl bg-white px-2 py-4 text-center shadow-md"
              >
                <img
                  src="{{ asset($individu["illustrasi"]) }}"
                  alt="{{ $individu["jenis_tes"] }}"
                ...
                <div class="my-3 flex justify-center">
                  <a
                    href="{{ route("psikotestHome") }}"
                    class="rounded-lg bg-gradient-to-r from-[#F7B23B] to-[#AD7D29] px-4 py-1.5 text-sm text-white"
                  >
                    Mulai Sekarang
                  </a>
                </div>
        ...
        <p class="mt-2 text-[16px] text-[#4F4F4F] max-sm:text-[14px]">
          *Harga masih bisa dinegosiasikan dan menyesuaikan dengan benefit yang ingin didapatkan.
        </p>
    ...
    {{-- TAMPILAN MOBILE --}}
    <div
      class="relative z-10 mt-5 grid grid-cols-2 justify-between gap-4 max-md:mx-20 max-sm:mx-4 md:hidden"
    >
      @foreach ($individus as $individu)
        <div
          class="flex h-full w-full flex-col items-center justify-center rounded-2xl bg-white p-4 text-center shadow-md"
        >
          <img
            src="{{ asset($individu["illustrasi"]) }}"
            alt="{{ $individu["jenis_tes"] }}"
          ...
          <div class="flex flex-col gap-y-0.5 text-left">
            <div class="flex items-start gap-1">
              <img
                src="{{ asset($individu["keterangan"]["laporan_tertulis"] ? "assets/images/landing/asset-psikotes/icon/check.svg" : "assets/images/landing/asset-psikotes/icon/cross.svg") }}"
                alt="{{ $individu["keterangan"]["laporan_tertulis"] ? "Centang Hijau" : "Silang Merah" }}"
                class="mt-1 h-3.5 w-3.5 object-contain max-sm:h-3 max-sm:w-3"
              />
              <span class="leading-snug text-[#70787D] max-sm:text-[14px] max-sm:leading-tight">
                Laporan Tertulis
              </span>
            </div>
          ...
          <div class="mt-3 flex w-full justify-center">
            <a
              href="{{ route("psikotestHome") }}"
              class="w-full rounded-xl bg-gradient-to-r from-[#F7B23B] to-[#AD7D29] py-1.5 text-[13px] text-white"
            >
              Mulai Sekarang
            </a>
          </div>
    ...
    <p
      class="mt-2 block text-[16px] text-[#4F4F4F] max-md:mx-20 max-sm:mx-4 max-sm:text-[13px] max-sm:leading-tight md:hidden"
    >
      *Harga masih bisa dinegosiasikan dan menyesuaikan dengan benefit yang ingin didapatkan.
    </p>
  </section>
  ...
  <section>
    <div
      class="bg-perusahaan relative z-10 mx-20 mt-10 h-auto rounded-3xl p-10 max-sm:mx-4 max-sm:p-5"
    >
      <div class="absolute inset-0 flex rounded-3xl bg-[#D7E6ED] mix-blend-multiply"></div>
      ...
      >
        ...
        <p
          class="text-justify text-lg text-[#3F3F3F] max-lg:text-[17px] max-sm:text-[15px] max-sm:leading-normal"
        >
          Psikotes untuk supervisor digunakan untuk melihat potensi, kelebihan dan kekurangan, serta
  ...
  <section class="relative">
    <h2
      class="text-gradient relative z-10 mb-4 mt-14 text-center text-3xl font-bold max-sm:mx-4 max-sm:text-2xl"
    >
      Psikotes Perusahaan untuk Staff
    </h2>
    <section>
      {{-- TAMPILAN DESKTOP --}}
      <div class="swiperContainer relative z-10 hidden md:block">
        <div class="swiper" id="swiperPerusahaanStaff">
          <div class="swiper-wrapper">
            @foreach ($staffs as $staff)
              <div class="swiper-slide">
                <div
                  class="flex h-full max-h-[500px] w-full max-w-[350px] flex-col items-center justify-center rounded-2xl bg-white p-4 text-center shadow-md"
                >
                  ...
                  <div class="flex flex-col space-y-1 text-left">
                    ...
                    <div class="flex items-start gap-1">
                      ...
                      />
                      <span class="leading-snug text-[#70787D]">
                        Deskripsi Karakteristik, Kelemahan, Kelebihan, dan Rekomendasi
                      </span>
                    </div>
                  ...
                  <div class="my-4 flex justify-center">
                    <a
                      href="{{ route("psikotestHome") }}"
                      class="rounded-lg bg-gradient-to-r from-[#F7B23B] to-[#AD7D29] px-4 py-1.5 text-[16px] text-white"
                    >
                      Mulai Sekarang
                    </a>
                  </div>
      ...
      <div class="relative z-10 mt-10 grid grid-cols-1 gap-y-4 max-md:mx-20 max-sm:mx-4 md:hidden">
        @foreach ($staffs as $staff)
          <div
            class="flex h-full w-full flex-col items-center justify-center rounded-2xl bg-white px-4 py-2 text-center shadow-md"
          >
            <p class="text-lg font-medium text-black">{{ $staff["paket"] }}</p>
            ...
            <div class="flex flex-col space-y-1 text-left">
              <div class="flex items-center gap-1">
                <img
                  ...
                  class="h-3.5 w-3.5"
                />
                <span class="leading-snug text-[#70787D] max-sm:text-[15px] max-sm:leading-tight">
                  Tes Intelegensi
                </span>
              </div>
  ...
  <section class="relative">
    <h2
      class="text-gradient relative z-10 mb-4 text-center text-3xl font-bold max-md:mt-3 max-sm:mx-4 max-sm:mt-6 max-sm:text-2xl"
    >
      Psikotes Perusahaan untuk Supervisor
    </h2>
    <section>
      {{-- TAMPILAN DESKTOP --}}
      <div class="swiperContainer relative z-10 hidden md:block">
        <div class="swiper" id="swiperPerusahaanSupervisor">
          ...
          <p
            class="mt-2 text-[16px] text-[#4F4F4F] max-sm:mx-4 max-sm:text-[13px] max-sm:leading-tight"
          >
            *Harga masih bisa dinegosiasikan dan menyesuaikan dengan benefit yang ingin didapatkan.
          </p>
          <div class="swiper-pagination"></div>
  ...
  <section>
    <div
      class="bg-pendidikan relative z-10 mx-20 mt-14 h-auto rounded-3xl p-10 max-sm:mx-4 max-sm:p-5"
    >
      <div class="absolute inset-0 flex rounded-3xl bg-[#D7E6ED] mix-blend-multiply"></div>
        ...
        <a href="{{ route("psikotes-new/daftar-psikotes") }}">
          <div class="relative z-10 flex justify-start max-md:justify-center">
            ...
            href="{{ route('psikotestHome') }}"
              class="text-md rounded-xl bg-gradient-to-r from-[#3986A3] to-[#225062] px-4 py-2 text-white max-sm:rounded-md max-sm:px-6 max-sm:text-[15px]"
            >
              Daftar Psikotes Instansi Pendidikan
          </a>
          </div>
        </a>
      </div>
      ...
      <div class="swiper" id="swiperPendidikan">
        <div class="swiper-wrapper">
          @foreach ($pendidikans as $pendidikan)
            <div class="swiper-slide">
              <div
                class="flex h-full max-h-[350px] w-full max-w-[250px] flex-col items-center justify-center rounded-2xl bg-white p-4 text-center shadow-md"
              >
                <img
                  src="{{ asset($pendidikan["illustrasi"]) }}"
                  alt="{{ $pendidikan["paket"] }}"
                  class="h-14 w-auto object-contain"
                />
                <p
                  class="mt-1 min-h-[50px] items-center text-lg font-medium leading-snug text-black"
                >
                  {{ $pendidikan["paket"] }}
                </p>
          ...
          <div class="flex flex-col gap-y-0.5 text-left">
            <div class="flex items-start gap-1">
              <img
                src="{{ asset($pendidikan["keterangan"]["laporan_tertulis"] ? "assets/images/landing/asset-psikotes/icon/check.svg" : "assets/images/landing/asset-psikotes/icon/cross.svg") }}"
                alt="{{ $pendidikan["keterangan"]["laporan_tertulis"] ? "Centang Hijau" : "Silang Merah" }}"
                class="mt-1 h-3 w-3 object-contain"
              />
              <span class="leading-snug text-[#70787D] max-sm:text-[14px] max-sm:leading-tight">
                Laporan Tertulis
              </span>
  ...
  <section>
    <div
      class="bg-komunitas relative z-10 mx-20 mt-10 h-auto rounded-3xl p-10 max-sm:mx-4 max-sm:p-5"
    >
      <div class="absolute inset-0 flex rounded-3xl bg-[#D7E6ED] mix-blend-multiply"></div>
      ...
      <div class="swiper" id="swiperKomunitas">
        <div class="swiper-wrapper">
          @foreach ($communitys as $community)
            <div class="swiper-slide">
              <div
                class="flex h-full max-h-[330px] w-full max-w-[250px] flex-col items-center justify-center rounded-2xl bg-white p-4 text-center shadow-md"
              >
                <img
                  src="{{ asset($community["illustrasi"]) }}"
                  alt="{{ $community["paket"] }}"
                  class="h-14 w-auto object-contain"
                />
                <p
  ...
  <section class="mt-6">
    <p
      class="font relative z-10 mx-20 my-5 text-center text-4xl font-semibold text-black max-sm:mx-2 max-sm:my-4 max-sm:text-[29px]"
    >
            ...
            <div class="swiper-slide">
              ...
              >
                ...
                <div class="flex flex-grow flex-col pt-4 text-center">
                  <p
                    class="min-h-[168px] flex-grow text-justify text-[16px] font-medium text-black max-lg:min-h-[168px] max-md:leading-snug max-sm:text-[15px] max-sm:leading-tight"
                  >
                    {{ $testimoni["comment"] }}
                  </p>
                </div>
        ...
        <div class="swiper-wrapper">
          @foreach ($dokumentasis as $dokumentasi)
            <div class="swiper-slide">
              <div class="relative">
                <img
                  src="{{ asset($dokumentasi["image"]) }}"
                  alt="Dokumentasi"
                  class="h-52 w-[345px] rounded-xl object-cover"
                />
                <p
                  class="absolute left-4 top-4 rounded-md bg-[#FEF7EB] px-2 py-1 text-sm text-[#C78E2E]"
                >
          ...
          <div class="swiper-slide">
            <div class="relative">
              <img
                src="{{ asset($dokumentasi["image"]) }}"
                alt="Dokumentasi"
                class="h-[270px] w-full rounded-xl object-cover"
              />
              <p
                class="absolute left-4 top-4 rounded-md bg-[#FEF7EB] px-2 py-1 text-sm text-[#C78E2E]"
              >
  ...
  <section>
    ...
    >
      ...
      <div
        class="relative flex h-full flex-col justify-center space-y-4 text-left max-md:text-center"
      >
        <h1
          class="mb-2 bg-gradient-to-l from-[#CF942E] to-[#F7B23B] bg-clip-text text-4xl font-semibold italic text-transparent max-md:text-4xl max-sm:text-3xl sm:text-black"
        >
          Active Campaign Empowerment (ACE)
        </h1>
        <div
          class="flex flex-col gap-y-3 text-justify text-lg text-[#3F3F3F] max-lg:text-[17px] max-sm:gap-y-1 max-sm:text-[15px] max-sm:leading-normal"
        >
          <p>
            Rangkaian acara tahunan dari Berbinar yang dirancang untuk mengenalkan produk psikotes
            kami secara lebih luas kepada khalayak. Event ini menjadi wadah bagi siapa saja yang
            ingin memperluas wawasan di bidang psikologi sekaligus memahami lebih dalam pentingnya
            pengenalan diri untuk pengembangan pribadi maupun profesional.
          </p>

          <p>
            Dalam ACE, kami menghadirkan
            <span class="font-bold">webinar eksklusif</span>
            yang menghadirkan pembicara-pembicara terkemuka di bidang psikologi. Melalui diskusi
            interaktif dan materi yang mendalam, peserta akan mendapatkan insight berharga tentang
            berbagai topik terkait psikologi dan pengembangan diri.
          </p>

          <p>
            Event ini berlangsung selama
            <span class="font-bold">tiga sesi</span>
            penuh aktivitas, mulai dari edukasi hingga kampanye kreatif, yang memberikan kesempatan
            bagi peserta untuk mengenal produk-produk psikotes kami lebih dekat.
          </p>
        </div>
        ...
        <div class="swiper-container swiperDokumentasiAce block overflow-hidden md:hidden">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img
                src="{{ asset("assets/images/landing/asset-psikotes/komunitas/komunitas1.png") }}"
                alt="Komunitas"
                class="h-[270px] w-full rounded-xl object-cover"
              />
            </div>
            <div class="swiper-slide">
              <img
                src="{{ asset("assets/images/landing/asset-psikotes/komunitas/komunitas2.png") }}"
                alt="Komunitas"
                class="h-[270px] w-full rounded-xl object-cover"
              />
            </div>
            <div class="swiper-slide">
              <img
                src="{{ asset("assets/images/landing/asset-psikotes/komunitas/komunitas3.png") }}"
                alt="Komunitas"
                class="h-[270px] w-full rounded-xl object-cover"
              />
            </div>
      ...
      <div class="flex w-full flex-wrap items-center justify-center gap-x-8 gap-y-5">
        <div class="relative">
          <img
            src="{{ asset("assets/images/landing/asset-psikotes/komunitas/komunitas1.png") }}"
            alt="Komunitas"
            class="h-52 w-[345px] rounded-xl object-cover max-lg:h-[250px] max-lg:w-[450px]"
          />
        </div>
