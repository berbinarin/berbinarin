...
<section class="relative w-full mt-24">
    ...
    <div class="relative bg-white mx-20 max-sm:mx-4 p-10 max-sm:p-4 flex flex-row gap-x-10 shadow-md max-lg:flex-col max-lg:gap-y-4 rounded-xl z-10">
        ...
        <div class="flex-1">
            <div class="flex flex-col gap-y-4">
                <div class="flex flex-row flex-wrap max-lg:justify-center gap-3">
                ...
                <div class="flex-col">
                    <p class="text-[#70787D] text-justify text-[17px] max-sm:text-[15px]">Berbinar memberikan produk yang dapat disesuaikan dengan kebutuhan SobatBinar dalam penggunaan jasa layanan psikologi, seperti konseling, psikotes, kelas, konsultan SDM, webinar/seminar, training, workshop, kaos motivasi, dan masih banyak lagi</p>
