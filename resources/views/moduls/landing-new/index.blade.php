...
@section('content')
    ...
    <section class="relative bg-cover w-full max-sm:h-[100vh] h-[110vh] bg-hero max-lg:bg-center">
        ...
        <div class="relative z-20 flex text-left items-center h-full max-sm:px-4 px-14">
            <div class="text-black max-sm:w-full flex flex-col justify-center">
                <h1 class="max-sm:text-[45px] text-6xl font-semibold judul-450px">Edukasi & Layanan <br>Psikologi <span
                        class="text-[#3886A3]">Berbinar</span></h1>
                <p class="mt-4 max-sm:text-md max-sm:w-full max-lg:w-3/4 w-2/4 text-lg font-normal text-[#444444] deskripsi-450px">
                    Berbinar hadir menawarkan layanan konseling bersama psikolog partner dan peer counselor untuk setiap
                    individu yang sedang berjuang.</p>
                <div class="flex justify-start">
                    <button
                        class="mt-4 bg-gradient-to-r from-[#F7B23B] to-[#AD7D29] text-white font-medium py-2 px-6 rounded-lg w-auto max-sm:w-auto max-sm:text-sm whitespace-nowrap">
                        Lakukan Konseling
                    </button>
                </div>
            </div>
        ...
        <div class="absolute bottom-0 max-sm:right-5 right-20 w-auto max-w-xs h-auto z-10 max-sm:opacity-80">
            <img src="{{ asset('assets/images/landing/vector-singa.png') }}" alt="Singa"
                 class="max-sm:w-auto max-sm:h-[350px] w-full h-full">
        </div>
        ...
        <!-- STATS SECTION -->
        <div
            class="absolute max-sm:bottom-[-14rem] bottom-[-5rem] left-1/2 transform -translate-x-1/2 max-sm:w-[93%] max-md:w-[83%] max-lg:w-[88%] w-4/6 bg-white py-8 bg-opacity-85 backdrop-blur-sm max-sm:px-6 px-8 rounded-xl shadow-lg z-20">
            <div
                class="flex flex-row max-sm:flex-col justify-around text-center max-sm:space-x-0 max-sm:space-y-3 space-x-8">
    ...
    <section>
        <h1 class="max-sm:text-[29px] text-4xl font font-semibold text-black text-center mt-40 max-sm:mt-64 max-sm:mx-2">
            Mengapa Harus <span class="bg-[#3886A3] text-white px-2 ">Berbinar</span></h1>
        <div class="bg-white max-sm:mx-4 mx-14 my-9 mb-16 shadow-md rounded-3xl">
            <div class="flex flex-row max-md:flex-col gap-x-6 max-md:p-5 p-8 items-center">
                ...
                <img src="{{ asset('assets/images/landing/logo-berbinar.png') }}" alt="Logo Berbinar"
                     class="h-64 w-auto hidden md:block">
                <!-- SCREEN MOBILE -->
                <img src="{{ asset('assets/images/landing/vector-konsul.png') }}" alt="Berbinar Mobile"
                     class="h-[270px] w-full object-cover rounded-lg block md:hidden">
                ...
                <div class="flex-col max-md:space-y-3 space-y-6">
                        ...
                        @foreach ($visimisis as $visimisi)
                            <div class="bg-[#3986A3] p-1.5 rounded-full items-center w-auto">
                                <div class="flex flex-row gap-x-1.5">
                                    <img src="{{ asset('assets/images/landing/asset-beranda/vector/tick.svg') }}"
                                         alt="Vector" class="h-6 w-6 bg-white rounded-full p-1">
                    ...
                    <p class="text-[#70787D] max-md:mt-3 text-justify max-sm:text-[15px] text-[17px]">
                        Berbinar memberikan produk yang dapat disesuaikan dengan kebutuhan SobatBinar dalam penggunaan
                        jasa layanan psikologi, seperti
                        konseling, psikotes, kelas, konsultan sdm, webinar/seminar, training, workshop, kaos motivasi,
                        dan masih banyak lagi
                    </p>
                    <button
                        class="text-white font-medium bg-gradient-to-r max-sm:text-[15px] text-md from-[#3986A3] to-[#225062] py-2 px-4 rounded-xl max-md:w-full">
    ...
    <div class="w-full max-sm:h-[1250px] h-[650px] bg-cover"
         style="background-image: url('/assets/images/landing/vector-pattern.png'), linear-gradient(to bottom right, #EAF8FF, #BDE8FD); background-blend-mode: normal, multiply;">
        {{-- JUDUL --}}
        <h1 class="text-4xl font font-semibold text-black text-center my-8 ">Konten Terbaru <span
                class="bg-primary text-white px-2 ">Berbinar</span></h1>
        {{-- KONTEN --}}
        <div class="flex flex-row max-sm:flex-col justify-around -mt-8 max-sm:items-center">
            ...
            <div class="justify-center text-center">
                ...
                {{-- EMBED --}}
                <div
                    style="border-radius: 20px; width: 320px; max-width: 100%; transform: scale(0.9); transform-origin: center center; overflow: hidden; height: 570px;">
                    <blockquote class="instagram-media"
                                data-instgrm-permalink="https://www.instagram.com/p/C_Ao0-KPK5S/?utm_source=ig_embed&amp;utm_campaign=loading"
                                data-instgrm-version="14"
                                style="background:#FFF; border:0; margin: 1px; padding:0; width:99.375%; width:calc(100% - 2px);">
                        <div style="padding:16px;">
                            <a href="https://www.instagram.com/p/C_Ao0-KPK5S/?utm_source=ig_embed&amp;utm_campaign=loading"
                            ...
                            <p style="color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
                                <a href="https://www.instagram.com/p/C_Ao0-KPK5S/?utm_source=ig_embed&amp;utm_campaign=loading"
                                   ...
                                   target="_blank">A post shared by Berbinar Insightful Indonesia (@berbinar.in)</a>
                            </p>
                        </div>
                    </blockquote>
                </div>
            ...
            <div class="justify-center text-center">
                ...
                {{-- EMBED --}}
                <div
                    style="border-radius: 20px; overflow: hidden; width: 320px; max-width: 100%; transform: scale(0.9); transform-origin: center center; ">
                    <blockquote class="tiktok-embed"
                        ...
                        <section style="margin: 0; padding: 0;">
                            <a target="_blank" title="@berbinar.in"
                               href="https://www.tiktok.com/@berbinar.in?refer=embed">@berbinar.in</a>
                            Celebrate Yourself! Kamu layak dirayakan atas setiap langkah, usaha, dan keberanianmu.
    ...
    <section class="mt-6">
        <p class="max-sm:text-[29px] text-4xl font font-semibold text-black text-center my-8 max-sm:mx-2 mx-20 relative z-10">
            Produk <span class="bg-primary text-white px-2 ">Berbinar</span></p>
                ...
                <div class="swiper-wrapper max-sm:pb-8 pb-1">
                    @foreach ($products as $product)
                        <div class="swiper-slide">
                            <div
                                class="bg-white rounded-3xl shadow-md flex flex-col justify-center items-center h-auto w-auto max-sm:max-w-[240px] max-sm:max-h-[370px]">
                                <div
                                    class="bg-gradient-to-b from-[#75BADB] to-[#AFCFDA] flex justify-center py-7 max-sm:py-5 rounded-t-3xl w-full">
                                    <img src="{{ asset($product['vector']) }}" alt="{{ $product['produk'] }}"
                                         class="max-sm:h-[110px] h-32 w-auto">
                                </div>
    ...
    <section class="mx-14 bg-[#EAF3F6] p-8 rounded-lg my-10">
        <div class="flex flex-col gap-y-4">
            <div class="justify-start flex">
                <img src="{{ asset('assets/images/landing/asset-beranda/vector/quote.svg') }}" alt="Vector"
                     class="h-8 w-auto">
            </div>
            <p class="text-black text-xl font-medium text-justify leading-loose">
                <span class="text-[#3986A3]">Kesehatan mental</span> merupakan hal yang sedang menjadi sebuah <span
                    class="text-[#3986A3]">trend</span> sekaligus permasalahan yang serius di era masyarakat sekarang.
                <span class="text-[#3986A3]">Berbinar</span> hadir dalam memberikan <span
                    class="text-[#3986A3]">solusi</span> terhadap keresahan dalam menghadapi persoalan kesehatan mental
            </p>
