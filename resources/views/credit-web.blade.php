    ...
    <div class="grid grid-cols-l md:grid-cols-2 lg:grid-cols-3 w-full">
        ...
        <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                ...
                <div class="rounded-xl overflow-hidden">
                    <img src="https://berbinar.in/assets/images/credit-card/Barita-MD.png" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                </div>
        ...
        <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                <!-- Gambar berada di sebelah kiri -->
                <div class="rounded-xl overflow-hidden">
                    <img src="https://berbinar.in/assets/images/credit-card/Anggi-FE.jpg" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                </div>
                <!-- Teks berada di sebelah kanan -->
                <div class="ml-5 flex flex-col">
                    ...
                    <h1 class="text-xs md:text-sm lg:text-base italic font-medium mt-1 text-gray-700">Feb 2024 -
                        Sekarang</h1>
                    <!--Start Icon-->
                    <div class="flex flew-row gap-5 flex-wrap mt-5">
        ...
        <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                <!-- Gambar berada di sebelah kiri -->
                <div class="rounded-xl overflow-hidden">
                    <img src="https://berbinar.in/assets/images/credit-card/fathiyyah2-FE.png" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                </div>
                <!-- Teks berada di sebelah kanan -->
                <div class="ml-5 flex flex-col">
            ...
            <div class="p-5 flex flex-row items-left ">
                ...
                <div class="ml-5 flex flex-col">
                    <h5 class="text-xl md:text-xl font-medium">Adam Wisnu</h4>
                        ...
                        <h1 class="text-xs md:text-sm lg:text-base italic font-medium mt-1 text-gray-700">Apr 2024 -
                            Sekarang</h1>
                        <!--Start Icon-->
                        <div class="flex flew-row gap-5 flex-wrap mt-5">
        ...
        <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                <!-- Gambar berada di sebelah kiri -->
                <div class="rounded-xl overflow-hidden">
                    <img src="https://berbinar.in/assets/images/credit-card/Ridho-BE.jpg" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                </div>
                <!-- Teks berada di sebelah kanan -->
                <div class="ml-5 flex flex-col">
        ...
        <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                <!-- Gambar berada di sebelah kiri -->
                <div class="rounded-xl overflow-hidden">
                    <img src="https://berbinar.in/assets/images/credit-card/MuhammadAdam-UIUX.jpg" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                </div>
                <!-- Teks berada di sebelah kanan -->
                <div class="ml-5 flex flex-col">
        ...
        <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                <!-- Gambar berada di sebelah kiri -->
                <div class="rounded-xl overflow-hidden">
                    <img src="https://berbinar.in/assets/images/credit-card/AlfianPutra-UIUX.jpg" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                </div>
                <!-- Teks berada di sebelah kanan -->
                <div class="ml-5 flex flex-col">
                    <h5 class="text-xl md:text-xl font-medium">Alifian Putra <br> Darmawan</h5>
                    <h4 class="text-sm md:text-base lg:text-lg font-medium mt-3">UI/UX Designer</h4>
                    <h1 class="text-xs md:text-sm lg:text-base italic font-medium mt-1 text-gray-700">Mar 2024 -
                        Sekarang</h1>
                    <!--Start Icon-->
                    <div class="flex flew-row gap-5 flex-wrap mt-5">
        ...
        <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                <!-- Gambar berada di sebelah kiri -->
                <div class="rounded-xl overflow-hidden">
                    <img src="https://berbinar.in/assets/images/credit-card/Briska-ex-UIUX.jpg" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                </div>
                <!-- Teks berada di sebelah kanan -->
                <div class="ml-5 flex flex-col">
        ...
        <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                <!-- Gambar berada di sebelah kiri -->
                <div class="rounded-xl overflow-hidden">
                    <img src="https://berbinar.in/assets/images/credit-card/farhan-ex-FS.jpg" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                </div>
                <!-- Teks berada di sebelah kanan -->
                <div class="ml-5 flex flex-col">
        ...
        <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                <!-- Gambar berada di sebelah kiri -->
                <div class="rounded-xl overflow-hidden">
                    <img src="https://berbinar.in/assets/images/credit-card/Wawa-ex-FE.jpg" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                </div>
                <!-- Teks berada di sebelah kanan -->
                <div class="ml-5 flex flex-col">
