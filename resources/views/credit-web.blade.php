    ...
    {{-- <div class="max-w-6xl mx-auto md:h-screen flex flex-col md:flex-row items-center justify-center relative px-5 md:px-0" style="margin-top: 50px; "> --}}
        ...
        <div class="rounded-xl shadow-lg mr-4">
            ...
            <div class="rounded-xl shadow-lg mr-4">
                <div class="p-5 flex flex-row items-left ">
                    <!-- Gambar berada di sebelah kiri -->
                    <div class="rounded-xl overflow-hidden">
                    <img src="{{ asset('assets/images/credit-card/juna_fe.jpg') }}" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                    </div>
                    <!-- Teks berada di sebelah kanan -->
                    <div class="ml-5 flex flex-col">
                        ...
                        <!--Start Icon-->
                        <div class="flex flew-row gap-5 flex-wrap mt-5">
                            <a href="mailto:junaidirahmat02@gmail.com" class="flex items-center justify-center" target="_blank">
                                <i class='bx bxs-envelope text-slate-500 text-[20px]'></i>
                            </a>
                            <a href="www.linkedin.com/in/junaidi-rahmat-eunola" class="flex items-center justify-center" target="_blank">
                                <i class='bx bxl-linkedin text-slate-500 text-[20px]'></i>
                            </a>
        ...
        <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                <!-- Gambar berada di sebelah kiri -->
                <div class="rounded-xl overflow-hidden">
                <img src="{{ asset('assets/images/credit-card/Arini-UIUX.jpg') }}" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                </div>
                <!-- Teks berada di sebelah kanan -->
                <div class="ml-5 flex flex-col">
                    <h5 class="text-xl md:text-xl font-medium">Talitha Dwi Arini</h4>
                    <h4 class="text-sm md:text-base lg:text-lg font-medium mt-3">UI/UX Designer</h4>
                    <h1 class="text-xs md:text-sm lg:text-base italic font-medium mt-1 text-gray-700">Agu 2024 - Sekarang</h1>
                    <!--Start Icon-->
                    <div class="flex flew-row gap-5 flex-wrap mt-5">
                        <a href="mailto:talitharyn@gmail.com " class="flex items-center justify-center" target="_blank">
                            <i class='bx bxs-envelope text-slate-500 text-[20px]'></i>
                        </a>
                        <a href="https://www.linkedin.com/in/talithadwiarini/" class="flex items-center justify-center" target="_blank">
                            <i class='bx bxl-linkedin text-slate-500 text-[20px]'></i>
                        </a>
        ...
        <!-- End Card -->
         ...
         <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                <!-- Gambar berada di sebelah kiri -->
                <div class="rounded-xl overflow-hidden">
                <img src="{{ asset('assets/images/credit-card/Memed-FE.jpg') }}" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                </div>
                <!-- Teks berada di sebelah kanan -->
                <div class="ml-5 flex flex-col">
                    <h5 class="text-xl md:text-xl font-medium">Muhammad</h4>
                    <h4 class="text-sm md:text-base lg:text-lg font-medium mt-3">Front-End<br/> Web Developer</h4>
                    <h1 class="text-xs md:text-sm lg:text-base italic font-medium mt-1 text-gray-700">Des 2024 - Sekarang</h1>
                    <!--Start Icon-->
                    <div class="flex flew-row gap-5 flex-wrap mt-5">
                        <a href="mailto:muhammadahjahh@gmail.com" class="flex items-center justify-center" target="_blank">
                            <i class='bx bxs-envelope text-slate-500 text-[20px]'></i>
                        </a>
                        <a href="https://www.linkedin.com/in/muhammad-met/" class="flex items-center justify-center" target="_blank">
                            <i class='bx bxl-linkedin text-slate-500 text-[20px]'></i>
                        </a>
                        <a href="https://www.instagram.com/mhmmad_23_/" class="flex items-center justify-center" target="_blank">
                            <i class='bx bxl-instagram-alt text-slate-500 text-[20px]'></i>
                        </a>
                    </div>
                    <!--End Icon-->
        ...
        <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                <!-- Gambar berada di sebelah kiri -->
                <div class="rounded-xl overflow-hidden">
                <img src="{{ asset('assets/images/credit-card/Ardian-BE.jpg') }}" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                </div>
                <!-- Teks berada di sebelah kanan -->
                <div class="ml-5 flex flex-col">
                    <h5 class="text-xl md:text-xl font-medium">Muhammad Hardiansyah</h4>
                    <h4 class="text-sm md:text-base lg:text-lg font-medium mt-3">Back-End<br/> Web Developer</h4>
                    <h1 class="text-xs md:text-sm lg:text-base italic font-medium mt-1 text-gray-700">Okt 2024 - Sekarang</h1>
                    <!--Start Icon-->
                    <div class="flex flew-row gap-5 flex-wrap mt-5">
                        <a href="mailto:m.hardiansyah24@gmail.com" class="flex items-center justify-center" target="_blank">
                            <i class='bx bxs-envelope text-slate-500 text-[20px]'></i>
                        </a>
                        <a href="http://www.linkedin.com/in/muhammad-hardiansyah-07ab96162" class="flex items-center justify-center" target="_blank">
                            <i class='bx bxl-linkedin text-slate-500 text-[20px]'></i>
                        </a>
                        <a href="http://www.instagram.com/m_hardiansyahh/" class="flex items-center justify-center" target="_blank">
                            <i class='bx bxl-instagram-alt text-slate-500 text-[20px]'></i>
                        </a>
                    </div>
                    <!--End Icon-->
        ...
        <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                <!-- Gambar berada di sebelah kiri -->
                <div class="rounded-xl overflow-hidden">
                <img src="{{ asset('assets/images/credit-card/Gerald-UIUX.jpg') }}" alt="Foto Profil" class="w-40 h-40 object-cover rounded-md md:w-40 md:h-40 md:rounded-md sm:w-20 sm:h-20 sm:rounded-lg">
                </div>
                <!-- Teks berada di sebelah kanan -->
                <div class="ml-5 flex flex-col">
                    <h5 class="text-xl md:text-xl font-medium">Geraldy Cornelius</h4>
                    <h4 class="text-sm md:text-base lg:text-lg font-medium mt-3">UI/UX Designer</h4>
                    <h1 class="text-xs md:text-sm lg:text-base italic font-medium mt-1 text-gray-700">Okt 2024 - Sekarang</h1>
                    <!--Start Icon-->
                    <div class="flex flew-row gap-5 flex-wrap mt-5">
                        <a href="mailto:geraldycornelius19@gmail.com" class="flex items-center justify-center" target="_blank">
                            <i class='bx bxs-envelope text-slate-500 text-[20px]'></i>
                        </a>
                        <a href="http://www.linkedin.com/in/geraldycornelius" class="flex items-center justify-center" target="_blank">
                            <i class='bx bxl-linkedin text-slate-500 text-[20px]'></i>
                        </a>
                        <a href="https://www.instagram.com/ger_geraldy/" class="flex items-center justify-center" target="_blank">
                            <i class='bx bxl-instagram-alt text-slate-500 text-[20px]'></i>
                        </a>
                    </div>
                    <!--End Icon-->
        ...
        <div class="rounded-xl shadow-lg mr-4">
            <div class="p-5 flex flex-row items-left ">
                ...
                <div class="ml-5 flex flex-col">
                    ...
                    <h4 class="text-sm md:text-base lg:text-lg font-medium mt-3">UI/UX Designer</h4>
                    <h1 class="text-xs md:text-sm lg:text-base italic font-medium mt-1 text-gray-400">Mar 2024 - Sep 2024</h1>
                    <!--Start Icon-->
                    <div class="flex flew-row gap-5 flex-wrap mt-5">
        ...
        <div class="rounded-xl shadow-lg mr-4">
                <div class="p-5 flex flex-row items-left ">
                    ...
                    <div class="ml-5 flex flex-col">
                        ...
                        <h4 class="text-sm md:text-base lg:text-lg font-medium mt-3">Front-End <br> Web Developer</h4>
                        <h1 class="text-xs md:text-sm lg:text-base italic font-medium mt-1 text-gray-400">Feb 2024 - Agu 2024</h1>
                        <!--Start Icon-->
                        <div class="flex flew-row gap-5 flex-wrap mt-5">
