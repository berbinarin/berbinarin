...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::prefix('/dashboard/admin/psikotest-paid')->group(function () {
        ...
        Route::get('/data', [DashboardController::class, 'psikotesPaidData'])->name('dashboard.psikotespaid.data');
        Route::get('/data-test', [DashboardController::class, 'psikotesPaidDataTest'])->name('dashboard.psikotespaid.data-test');
        Route::get('/data-detail', [DashboardController::class, 'psikotesPaidDataShow'])->name('dashboard.psikotespaid.data-show');
