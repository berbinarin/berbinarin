...
Route::group(['middleware'=>['auth']],function(){
    ...
    Route::get('/dashboard/admin/positions/edit/1', [DashboardController::class, 'editPositions']);
    ...
    Route::get('/dashboard/admin/positions/descriptions/edit/1', [DashboardController::class, 'editJobDescriptions']);
    ...
    Route::get('/dashboard/admin/positions/requirements/edit/1', [DashboardController::class, 'editRequirements']);
});