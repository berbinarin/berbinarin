...
class PsychologistController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($kategori === 'peer-counselor') {
            $harga = $metode === 'online'
                ? [1 => 54000, 2 => 108000, 3 => 162000][$sesi]
                : [1 => 66000, 2 => 132000, 3 => 198000][$sesi];
        } else {
            if (!$isWeekend) {
                $harga = $metode === 'online'
                    ? [1 => 180000, 2 => 306000, 3 => 432000][$sesi]
                    : [1 => 210000, 2 => 357600, 3 => 505200][$sesi];
            } else {
                $harga = $metode === 'online'
                    ? [1 => 240000, 2 => 408000, 3 => 600000][$sesi]
                    : [1 => 270000, 2 => 458400, 3 => 648000][$sesi];
            }
        }
