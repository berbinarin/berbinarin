...
class PsycologistStaffController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('dashboard.manager-cpm.index', ['PsikologData' => $PsikologData], compact('konselling'));
    }
    ...
    {
        $konselling = $request->session()->get('konselling');
        return view('dashboard.manager-cpm.create', compact('konselling'));
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        $konselling = $request->session()->get('konselling');
        return view('dashboard.manager-cpm.show', ['PsikologDataDetails' => $PsikologDataDetails], compact('konselling'));
    }
    ...
    public function edit(Request $request, $id)
    {
        $PsikologDataDetails = KonsellingPsikologStaff::find($id);
        $konselling = $request->session()->get('konselling');
        return view('dashboard.manager-cpm.edit', ['PsikologDataDetails' => $PsikologDataDetails], compact('konselling'));
    }
