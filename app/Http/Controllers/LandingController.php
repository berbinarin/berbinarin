...
class LandingController extends Controller
{
    ...
    public function bisikan_new() {
        ...
        $link_pendaftaran = 'https://bit.ly/Pendaftaran_101ClassJourney';
        return view('moduls.landing-new.produk-bisikan', compact('layanan_class_journey', 'benefit_class_journey', 'faqs', 'poster', 'link_pendaftaran', 'episodes', 'topics', 'sosmed', 'manfaat_bisikan'));
    }
